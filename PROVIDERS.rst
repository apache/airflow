...
To ensure consistency and manage dependencies, ``prefligit`` is configured to automatically update all dependencies.
Once you have ``prefligit`` installed, it will automatically handle the dependency updates.
