...
files_not_fully_covered = [
    ...
    "airflow-core/src/airflow/executors/sequential_executor.py",
    # jobs
    "airflow-core/src/airflow/jobs/backfill_job_runner.py",
    ...
    "airflow-core/src/airflow/jobs/local_task_job_runner.py",
    "airflow-core/src/airflow/jobs/scheduler_job_runner.py",
    "airflow-core/src/airflow/jobs/triggerer_job_runner.py",
    # models
    "airflow-core/src/airflow/models/abstractoperator.py",
    ...
    "airflow-core/src/airflow/models/dagpickle.py",
    ...
    "airflow-core/src/airflow/models/skipmixin.py",
    ...
    "airflow-core/src/airflow/serialization/pydantic/dag_run.py",
    "airflow-core/src/airflow/serialization/pydantic/job.py",
    "airflow-core/src/airflow/serialization/pydantic/taskinstance.py",
    ...
    "airflow-core/src/airflow/utils/docs.py",
    ...
    "airflow-core/src/airflow/utils/log/secrets_masker.py",
    "airflow-core/src/airflow/utils/log/task_handler_with_custom_formatter.py",
    "airflow-core/src/airflow/utils/log/trigger_handler.py",
    "airflow-core/src/airflow/utils/mixins.py",
    ...
    "airflow-core/src/airflow/utils/python_virtualenv.py",
