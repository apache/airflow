...
TASKRUNNER_PY = (
    AIRFLOW_CORE_SOURCES_PATH / "task-sdk" / "src" / "airflow" / "sdk" / "execution_time" / "task_runner.py"
)
CONTEXT_PY = AIRFLOW_CORE_SOURCES_PATH / "airflow" / "utils" / "context.py"
CONTEXT_HINT = (
    AIRFLOW_CORE_SOURCES_PATH / "task-sdk" / "src" / "airflow" / "sdk" / "definitions" / "context.py"
)
TEMPLATES_REF_RST = AIRFLOW_CORE_SOURCES_PATH / ".." / "docs" / "templates-ref.rst"
