...
REPLACEMENTS: list[RegexpSpec] = [
    ...
    RegexpSpec(
        regexp=r"\u2018",
        replacement="'",
        description="left single quotation with straight one",
    ),
    RegexpSpec(
        regexp=r"\u2019",
        replacement="'",
        description="right single quotation with straight one",
    ),
    RegexpSpec(
        regexp=r"\u201C",
        replacement='"',
        description="left double quotation with straight one",
    ),
    RegexpSpec(
        regexp=r"\u201D",
        replacement='"',
