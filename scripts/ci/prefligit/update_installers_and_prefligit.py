...
sys.path.insert(0, str(Path(__file__).parent.resolve()))  # make sure common_prefligit_utils is imported
from common_prefligit_utils import AIRFLOW_CORE_ROOT_PATH, AIRFLOW_ROOT_PATH, console
...
FILES_TO_UPDATE: list[tuple[Path, bool]] = [
    ...
    (AIRFLOW_ROOT_PATH / ".github" / "actions" / "install-prefligit" / "action.yml", False),
