...
from common_prefligit_utils import AIRFLOW_CORE_SOURCES_PATH, AIRFLOW_ROOT_PATH
...
# here that are not available in stdlib! You should not import common_prefligit_utils.py here because
