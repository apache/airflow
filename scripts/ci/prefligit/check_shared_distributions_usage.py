...
sys.path.insert(0, str(Path(__file__).parent.resolve()))  # for common_prefligit_utils import
from common_prefligit_utils import AIRFLOW_ROOT_PATH, console, insert_documentation
