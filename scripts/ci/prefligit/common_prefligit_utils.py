...
def initialize_breeze_prefligit(name: str, file: str):
    ...
    if os.environ.get("SKIP_BREEZE_PREFLIGITS"):
    ...
    if shutil.which("breeze") is None:
        console.print(
            ...
            "[bright_blue]You can also set SKIP_BREEZE_PREFLIGITS env variable to non-empty "
