...
from common_prefligit_utils import AIRFLOW_CORE_SOURCES_PATH, AIRFLOW_PROVIDERS_ROOT_PATH, console
    ...
    for dbfile, mpath in paths:
        ...
        if not match:
            console.print(
                ...
                "please update scripts/ci/prefligit/version_heads_map.py"
            )
            sys.exit(1)
