...
function install_airflow() {
    ...
    if [[ ${AIRFLOW_INSTALLATION_METHOD} == "." ]]; then
        ...
        installation_command_flags="--editable ./airflow-core[${AIRFLOW_EXTRAS}]${AIRFLOW_VERSION_SPECIFICATION} --editable ./task-sdk --editable ./devel-common --editable ./airflow-core"
