...
from airflow.providers.keycloak.auth_manager import __file__ as KEYCLOAK_AUTH_MANAGER_API_PATH
...
KEYCLOAK_AUTH_MANAGER_OPENAPI_SPEC_FILE = (
    Path(KEYCLOAK_AUTH_MANAGER_API_PATH).parent / "openapi" / "v2-keycloak-auth-manager-generated.yaml"
)
