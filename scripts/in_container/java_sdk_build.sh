...
# Requires the apache-airflow-coordinators-java distribution to be installed so that
# airflow.sdk.coordinators.java.JavaCoordinator is importable via import_string.
export AIRFLOW__SDK__COORDINATORS='[{"name": "java", "classpath": "airflow.sdk.coordinators.java.JavaCoordinator", "kwargs": {"bundles_folder": "${STUB_BUNDLE}/jar-bundles"}}]'
export AIRFLOW__SDK__QUEUE_TO_COORDINATOR='{"java-queue": "java"}'
