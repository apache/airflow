...
class Type(str, Enum):
    ...
    ASSET_NAME_REF = "asset-name-ref"
    ASSET_URI_REF = "asset-uri-ref"
    DAG = "dag"
    SENSOR = "sensor"
    TRIGGER = "trigger"
...
class ConnectionHookFieldBehavior(BaseModel):
    ...
    hidden: Annotated[
        bool | None, Field(description="Flag if the form field should be hidden.", title="Hidden")
    ] = False
    title: Annotated[
        str | None,
        Field(
    ...
    placeholder: Annotated[
        str | None,
        Field(description="Placeholder text that should be populated to the form.", title="Placeholder"),
    ] = None
...
class DAGRunStates(BaseModel):
    ...
    running: Annotated[int, Field(title="Running")]
    success: Annotated[int, Field(title="Success")]
...
class DAGRunTypes(BaseModel):
    ...
    backfill: Annotated[int, Field(title="Backfill")]
    scheduled: Annotated[int, Field(title="Scheduled")]
    manual: Annotated[int, Field(title="Manual")]
    asset_triggered: Annotated[int, Field(title="Asset Triggered")]
...
class EdgeResponse(BaseModel):
    ...
    source_id: Annotated[str, Field(title="Source Id")]
    target_id: Annotated[str, Field(title="Target Id")]
    is_setup_teardown: Annotated[bool | None, Field(title="Is Setup Teardown")] = None
    label: Annotated[str | None, Field(title="Label")] = None
    is_source_asset: Annotated[bool | None, Field(title="Is Source Asset")] = None
...
class MenuItemCollectionResponse(BaseModel):
    ...
    authorized_menu_items: Annotated[list[MenuItem], Field(title="Authorized Menu Items")]
    extra_menu_items: Annotated[list[ExtraMenuItem], Field(title="Extra Menu Items")]


class SetupTeardownType(str, Enum):
    SETUP = "setup"
    TEARDOWN = "teardown"


class AssetConditionType(str, Enum):
    OR_GATE = "or-gate"
    AND_GATE = "and-gate"
...
class NodeResponse(BaseModel):
    ...
    label: Annotated[str, Field(title="Label")]
    type: Annotated[Type, Field(title="Type")]
    children: Annotated[list[NodeResponse] | None, Field(title="Children")] = None
    is_mapped: Annotated[bool | None, Field(title="Is Mapped")] = None
    tooltip: Annotated[str | None, Field(title="Tooltip")] = None
    setup_teardown_type: Annotated[SetupTeardownType | None, Field(title="Setup Teardown Type")] = None
    operator: Annotated[str | None, Field(title="Operator")] = None
    asset_condition_type: Annotated[AssetConditionType | None, Field(title="Asset Condition Type")] = None
...
class StandardHookFields(BaseModel):
    ...
    description: ConnectionHookFieldBehavior | None = None
    url_schema: ConnectionHookFieldBehavior | None = None
    host: ConnectionHookFieldBehavior | None = None
    port: ConnectionHookFieldBehavior | None = None
    login: ConnectionHookFieldBehavior | None = None
    password: ConnectionHookFieldBehavior | None = None
...
class TaskInstanceStateCount(BaseModel):
    ...
    no_status: Annotated[int, Field(title="No Status")]
    removed: Annotated[int, Field(title="Removed")]
    scheduled: Annotated[int, Field(title="Scheduled")]
    queued: Annotated[int, Field(title="Queued")]
    running: Annotated[int, Field(title="Running")]
    success: Annotated[int, Field(title="Success")]
    restarting: Annotated[int, Field(title="Restarting")]
    failed: Annotated[int, Field(title="Failed")]
    up_for_retry: Annotated[int, Field(title="Up For Retry")]
    up_for_reschedule: Annotated[int, Field(title="Up For Reschedule")]
    upstream_failed: Annotated[int, Field(title="Upstream Failed")]
    skipped: Annotated[int, Field(title="Skipped")]
    deferred: Annotated[int, Field(title="Deferred")]
...
class BaseGraphResponse(BaseModel):
    ...
    edges: Annotated[list[BaseEdgeResponse], Field(title="Edges")]
    nodes: Annotated[list[BaseNodeResponse], Field(title="Nodes")]
...
class ConfigResponse(BaseModel):
    ...
    navbar_color: Annotated[str, Field(title="Navbar Color")]
    navbar_text_color: Annotated[str, Field(title="Navbar Text Color")]
    navbar_hover_color: Annotated[str, Field(title="Navbar Hover Color")]
    navbar_text_hover_color: Annotated[str, Field(title="Navbar Text Hover Color")]
    navbar_logo_text_color: Annotated[str, Field(title="Navbar Logo Text Color")]
    page_size: Annotated[int, Field(title="Page Size")]
    auto_refresh_interval: Annotated[int, Field(title="Auto Refresh Interval")]
    default_ui_timezone: Annotated[str, Field(title="Default Ui Timezone")]
    hide_paused_dags_by_default: Annotated[bool, Field(title="Hide Paused Dags By Default")]
    instance_name: Annotated[str, Field(title="Instance Name")]
    instance_name_has_markup: Annotated[bool, Field(title="Instance Name Has Markup")]
    enable_swagger_ui: Annotated[bool, Field(title="Enable Swagger Ui")]
    require_confirmation_dag_change: Annotated[bool, Field(title="Require Confirmation Dag Change")]
    default_wrap: Annotated[bool, Field(title="Default Wrap")]
    warn_deployment_exposure: Annotated[bool, Field(title="Warn Deployment Exposure")]
    audit_view_excluded_events: Annotated[str, Field(title="Audit View Excluded Events")]
    audit_view_included_events: Annotated[str, Field(title="Audit View Included Events")]
    test_connection: Annotated[str, Field(title="Test Connection")]
    state_color_mapping: Annotated[dict[str, Any], Field(title="State Color Mapping")]
    dashboard_alert: Annotated[list[UIAlert], Field(title="Dashboard Alert")]
...
class ConnectionHookMetaData(BaseModel):
    ...
    connection_type: Annotated[str | None, Field(title="Connection Type")] = None
    hook_class_name: Annotated[str | None, Field(title="Hook Class Name")] = None
    default_conn_name: Annotated[str | None, Field(title="Default Conn Name")] = None
    hook_name: Annotated[str, Field(title="Hook Name")]
    standard_fields: StandardHookFields | None = None
    extra_fields: Annotated[dict[str, Any] | None, Field(title="Extra Fields")] = None
...
class DAGWithLatestDagRunsResponse(BaseModel):
    """
    ...
    owners: Annotated[list[str], Field(title="Owners")]
    asset_expression: Annotated[dict[str, Any] | None, Field(title="Asset Expression")] = None
    latest_dag_runs: Annotated[list[DAGRunResponse], Field(title="Latest Dag Runs")]
    file_token: Annotated[str, Field(description="Return file token.", title="File Token")]
...
class GridTaskInstanceSummary(BaseModel):
    ...
    start_date: Annotated[datetime | None, Field(title="Start Date")] = None
    end_date: Annotated[datetime | None, Field(title="End Date")] = None
    queued_dttm: Annotated[datetime | None, Field(title="Queued Dttm")] = None
    child_states: Annotated[dict[str, int] | None, Field(title="Child States")] = None
    task_count: Annotated[int, Field(title="Task Count")]
...
class DAGWithLatestDagRunsCollectionResponse(BaseModel):
    ...
    total_entries: Annotated[int, Field(title="Total Entries")]
    dags: Annotated[list[DAGWithLatestDagRunsResponse], Field(title="Dags")]
...
class GridDAGRunwithTIs(BaseModel):
    ...
    data_interval_end: Annotated[datetime | None, Field(title="Data Interval End")] = None
    note: Annotated[str | None, Field(title="Note")] = None
    task_instances: Annotated[list[GridTaskInstanceSummary], Field(title="Task Instances")]
...
class GridResponse(BaseModel):
    ...
    dag_runs: Annotated[list[GridDAGRunwithTIs], Field(title="Dag Runs")]
