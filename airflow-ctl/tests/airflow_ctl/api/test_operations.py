...
class TestTaskInstanceOperations:
    ...
    def test_update(self):
        """Test updating a task instance state — API always returns a collection."""
    ...
    def test_update_with_note(self):
        """Test updating a task instance with a note only (no new_state)."""
    ...
    def test_update_with_map_index(self):
        """Test that map_index routes to the indexed endpoint, scoping the update to one instance."""
        map_index = 0
