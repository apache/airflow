...
class FailFastDagInvalidTriggerRule(AirflowException):
    ...
    _allowed_rules = ("all_success", "all_done_setup_success")

    @classmethod
    def check(cls, *, fail_fast: bool, trigger_rule: str):
        """
    ...
    def __str__(self) -> str:
        return f"A 'fail_fast' dag can only have {self._allowed_rules[0]} trigger rule"
