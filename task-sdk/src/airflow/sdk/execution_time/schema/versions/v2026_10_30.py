...
class AddBundleImportRootToDagFileParseRequest(VersionChange):
    """Add the bundle import root to Dag file parse requests."""

    description = __doc__

    instructions_to_migrate_to_previous_version = (
        schema(DagFileParseRequest).field("bundle_import_root").didnt_exist,
    )
