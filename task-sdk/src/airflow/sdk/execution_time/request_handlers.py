...
def handle_get_connection(client: Client, msg: GetConnection) -> tuple[BaseModel | None, dict]:
...
def handle_get_variable(client: Client, msg: GetVariable) -> tuple[BaseModel | None, dict]:
...
def handle_get_xcom(client: Client, msg: GetXCom) -> tuple[BaseModel | None, dict]:
...
def handle_get_asset_by_name(client: Client, msg: GetAssetByName) -> tuple[BaseModel | None, dict]:
...
def handle_get_asset_by_uri(client: Client, msg: GetAssetByUri) -> tuple[BaseModel | None, dict]:
