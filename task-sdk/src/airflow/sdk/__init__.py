...
__lazy_imports: dict[str, str] = {
    ...
    "TruncateToDailyMapper": ".definitions.partition_mappers.temporal",
    "TruncateToHourlyMapper": ".definitions.partition_mappers.temporal",
    "TruncateToMonthlyMapper": ".definitions.partition_mappers.temporal",
    "TruncateToQuarterlyMapper": ".definitions.partition_mappers.temporal",
    "TruncateToWeeklyMapper": ".definitions.partition_mappers.temporal",
    "TruncateToYearlyMapper": ".definitions.partition_mappers.temporal",
