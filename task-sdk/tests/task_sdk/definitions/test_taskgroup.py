...
def test_task_group_retries_negative_value_raises():
    """Negative retries should be rejected at construction time."""
    with pytest.raises(ValueError, match="non-negative"):
        with DAG(dag_id="test_negative_retries", schedule=None, start_date=DEFAULT_DATE):
            TaskGroup(group_id="bad", retries=-1)
