...
REQUEST_TEST_CASES = [
    ...
    RequestTestCase(
        message=GetAssetState(name="debug_watcher_asset", key="watermark"),
        test_id="get_asset_state",
        client_mock=ClientMock(
            method_path="asset_state.get",
            args=("debug_watcher_asset", "watermark"),
            response=AssetStateResult(value="2026-04-30T00:00:00Z"),
        ),
        expected_body={"value": "2026-04-30T00:00:00Z", "type": "AssetStateResult"},
    ),
    RequestTestCase(
        message=SetAssetState(name="debug_watcher_asset", key="watermark", value="2026-04-30T00:00:00Z"),
        test_id="set_asset_state",
        client_mock=ClientMock(
            method_path="asset_state.set",
            args=("debug_watcher_asset", "watermark", "2026-04-30T00:00:00Z"),
            response=OKResponse(ok=True),
        ),
        expected_body={"ok": True, "type": "OKResponse"},
    ),
    RequestTestCase(
        message=DeleteAssetState(name="debug_watcher_asset", key="watermark"),
        test_id="delete_asset_state",
        client_mock=ClientMock(
    ...
    RequestTestCase(
        message=ClearAssetState(name="debug_watcher_asset"),
        test_id="clear_asset_state",
        client_mock=ClientMock(
            method_path="asset_state.clear",
            args=("debug_watcher_asset",),
            response=OKResponse(ok=True),
        ),
        expected_body={"ok": True, "type": "OKResponse"},
    ),
