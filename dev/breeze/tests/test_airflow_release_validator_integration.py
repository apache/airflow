...
class TestValidateLicensesIntegration:
    """Integration tests for Apache RAT license validation."""
...
class TestValidateReproducibleBuildIntegration:
    ...
    They are marked with 'slow_integration' and excluded from regular CI.
    """

    def test_reproducible_build_matches_svn(self, validator):
