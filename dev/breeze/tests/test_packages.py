    ...
    [
        pytest.param(
            "",
            {
                ...
                "cncf.kubernetes": ["apache-airflow-providers-cncf-kubernetes>=8.1.0"],
        ...
        pytest.param(
            "dev0",
            {
                ...
                "apache.beam": ["apache-airflow-providers-apache-beam", "apache-beam[gcp]"],
                "apache.cassandra": ["apache-airflow-providers-apache-cassandra"],
                "cncf.kubernetes": ["apache-airflow-providers-cncf-kubernetes>=8.1.0.dev0"],
                "common.sql": ["apache-airflow-providers-common-sql"],
        ...
        pytest.param(
            "beta0",
            {
                ...
                "apache.beam": ["apache-airflow-providers-apache-beam", "apache-beam[gcp]"],
                "apache.cassandra": ["apache-airflow-providers-apache-cassandra"],
                "cncf.kubernetes": ["apache-airflow-providers-cncf-kubernetes>=8.1.0b0"],
                "common.sql": ["apache-airflow-providers-common-sql"],
