    ...
    [
        (
            pytest.param(
                ("INTHEWILD.md",),
                {
                    ...
                    "docs-build": "false",
                    "skip-prefligits": ALL_SKIPPED_COMMITS_ON_NO_CI_IMAGE,
        ...
        (
            pytest.param(
                ("airflow-core/src/airflow/api/file.py",),
                {
                    ...
                    "run-tests": "true",
                    "docs-build": "true",
                    "skip-prefligits": ALL_SKIPPED_COMMITS_BY_DEFAULT_ON_ALL_TESTS_NEEDED,
                    "upgrade-to-newer-dependencies": "false",
        ...
        (
            pytest.param(
                ("airflow-core/src/airflow/serialization/python.py",),
                {
                    ...
                    "run-amazon-tests": "false",
                    "docs-build": "true",
                    "skip-prefligits": ALL_SKIPPED_COMMITS_IF_NO_PROVIDERS_UI_AND_HELM_TESTS,
                    "upgrade-to-newer-dependencies": "false",
        ...
        (
            pytest.param(
                ("providers/apache/beam/tests/unit/apache/beam/file.py",),
                {
                    ...
                    "run-amazon-tests": "false",
                    "docs-build": "true",
                    "skip-prefligits": ALL_SKIPPED_COMMITS_IF_NO_UI_AND_HELM_TESTS,
        ...
        (
            pytest.param(
                ...
                ),
                {
                    ...
                    "run-amazon-tests": "true",
                    "docs-build": "true",
                    "skip-prefligits": ALL_SKIPPED_COMMITS_IF_NO_UI,
        ...
        (
            pytest.param(
                ...
                ),
                {
                    ...
                    "run-tests": "true",
                    "docs-build": "true",
                    "skip-prefligits": ALL_SKIPPED_COMMITS_IF_NO_PROVIDERS_AND_UI,
                    "run-amazon-tests": "false",
                    "run-kubernetes-tests": "true",
                    "upgrade-to-newer-dependencies": "false",
                    "core-test-types-list-as-strings-in-json": json.dumps(
        ...
        pytest.param(
            ("providers/amazon/src/airflow/providers/amazon/provider.yaml",),
            {
                ...
                "skip-prefligits": "flynt," + ALL_SKIPPED_COMMITS_IF_NO_UI_AND_HELM_TESTS,
                "run-kubernetes-tests": "false",
                "upgrade-to-newer-dependencies": "false",
                "run-amazon-tests": "true",
                "core-test-types-list-as-strings-in-json": json.dumps(
        ...
        (
            pytest.param(
                ("airflow-core/src/airflow/ui/src/index.tsx",),
                {
                    ...
                    "docs-build": "false",
                    "full-tests-needed": "false",
                    "skip-prefligits": ALL_SKIPPED_COMMITS_IF_NO_CODE_PROVIDERS_AND_HELM_TESTS,
                    "upgrade-to-newer-dependencies": "false",
                    "needs-mypy": "false",
                    "mypy-checks": "[]",
                    "run-ui-tests": "true",
        ...
        pytest.param(
            ("chart/RELEASE_NOTES.rst",),
            {
                ...
                "run-amazon-tests": "false",
                "docs-build": "true",
                "skip-prefligits": "check-provider-yaml-valid,flynt,identity,mypy-airflow-core,mypy-airflow-ctl,mypy-dev,mypy-devel-common,mypy-providers,mypy-task-sdk,ts-compile-lint-simple-auth-manager-ui,ts-compile-lint-ui",
                "upgrade-to-newer-dependencies": "false",
                "core-test-types-list-as-strings-in-json": None,
                "providers-test-types-list-as-strings-in-json": None,
                "individual-providers-test-types-list-as-strings-in-json": None,
...
@pytest.mark.parametrize(
    ...
    [
        (
            pytest.param(
                ("scripts/ci/prefligit/file.sh",),
                {
                    "full-tests-needed": "false",
                },
                id="No full tests needed when prefligit scripts change",
            )
        ),
        (
            pytest.param(
        ...
        (
            pytest.param(
                ...
                "v2-7-stable",
                {
                    ...
                    "full-tests-needed": "true",
                    "skip-prefligits": All_SKIPPED_COMMITS_IF_NON_MAIN_BRANCH,
                    "upgrade-to-newer-dependencies": "false",
                    "core-test-types-list-as-strings-in-json": ALL_CI_SELECTIVE_TEST_TYPES_AS_JSON,
                    "needs-mypy": "true",
                    "mypy-checks": ALL_MYPY_CHECKS_EXCEPT_PROVIDERS,
                },
                id="Everything should run except Providers and lint prefligit "
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            id="All tests except Providers and helm lint prefligit "
    ...
    [
        pytest.param(
            ("INTHEWILD.md",),
            {
                ...
                "docs-list-as-string": None,
                "upgrade-to-newer-dependencies": "false",
                "skip-prefligits": ALL_SKIPPED_COMMITS_IF_NOT_IMPORTANT_FILES_CHANGED,
                "core-test-types-list-as-strings-in-json": None,
                "needs-mypy": "false",
                "mypy-checks": "[]",
            },
        ...
        pytest.param(
            ("airflow-core/tests/system/any_file.py",),
            {
                ...
                "docs-build": "true",
                "docs-list-as-string": ALL_DOCS_SELECTED_FOR_BUILD,
                "skip-prefligits": ALL_SKIPPED_COMMITS_IF_NO_PROVIDERS,
                "upgrade-to-newer-dependencies": "false",
                "core-test-types-list-as-strings-in-json": json.dumps(
                    [{"description": "Always", "test_types": "Always"}]
                ),
