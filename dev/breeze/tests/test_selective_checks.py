...
ALL_SKIPPED_COMMITS_ON_NO_CI_IMAGE = (
    ...
    "mypy-scripts,"
    "mypy-shared-configuration,mypy-shared-dagnode,mypy-shared-exceptions,mypy-shared-listeners,mypy-shared-logging,"
            ...
            pytest.param(
                ("shared/logging/src/airflow_shared/logging/remote.py",),
                {
                    "skip-prek-hooks": (
                        ...
                        "mypy-shared-configuration,mypy-shared-dagnode,mypy-shared-exceptions,mypy-shared-listeners,"
