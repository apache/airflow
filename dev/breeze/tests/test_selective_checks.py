        ...
        (
            pytest.param(
                ("generated/provider_dependencies.json",),
                {
                    ...
                    "all-python-versions-list-as-string": "3.9 3.10 3.11 3.12 3.12",
                    "python-versions": "['3.9', '3.10', '3.11', '3.12', '3.13']",
                    "python-versions-list-as-string": "3.9 3.10 3.11 3.12 3.12",
                    "ci-image-build": "true",
                    "prod-image-build": "true",
                    "needs-helm-tests": "true",
                    "run-tests": "true",
    ...
    [
        (
            pytest.param(
                ...
                "main",
                {
                    ...
                    "kubernetes-combos-list-as-string": "3.9-v1.29.12 3.10-v1.30.8 3.11-v1.31.4 3.12-v1.32.0 3.13-v1.29.12",
                    "ci-image-build": "true",
                    "prod-image-build": "true",
                    "run-tests": "true",
                    "skip-providers-tests": "false",
        ...
        (
            pytest.param(
                ...
                {
                    "selected-providers-list-as-string": ALL_PROVIDERS_AFFECTED,
                    "all-python-versions": "['3.13']",
                    "all-python-versions-list-as-string": "3.13",
                    "all-versions": "false",
                    "default-python-version": "3.13",
                    "mysql-versions": "['8.4']",
                    "postgres-versions": "['17']",
                    "python-versions": "['3.13']",
                    "python-versions-list-as-string": "3.13",
                    "kubernetes-versions": "['v1.32.0']",
                    "kubernetes-versions-list-as-string": "v1.32.0",
                    "kubernetes-combos-list-as-string": "3.13-v1.32.0",
                    "ci-image-build": "true",
                    "prod-image-build": "true",
                    "run-tests": "true",
                    "skip-providers-tests": "false",
...
def test_files_provided_trigger_full_build_for_any_event_type(github_event):
    ...
    assert_outputs_are_printed(
        {
            "all-python-versions": "['3.9', '3.10', '3.11', '3.12', '3.13']",
            "all-python-versions-list-as-string": "3.9 3.10 3.11 3.12 3.12 3.13",
            "ci-image-build": "true",
            "prod-image-build": "true",
            "needs-helm-tests": "true",
            "run-tests": "true",
