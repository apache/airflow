        ...
        (
            pytest.param(
                ("generated/provider_dependencies.json",),
                {
                    ...
                    "all-python-versions-list-as-string": "3.9 3.10 3.11 3.12 3.13",
                    "python-versions": "['3.9', '3.10', '3.11', '3.12', '3.13']",
                    "python-versions-list-as-string": "3.9 3.10 3.11 3.12 3.13",
                    "ci-image-build": "true",
                    "prod-image-build": "true",
                    "needs-helm-tests": "true",
                    "run-tests": "true",
...
def test_files_provided_trigger_full_build_for_any_event_type(github_event):
    ...
    assert_outputs_are_printed(
        {
            "all-python-versions": "['3.9', '3.10', '3.11', '3.12', '3.13']",
            "all-python-versions-list-as-string": "3.9 3.10 3.11 3.12 3.13 3.13",
            "ci-image-build": "true",
            "prod-image-build": "true",
            "needs-helm-tests": "true",
            "run-tests": "true",
