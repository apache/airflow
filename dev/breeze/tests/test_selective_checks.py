        ...
        (
            pytest.param(
                ...
                "main",
                {
                    ...
                    "python-versions": "['3.9', '3.10', '3.11', '3.12']",
                    "python-versions-list-as-string": "3.9 3.10 3.11 3.12",
                    "kubernetes-versions": "['v1.27.13', 'v1.28.9', 'v1.29.4', 'v1.30.0']",
                    "kubernetes-versions-list-as-string": "v1.27.13 v1.28.9 v1.29.4 v1.30.0",
                    "kubernetes-combos-list-as-string": "3.9-v1.27.13 3.10-v1.28.9 3.11-v1.29.4 3.12-v1.30.0",
                    "ci-image-build": "true",
                    "prod-image-build": "true",
                    "run-tests": "true",
                    "docs-build": "true",
        ...
        (
            pytest.param(
                ...
                "main",
                {
                    ...
                    "kubernetes-combos-list-as-string": "3.9-v1.27.13",
                    "ci-image-build": "true",
                    "prod-image-build": "true",
                    "run-tests": "true",
                    "docs-build": "true",
