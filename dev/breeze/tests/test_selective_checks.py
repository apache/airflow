...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pytest.param(
                ("airflow-core/tests/api/file.py",),
                {
                    "all-python-versions": "['3.9']",
                    "all-python-versions-list-as-string": "3.9",
                    "python-versions": "['3.9']",
        ...
        (
            pytest.param(
                ("airflow-core/src/airflow/operators/file.py",),
                {
                    "selected-providers-list-as-string": None,
                    "all-python-versions": "['3.9']",
                    "all-python-versions-list-as-string": "3.9",
        ...
        pytest.param(
            (
                "airflow-core/tests/always/test_project_structure.py",
        ...
        (
            pytest.param(
                ("airflow-core/tests/utils/test_cli_util.py",),
                {
                    "selected-providers-list-as-string": ALL_PROVIDERS_AFFECTED,
                    "all-python-versions": "['3.9']",
                    "all-python-versions-list-as-string": "3.9",
