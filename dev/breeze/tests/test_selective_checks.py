...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            {
                "affected-providers-list-as-string": "amazon apache.hive cncf.kubernetes common.sql exasol "
                "ftp google http imap microsoft.azure mongo mysql postgres salesforce ssh",
                "all-python-versions": "['3.8']",
                "all-python-versions-list-as-string": "3.8",
                "python-versions": "['3.8']",
                "python-versions-list-as-string": "3.8",
        ...
        pytest.param(
            ("airflow/providers/amazon/file.py",),
            {
                ...
                "parallel-test-types-list-as-string": "Always Providers[amazon] "
                "Providers[apache.hive,cncf.kubernetes,common.sql,exasol,ftp,http,"
                "imap,microsoft.azure,mongo,mysql,postgres,salesforce,ssh] Providers[google]",
            },
            id="Providers tests run including amazon tests if amazon provider files changed",
        ),
    ],
    ...
    [
        ...
        pytest.param(
            ...
            ),
            {
                ...
                "sftp,ssh,trino] Providers[google]",
            },
