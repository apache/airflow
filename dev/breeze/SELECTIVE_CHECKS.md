...
| docs-filter                        | What filter to apply to docs building - based on which documentation packages should be built           | --package-filter apache-airflow -                   |
...
| parallel-test-types                | Which test types should be run for unit tests                                                           | API Always Providers\[amazon\] Providers\[-amazon\] |
