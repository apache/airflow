...
in the `testing doc <../../../contribution-docs/testing.rst>`_ where all the test types and information on how to run them are explained.
...
This is described in detail in `Testing Kubernetes <../../../contribution-docs/testing.rst#running-tests-with-kubernetes>`_.
