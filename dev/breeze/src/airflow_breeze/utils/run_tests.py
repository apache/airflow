...
TEST_TYPE_CORE_MAP_TO_PYTEST_ARGS: dict[str, list[str]] = {
    "Always": ["airflow-core/tests/always"],
    "API": ["airflow-core/tests/api", "airflow-core/tests/api_fastapi"],
    "CLI": ["airflow-core/tests/cli"],
    "Core": [
    ...
    "Operators": ["airflow-core/tests/operators"],
    "Serialization": [
...
TEST_GROUP_TO_TEST_FOLDERS: dict[GroupOfTests, list[str]] = {
    GroupOfTests.CORE: ["airflow-core/tests"],
...
NO_RECURSE_DIRS = [
    "airflow-core/tests/_internals",
    "airflow-core/tests/dags_with_system_exit",
    "airflow-core/tests/dags_corrupted",
    "airflow-core/tests/dags",
...
def find_all_other_tests() -> list[str]:
    ...
    all_current_test_folders = [
        ...
        for path in AIRFLOW_ROOT_PATH.glob("airflow-core/tests/*")
