...
PROVIDERS_COMPATIBILITY_TESTS_MATRIX: list[dict[str, str | list[str]]] = [
    ...
    },
    {
        ...
        "airflow-constraints-reference": "constraints-3.2.2",
        "remove-providers": "",
        "run-unit-tests": "true",
    },
    {
    ...
    },
    {
        ...
        "airflow-constraints-reference": "constraints-3.3.1",
        "remove-providers": "",
        "run-unit-tests": "true",
    },
    {
        "python-version": "3.10",
        "airflow-version": "apache/airflow:v3-3-test",
        "airflow-constraints-reference": "constraints-3-3",
        "remove-providers": "",
        "run-unit-tests": "true",
    },
]
