...
@click.option(
    ...
    default=None,
    help="Folder to store build metadata. When specified, images are pushed by digest only "
    "and metadata files are stored for later merging with merge-prod-images.",
)
@option_verbose
def release_prod_images(
    ...
    for python in python_versions:
        ...
        if python == DEFAULT_PYTHON_MAJOR_MINOR_VERSION and not metadata_file:
            get_console().print(
