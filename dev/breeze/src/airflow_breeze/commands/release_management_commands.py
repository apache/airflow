...
RICH_VERSION = "14.1.0"
PREFLIGIT_VERSION = "0.0.22"
HATCH_VERSION = "1.14.1"
PYYAML_VERSION = "6.0.2"

# prefligit environment and this is done with node, no python installation is needed.
...
def _build_local_build_image():
    ...
    dockerignore_content = dockerignore_content + textwrap.dedent("""
        # Include git in the build context - we need to get git version and prefligit configuration
...
@click.option(
    "--skip-changelog",
    is_flag=True,
    help="Skip changelog generation. This is used in prefligit that updates build-files only.",
)
@click.option(
    "--skip-readme",
    is_flag=True,
    help="Skip readme generation. This is used in prefligit that updates build-files only.",
)
@option_verbose
