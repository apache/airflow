...
- Add supported Airflow version to `./scripts/ci/prefligit/supported_versions.py` and let prefligit do the job again.
...
- Modify `./scripts/ci/prefligit/supported_versions.py` and let prefligit do the job.
