...
class TestCreateUserJob:
    ...
    @pytest.mark.parametrize(
        ...
        _get_git_sync_test_params_for_no_containers("createUserJob"),
    )
    def test_git_sync_not_added_when_disabled_or_persistent_dags(
        ...
        _test_git_sync_presence(
            ...
            template_path="templates/jobs/create-user-job.yaml",
    ...
    @pytest.mark.parametrize(
        ("git_sync_values", "dags_persistence_enabled"),
        _get_enabled_git_sync_test_params("createUserJob"),
    )
