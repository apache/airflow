...
class TestJobLauncher:
    ...
    @pytest.mark.parametrize("create", [False, True, None])
    def test_worker_role_binding_should_exists_with_kubernetes_airflow_2(self, executor, create):
        docs = render_chart(
            name="prod",
            namespace="airflow",
            values={
    ...
    @pytest.mark.parametrize("create", [False, True])
    def test_worker_role_binding_should_not_exists_with_kubernetes_airflow_2(self, executor, create):
        docs = render_chart(
            name="prod",
            values={
                "airflowVersion": "2.11.0",
    ...
    def test_worker_kubernetes_role_binding_should_exists_airflow_2(self, executor, service_account_values):
        docs = render_chart(
            name="prod",
            namespace="airflow",
            values={
