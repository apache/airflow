...
class TestHTTPRouteFlower:
    ...
    def test_should_fail_when_ingress_and_httproute_both_enabled(self, ingress_values):
        with pytest.raises(HelmFailedError) as exc_info:
            render_chart(
                values={
                    "executor": "CeleryExecutor",
    ...
    def test_should_fail_when_ingress_template_sees_ingress_and_httproute_both_enabled(self, ingress_values):
        with pytest.raises(HelmFailedError) as exc_info:
            render_chart(
                values={
                    "executor": "CeleryExecutor",
