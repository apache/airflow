...
|              | Master version (dev)      | Stable version (2.0.3)   | Previous version (1.10.15) |
| ------------ | ------------------------- | ------------------------ | -------------------------  |
...
pip install apache-airflow==2.0.3 \
 --constraint "https://raw.githubusercontent.com/apache/airflow/constraints-2.0.3/constraints-3.7.txt"
```

2. Installing with extras (for example postgres,google)

```bash
pip install apache-airflow[postgres,google]==2.0.3 \
 --constraint "https://raw.githubusercontent.com/apache/airflow/constraints-2.0.3/constraints-3.7.txt"
```
