...
| Kubernetes | 1.23, 1.24, 1.25, 1.26, 1.27 | 1.23, 1.24, 1.25, 1.26, 1.27 |
...
2. The "oldest" supported version of Python/Kubernetes is the default one until we decide to switch to
   ...
   and `apache/airflow:2.6.3` images are Python 3.7 images. This means that default reference image will
