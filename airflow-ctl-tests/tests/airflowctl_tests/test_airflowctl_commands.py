...
TEST_COMMANDS = [
    ...
    f"dags trigger example_bash_operator --logical-date={ONE_DATE_PARAM} --run-after={ONE_DATE_PARAM}",
    ...
    f'xcom list example_bash_operator "manual__{ONE_DATE_PARAM}" runme_0',
    ...
    "pools update test_pool --slots=10",
