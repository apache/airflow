...
If you create pull-request, you don't have to create a issue first, but if you want, you can do it. 
Creating a issue will allow you to collect feedback or share plans with other people.
