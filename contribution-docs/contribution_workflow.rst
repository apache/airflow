...
The local env instructions can be found in full in the `local_virtualenv.rst <local_virtualenv.rst>`_ file.
...
The Breeze instructions can be found in full in the `Breeze documentation <../dev/breeze/doc/breeze.rst>`_ file.
