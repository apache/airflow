...
class MappedOperator(AbstractOperator):
    ...
    def _expand_mapped_kwargs(
        ...
        """
        return self._get_specified_expand_input().resolve(context, include_xcom=include_xcom)
    ...
    def render_template_fields(
        ...
        mapped_kwargs, seen_oids = self._expand_mapped_kwargs(context, include_xcom=True)
