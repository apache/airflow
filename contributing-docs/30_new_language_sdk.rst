...
For a diagram-driven overview of how a task runs across the Python and Coordinator
paths, see `Task execution architecture <31_task_execution_architecture.rst>`__.
