...
#. Build the image base on PROD Airflow image. You need to build the PROD image first (the command will
...
#. Run Kubernetes tests
   ...
   #. You can enter an interactive shell to run tests one-by-one
