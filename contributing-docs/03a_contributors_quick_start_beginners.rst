...
.. note::
   Docker **or Podman** installation varies by OS. See the `full guide <03b_contributors_quick_start_seasoned_developers.rst#local-machine-development>`_ for Ubuntu, macOS, and Windows instructions.
