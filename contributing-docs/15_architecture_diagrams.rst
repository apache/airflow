...
automatically updated when the code changes. The diagrams are generated using prek hooks (See
...
prek will automatically generate an .md5sum hash of the sources and store it next to the diagram
file).
...
code and the .md5sum file. The prek hook will then not run the diagram generation until the
