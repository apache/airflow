...
public class EventLogApi {
  ...
  public EventLog getEventLog (Integer eventLogId) throws ApiException {
    ...
    if (eventLogId == null) {
        throw new ApiException(400, "Missing the required parameter 'eventLogId' when calling getEventLog");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public EventLogCollection getEventLogs (Integer limit, Integer offset) throws ApiException {
    ...
    try {
      ...
      if (localVarResponse.statusCode()/ 100 != 2) {
          throw new ApiException(localVarResponse.statusCode(),
              "getEventLogs call received non-success response",
              localVarResponse.headers(),
              localVarResponse.body() == null ? null : new String(localVarResponse.body().readAllBytes()));
      }
