...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirflowApiStable.TaskFail();
  });
  ...
  describe('TaskFail', function() {
    it('should create an instance of TaskFail', function() {
      // uncomment below and update the code to test TaskFail
      //var instane = new AirflowApiStable.TaskFail();
      //expect(instance).to.be.a(AirflowApiStable.TaskFail);
    });
