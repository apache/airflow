...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirflowApiStable.TimeDelta();
  });
  ...
  describe('TimeDelta', function() {
    it('should create an instance of TimeDelta', function() {
      // uncomment below and update the code to test TimeDelta
      //var instane = new AirflowApiStable.TimeDelta();
      //expect(instance).to.be.a(AirflowApiStable.TimeDelta);
    });
