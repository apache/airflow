...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirflowApiStable.ScheduleInterval();
  });
  ...
  describe('ScheduleInterval', function() {
    it('should create an instance of ScheduleInterval', function() {
      // uncomment below and update the code to test ScheduleInterval
      //var instane = new AirflowApiStable.ScheduleInterval();
      //expect(instance).to.be.a(AirflowApiStable.ScheduleInterval);
    });
