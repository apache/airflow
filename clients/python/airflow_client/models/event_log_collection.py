...
class EventLogCollection(object):
    ...
    @property
    def event_logs(self):
        """Gets the event_logs of this EventLogCollection.  # noqa: E501


        :return: The event_logs of this EventLogCollection.  # noqa: E501
        :rtype: list[EventLog]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventLogCollection):
            return False
