...
class Istio(LoggingMixin):
    ...
    def handle_istio_proxy(self, pod):
        ...
        :type pod: V1Pod
        :rtype: bool -- Did we detect and shutdown an istio-proxy?
        :raises: AirflowException, if we find an istio-proxy, and we can't shut it down.
    ...
    def _should_shutdown_istio_proxy(self, pod):
        ...
        :param pod: The pod which we are checking for the sidecar
        :type pod: V1Pod
        :rtype: bool - if the istio-proxy needs to be shutdown
    ...
    def _shutdown_istio_proxy(self, pod):
        ...
        :param pod: The pod which the container is in
        :type pod: V1Pod
        :rtype: None
        :raises: AirflowException -- if we can't shut it down
