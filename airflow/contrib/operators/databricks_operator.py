...
class DatabricksOperator(BaseOperator):
    ...
    def _deep_string_coerce(self, content, json_path='json'):
        ...
        if isinstance(content, six.string_types):
            ...
            return [c(e, '{0}[{1}]'.format(json_path, i))
            ...
            raise AirflowException(msg.format(param_type, json_path))
    ...
    def _log_run_page_url(self):
        msg = 'View run status, Spark UI, and logs at {}'
        self.log.info(msg.format(self._run_page_url))
        ...
        while True:
            ...
            if run_state.is_terminal:
                if run_state.is_successful:
                    ...
                    raise AirflowException(msg.format(t=self.task_id,
                                                      s=run_state))
            else:
    ...
    def on_kill(self):
        ...
        self.log.info(msg.format(t=self.task_id, r=self.run_id))
