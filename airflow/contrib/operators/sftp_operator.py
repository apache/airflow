...
class SftpOperator(BaseOperator):
    """
    Transfers a file via SFTP put/get operations
    ...
    :param put: If put is True, will copy local_filepath to remote_filepath. If put is False,
        will copy remote_filepath to local_filepath
    :type put: bool
    """

    @apply_defaults
    def __init__(self, sftp_conn_id, local_filepath, remote_filepath, put=True, *args, **kwargs):
    ...
    def execute(self, context):
        """
        Transfer files vis SFTP
        """
        hook = SftpHook(sftp_conn_id=self.sftp_conn_id)
