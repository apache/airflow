...
class DataProcPigOperator(BaseOperator):
    ...
    **Example**: ::
    ...
    """
    template_fields = ['query', 'variables', 'job_name', 'cluster_name', 'dataproc_pig_jars']
    template_ext = ('.pg', '.pig',)
    ui_color = '#0273d4'
...
class DataProcHiveOperator(BaseOperator):
    ...
    :vartype dataproc_job_id: str
    """
    template_fields = ['query', 'variables', 'job_name', 'cluster_name', 'dataproc_hive_jars']
    template_ext = ('.q',)
    ui_color = '#0273d4'
...
class DataProcSparkSqlOperator(BaseOperator):
    ...
    :vartype dataproc_job_id: str
    """
    template_fields = ['query', 'variables', 'job_name', 'cluster_name', 'dataproc_spark_jars']
    template_ext = ('.q',)
    ui_color = '#0273d4'
...
class DataProcSparkOperator(BaseOperator):
    ...
    template_fields = ['arguments', 'job_name', 'cluster_name', 'dataproc_spark_jars']
    ui_color = '#0273d4'
...
class DataProcHadoopOperator(BaseOperator):
    ...
    template_fields = ['arguments', 'job_name', 'cluster_name', 'dataproc_hadoop_jars']
    ui_color = '#0273d4'
...
class DataProcPySparkOperator(BaseOperator):
    ...
    template_fields = ['arguments', 'job_name', 'cluster_name', 'dataproc_pyspark_jars']
    ui_color = '#0273d4'
