...
from .kubernetes_executor_config import KubeConfig, KubernetesExecutorConfig
from .kubernetes_job_watcher import KubernetesJobWatcher
import re
...
class AirflowKubernetesScheduler(LoggingMixin):
    ...
    def run_next(self, next_job: TaskObject):
        """
        ...
        key, command, kube_executor_config = next_job.key, next_job.command, next_job.kub_executor_config
...
class KubernetesExecutor(BaseExecutor, LoggingMixin):
    def __init__(self):
        ...
        self.task_queue = None  # type: queue.Queue[TaskObject]
    ...
    def execute_async(self, key, command, queue=None, executor_config=None):
        ...
        self.task_queue.put(TaskObject(key, command, kube_executor_config))
