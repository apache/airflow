...
# TODO: cleanup some of the below code,
# which is replicated by functions defined in 1.10.15.
# This code comes from cherry-picking this commit:
# 43127ca5690975d017e798e6276271340a002c3e
@cli_utils.action_logging
def users(args):
    if args.list:
...
class CLIFactory(object):
    ...
    def get_parser(cls, dag_parser=False):
        ...
        for (sub, hide_from_toplevel_help) in subparser_list:
            ...
            # TODO: determine whether this line is necessary.
            # This was cherry-picked from:
            # adee6b6d8247b68e9918bcc9fcdc00fbd0d1ab4f
