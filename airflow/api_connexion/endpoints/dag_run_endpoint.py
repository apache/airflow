...
@security.requires_access([("can_read", permissions.RESOURCE_ALL_DAGS), ("can_delete", "DagRun")])
@provide_session
...
@security.requires_access([("can_read", permissions.RESOURCE_ALL_DAGS), ("can_read", "DagRun")])
@provide_session
...
@security.requires_access([("can_read", permissions.RESOURCE_ALL_DAGS), ("can_create", "DagRun")])
@provide_session
