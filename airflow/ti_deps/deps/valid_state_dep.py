...
class ValidStateDep(BaseTIDep):
    ...
    def __eq__(self, other):
        """Check if two instances are equal by comparing their types and valid states."""
        return isinstance(self, type(other)) and self._valid_states == other._valid_states

    def __hash__(self):
        """Compute the hash value based on the type of the instance and its valid states."""
