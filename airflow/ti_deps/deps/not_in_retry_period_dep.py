    ...
    def _get_dep_statuses(self, ti, session, dep_context):
        ...
        if ti.is_premature:
            yield self._failing_status(
                reason=f"Task is not ready for retry yet but will be retried automatically. Current date is {cur_date.isoformat()} and task will be retried at {next_task_retry_date.isoformat()}."
            )
