...
class ReadyToRescheduleDep(BaseTIDep):
    ...
    def _get_dep_statuses(self, ti, session, dep_context):
        ...
        yield self._failing_status(
            reason=f"Task is not ready for reschedule yet but will be rescheduled automatically. Current date is {now.isoformat()} and task will be rescheduled at {next_reschedule_date.isoformat()}."
        )
