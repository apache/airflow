...
class StandaloneCommand:
    ...
    def run(self):
        ...
        self.web_server_port = int(conf.get('webserver', 'WEB_SERVER_PORT', fallback='8080'))
    ...
    def is_ready(self):
        ...
        """
        return self.port_open(self.web_server_port) and self.job_running(SchedulerJob) and self.job_running(TriggererJob)
