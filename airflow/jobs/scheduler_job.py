...
from airflow.models.dataset import DatasetConsumerDag, DatasetDagRunQueue, DatasetEvent
        ...
        for dag_model in dag_models:
            ...
            if (dag.dag_id, exec_date) not in existing_dagruns:
                ...
                dataset_event_filters = [
                    DatasetConsumerDag.dag_id == dag.dag_id,
                ...
                dataset_events = (
                    ...
                    .join(DatasetConsumerDag, DatasetEvent.dataset_id == DatasetConsumerDag.dataset_id)
