...
from airflow import configuration as conf, models, executors
from airflow import settings
from airflow.jobs.backfilljob import BackfillJob
from airflow.jobs.basejob import BaseJob
from airflow.models import SlaMiss, errors, DagRun
...
from airflow.utils.dag_processing import SimpleTaskInstance, list_py_file_paths, \
    DagFileProcessorAgent, SimpleDagBag, SimpleDag
...
class SchedulerJob(BaseJob):
    ...
    def _execute(self):
        ...
        def processor_factory(file_path, zombies):
            from airflow.jobs.dagfileprocessor import DagFileProcessor  # Avoid circular import
