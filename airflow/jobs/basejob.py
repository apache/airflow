...
from sqlalchemy import Column, Integer, String, Index, and_, or_
...
from airflow.utils import timezone, helpers
...
class BaseJob(Base, LoggingMixin):
    ...
    def reset_state_for_orphaned_tasks(self, filter_by_dag_run=None, session=None):
        ...
        from airflow.jobs.backfilljob import BackfillJob  # Avoid circular import
