...
class SchedulerJobRunner(BaseJobRunner, LoggingMixin):
    ...
    def _create_dag_runs(self, dag_models: Collection[DagModel], session: Session) -> None:
        ...
        for dag_model in dag_models:
            ...
            latest_dag_version = DagVersion.get_lastest_version(dag.dag_id, session=session)
    ...
    def _verify_integrity_if_dag_changed(self, dag_run: DagRun, session: Session) -> bool:
        ...
        """
        latest_dag_version = DagVersion.get_lastest_version(dag_run.dag_id, session=session)
        ...
        dag_run.dag_version = DagVersion.get_lastest_version(dag_run.dag_id, session=session)
