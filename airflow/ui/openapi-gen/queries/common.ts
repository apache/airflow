...
export const UseAssetServiceGetAssetsKeyFn = ({ dagIds, limit, namePattern, offset, orderBy, uriPattern }: {
  dagIds?: string[];
  limit?: number;
  namePattern?: string;
  offset?: number;
  orderBy?: string;
  uriPattern?: string;
} = {}, queryKey?: Array<unknown>) => [useAssetServiceGetAssetsKey, ...(queryKey ?? [{ dagIds, limit, namePattern, offset, orderBy, uriPattern }])];
...
export type DagsServiceRecentDagRunsQueryResult<TData = DagsServiceRecentDagRunsDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useDagsServiceRecentDagRunsKey = "DagsServiceRecentDagRuns";
export const UseDagsServiceRecentDagRunsKeyFn = ({ dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, lastDagRunState, limit, offset, onlyActive, owners, paused, tags }: {
  ...
  paused?: boolean;
  tags?: string[];
} = {}, queryKey?: Array<unknown>) => [useDagsServiceRecentDagRunsKey, ...(queryKey ?? [{ dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, lastDagRunState, limit, offset, onlyActive, owners, paused, tags }])];
...
export const UseStructureServiceStructureDataKeyFn = ({ dagId, externalDependencies, includeDownstream, includeUpstream, root }: {
  dagId: string;
  externalDependencies?: boolean;
  includeDownstream?: boolean;
  includeUpstream?: boolean;
  root?: string;
}, queryKey?: Array<unknown>) => [useStructureServiceStructureDataKey, ...(queryKey ?? [{ dagId, externalDependencies, includeDownstream, includeUpstream, root }])];
...
export const UseBackfillServiceListBackfillsKeyFn = ({ active, dagId, limit, offset, orderBy }: {
  active?: boolean;
  dagId?: string;
  limit?: number;
  offset?: number;
  orderBy?: string;
} = {}, queryKey?: Array<unknown>) => [useBackfillServiceListBackfillsKey, ...(queryKey ?? [{ active, dagId, limit, offset, orderBy }])];
export type BackfillServiceListBackfills1DefaultResponse = Awaited<ReturnType<typeof BackfillService.listBackfills1>>;
export type BackfillServiceListBackfills1QueryResult<TData = BackfillServiceListBackfills1DefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useBackfillServiceListBackfills1Key = "BackfillServiceListBackfills1";
export const UseBackfillServiceListBackfills1KeyFn = ({ dagId, limit, offset, orderBy }: {
  dagId: string;
  limit?: number;
  offset?: number;
  orderBy?: string;
}, queryKey?: Array<unknown>) => [useBackfillServiceListBackfills1Key, ...(queryKey ?? [{ dagId, limit, offset, orderBy }])];
...
export const UseGridServiceGridDataKeyFn = ({ dagId, includeDownstream, includeUpstream, limit, logicalDateGte, logicalDateLte, offset, orderBy, root, runType, state }: {
  dagId: string;
  includeDownstream?: boolean;
  includeUpstream?: boolean;
  limit?: number;
  ...
  runType?: string[];
  state?: string[];
}, queryKey?: Array<unknown>) => [useGridServiceGridDataKey, ...(queryKey ?? [{ dagId, includeDownstream, includeUpstream, limit, logicalDateGte, logicalDateLte, offset, orderBy, root, runType, state }])];
...
export const UseDagRunServiceGetDagRunsKeyFn = ({ dagId, endDateGte, endDateLte, limit, logicalDateGte, logicalDateLte, offset, orderBy, startDateGte, startDateLte, state, updatedAtGte, updatedAtLte }: {
  dagId: string;
  endDateGte?: string;
  endDateLte?: string;
  limit?: number;
  ...
  updatedAtGte?: string;
  updatedAtLte?: string;
}, queryKey?: Array<unknown>) => [useDagRunServiceGetDagRunsKey, ...(queryKey ?? [{ dagId, endDateGte, endDateLte, limit, logicalDateGte, logicalDateLte, offset, orderBy, startDateGte, startDateLte, state, updatedAtGte, updatedAtLte }])];
...
export const UseExtraLinksServiceGetExtraLinksKeyFn = ({ dagId, dagRunId, taskId }: {
  dagId: string;
  dagRunId: string;
  taskId: string;
}, queryKey?: Array<unknown>) => [useExtraLinksServiceGetExtraLinksKey, ...(queryKey ?? [{ dagId, dagRunId, taskId }])];
...
export const UseTaskInstanceServiceGetExtraLinksKeyFn = ({ dagId, dagRunId, taskId }: {
  dagId: string;
  dagRunId: string;
  taskId: string;
}, queryKey?: Array<unknown>) => [useTaskInstanceServiceGetExtraLinksKey, ...(queryKey ?? [{ dagId, dagRunId, taskId }])];
...
export const UseTaskInstanceServiceGetMappedTaskInstancesKeyFn = ({ dagId, dagRunId, durationGte, durationLte, endDateGte, endDateLte, executor, limit, logicalDateGte, logicalDateLte, offset, orderBy, pool, queue, startDateGte, startDateLte, state, taskId, updatedAtGte, updatedAtLte }: {
  dagId: string;
  dagRunId: string;
  durationGte?: number;
  durationLte?: number;
  ...
  updatedAtGte?: string;
  updatedAtLte?: string;
}, queryKey?: Array<unknown>) => [useTaskInstanceServiceGetMappedTaskInstancesKey, ...(queryKey ?? [{ dagId, dagRunId, durationGte, durationLte, endDateGte, endDateLte, executor, limit, logicalDateGte, logicalDateLte, offset, orderBy, pool, queue, startDateGte, startDateLte, state, taskId, updatedAtGte, updatedAtLte }])];
...
export type TaskInstanceServiceGetTaskInstanceDependencies1DefaultResponse = Awaited<ReturnType<typeof TaskInstanceService.getTaskInstanceDependencies1>>;
export type TaskInstanceServiceGetTaskInstanceDependencies1QueryResult<TData = TaskInstanceServiceGetTaskInstanceDependencies1DefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useTaskInstanceServiceGetTaskInstanceDependencies1Key = "TaskInstanceServiceGetTaskInstanceDependencies1";
export const UseTaskInstanceServiceGetTaskInstanceDependencies1KeyFn = ({ dagId, dagRunId, mapIndex, taskId }: {
  dagId: string;
  dagRunId: string;
  mapIndex?: number;
  taskId: string;
}, queryKey?: Array<unknown>) => [useTaskInstanceServiceGetTaskInstanceDependencies1Key, ...(queryKey ?? [{ dagId, dagRunId, mapIndex, taskId }])];
...
export const UseTaskInstanceServiceGetTaskInstancesKeyFn = ({ dagId, dagRunId, durationGte, durationLte, endDateGte, endDateLte, executor, limit, logicalDateGte, logicalDateLte, offset, orderBy, pool, queue, startDateGte, startDateLte, state, taskDisplayNamePattern, taskId, updatedAtGte, updatedAtLte }: {
  dagId: string;
  dagRunId: string;
  durationGte?: number;
  durationLte?: number;
  ...
  updatedAtGte?: string;
  updatedAtLte?: string;
}, queryKey?: Array<unknown>) => [useTaskInstanceServiceGetTaskInstancesKey, ...(queryKey ?? [{ dagId, dagRunId, durationGte, durationLte, endDateGte, endDateLte, executor, limit, logicalDateGte, logicalDateLte, offset, orderBy, pool, queue, startDateGte, startDateLte, state, taskDisplayNamePattern, taskId, updatedAtGte, updatedAtLte }])];
...
export const UsePoolServiceGetPoolsKeyFn = ({ limit, offset, orderBy }: {
  ...
  offset?: number;
  orderBy?: string;
} = {}, queryKey?: Array<unknown>) => [usePoolServiceGetPoolsKey, ...(queryKey ?? [{ limit, offset, orderBy }])];
...
export type VariableServiceImportVariablesMutationResult = Awaited<ReturnType<typeof VariableService.importVariables>>;
...
export type ConnectionServicePutConnectionsMutationResult = Awaited<ReturnType<typeof ConnectionService.putConnections>>;
...
export type TaskInstanceServicePatchTaskInstance1MutationResult = Awaited<ReturnType<typeof TaskInstanceService.patchTaskInstance1>>;
