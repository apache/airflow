...
import { AssetService, ConnectionService, DagRunService, DagService, DashboardService, MonitorService, VariableService } from "../requests/services.gen";
...
export const UseDagServiceGetDagsKeyFn = ({ dagDisplayNamePattern, dagIdPattern, lastDagRunState, limit, offset, onlyActive, orderBy, owners, paused, tags }: {
  ...
  paused?: boolean;
  tags?: string[];
} = {}, queryKey?: Array<unknown>) => [useDagServiceGetDagsKey, ...(queryKey ?? [{ dagDisplayNamePattern, dagIdPattern, lastDagRunState, limit, offset, onlyActive, orderBy, owners, paused, tags }])];
...
export const UseConnectionServiceGetConnectionsKeyFn = ({ limit, offset, orderBy }: {
  limit?: number;
  offset?: number;
  orderBy?: string;
} = {}, queryKey?: Array<unknown>) => [useConnectionServiceGetConnectionsKey, ...(queryKey ?? [{ limit, offset, orderBy }])];
