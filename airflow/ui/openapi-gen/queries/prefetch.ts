...
* @throws ApiError
*/
export const prefetchUseAssetServiceGetAssets = (queryClient: QueryClient, { dagIds, limit, namePattern, offset, orderBy, uriPattern }: {
  dagIds?: string[];
  limit?: number;
  namePattern?: string;
  offset?: number;
  orderBy?: string;
  uriPattern?: string;
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseAssetServiceGetAssetsKeyFn({ dagIds, limit, namePattern, offset, orderBy, uriPattern }), queryFn: () => AssetService.getAssets({ dagIds, limit, namePattern, offset, orderBy, uriPattern }) });
/**
* Get Asset Aliases
* Get asset aliases.
* @param data The data for the request.
...
* @throws ApiError
*/
export const prefetchUseDagsServiceRecentDagRuns = (queryClient: QueryClient, { dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, lastDagRunState, limit, offset, onlyActive, owners, paused, tags }: {
  ...
  paused?: boolean;
  tags?: string[];
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseDagsServiceRecentDagRunsKeyFn({ dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, lastDagRunState, limit, offset, onlyActive, owners, paused, tags }), queryFn: () => DagsService.recentDagRuns({ dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, lastDagRunState, limit, offset, onlyActive, owners, paused, tags }) });
/**
* Historical Metrics
...
* @throws ApiError
*/
export const prefetchUseStructureServiceStructureData = (queryClient: QueryClient, { dagId, externalDependencies, includeDownstream, includeUpstream, root }: {
  dagId: string;
  externalDependencies?: boolean;
  includeDownstream?: boolean;
  includeUpstream?: boolean;
  root?: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseStructureServiceStructureDataKeyFn({ dagId, externalDependencies, includeDownstream, includeUpstream, root }), queryFn: () => StructureService.structureData({ dagId, externalDependencies, includeDownstream, includeUpstream, root }) });
/**
* List Backfills
* @param data The data for the request.
* @param data.limit
...
* @throws ApiError
*/
export const prefetchUseBackfillServiceListBackfills = (queryClient: QueryClient, { active, dagId, limit, offset, orderBy }: {
  active?: boolean;
  dagId?: string;
  limit?: number;
  offset?: number;
  orderBy?: string;
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseBackfillServiceListBackfillsKeyFn({ active, dagId, limit, offset, orderBy }), queryFn: () => BackfillService.listBackfills({ active, dagId, limit, offset, orderBy }) });
/**
* List Backfills
* @param data The data for the request.
* @param data.dagId
...
* @throws ApiError
*/
export const prefetchUseBackfillServiceListBackfills1 = (queryClient: QueryClient, { dagId, limit, offset, orderBy }: {
  dagId: string;
  limit?: number;
  offset?: number;
  orderBy?: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseBackfillServiceListBackfills1KeyFn({ dagId, limit, offset, orderBy }), queryFn: () => BackfillService.listBackfills1({ dagId, limit, offset, orderBy }) });
/**
* Get Backfill
* @param data The data for the request.
...
* @throws ApiError
*/
export const prefetchUseGridServiceGridData = (queryClient: QueryClient, { dagId, includeDownstream, includeUpstream, limit, logicalDateGte, logicalDateLte, offset, orderBy, root, runType, state }: {
  dagId: string;
  includeDownstream?: boolean;
  includeUpstream?: boolean;
  limit?: number;
  ...
  runType?: string[];
  state?: string[];
}) => queryClient.prefetchQuery({ queryKey: Common.UseGridServiceGridDataKeyFn({ dagId, includeDownstream, includeUpstream, limit, logicalDateGte, logicalDateLte, offset, orderBy, root, runType, state }), queryFn: () => GridService.gridData({ dagId, includeDownstream, includeUpstream, limit, logicalDateGte, logicalDateLte, offset, orderBy, root, runType, state }) });
/**
* Get Connection
...
* @throws ApiError
*/
export const prefetchUseConnectionServiceGetConnections = (queryClient: QueryClient, { limit, offset, orderBy }: {
  limit?: number;
  offset?: number;
  orderBy?: string;
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseConnectionServiceGetConnectionsKeyFn({ limit, offset, orderBy }), queryFn: () => ConnectionService.getConnections({ limit, offset, orderBy }) });
/**
* Get Dag Run
* @param data The data for the request.
* @param data.dagId
...
* @throws ApiError
*/
export const prefetchUseDagRunServiceGetDagRuns = (queryClient: QueryClient, { dagId, endDateGte, endDateLte, limit, logicalDateGte, logicalDateLte, offset, orderBy, startDateGte, startDateLte, state, updatedAtGte, updatedAtLte }: {
  dagId: string;
  endDateGte?: string;
  endDateLte?: string;
  limit?: number;
...
* @throws ApiError
*/
export const prefetchUseDagServiceGetDags = (queryClient: QueryClient, { dagDisplayNamePattern, dagIdPattern, lastDagRunState, limit, offset, onlyActive, orderBy, owners, paused, tags }: {
  dagDisplayNamePattern?: string;
  dagIdPattern?: string;
  lastDagRunState?: DagRunState;
  limit?: number;
  ...
  paused?: boolean;
  tags?: string[];
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseDagServiceGetDagsKeyFn({ dagDisplayNamePattern, dagIdPattern, lastDagRunState, limit, offset, onlyActive, orderBy, owners, paused, tags }), queryFn: () => DagService.getDags({ dagDisplayNamePattern, dagIdPattern, lastDagRunState, limit, offset, onlyActive, orderBy, owners, paused, tags }) });
/**
* Get Dag
...
* @throws ApiError
*/
export const prefetchUseExtraLinksServiceGetExtraLinks = (queryClient: QueryClient, { dagId, dagRunId, taskId }: {
  dagId: string;
  dagRunId: string;
  taskId: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseExtraLinksServiceGetExtraLinksKeyFn({ dagId, dagRunId, taskId }), queryFn: () => ExtraLinksService.getExtraLinks({ dagId, dagRunId, taskId }) });
/**
* Get Extra Links
* Get extra links for task instance.
* @param data The data for the request.
...
* @throws ApiError
*/
export const prefetchUseTaskInstanceServiceGetExtraLinks = (queryClient: QueryClient, { dagId, dagRunId, taskId }: {
  dagId: string;
  dagRunId: string;
  taskId: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseTaskInstanceServiceGetExtraLinksKeyFn({ dagId, dagRunId, taskId }), queryFn: () => TaskInstanceService.getExtraLinks({ dagId, dagRunId, taskId }) });
/**
* Get Task Instance
* Get task instance.
* @param data The data for the request.
...
* @throws ApiError
*/
export const prefetchUseTaskInstanceServiceGetMappedTaskInstances = (queryClient: QueryClient, { dagId, dagRunId, durationGte, durationLte, endDateGte, endDateLte, executor, limit, logicalDateGte, logicalDateLte, offset, orderBy, pool, queue, startDateGte, startDateLte, state, taskId, updatedAtGte, updatedAtLte }: {
  dagId: string;
  dagRunId: string;
  durationGte?: number;
  durationLte?: number;
  ...
  updatedAtGte?: string;
  updatedAtLte?: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseTaskInstanceServiceGetMappedTaskInstancesKeyFn({ dagId, dagRunId, durationGte, durationLte, endDateGte, endDateLte, executor, limit, logicalDateGte, logicalDateLte, offset, orderBy, pool, queue, startDateGte, startDateLte, state, taskId, updatedAtGte, updatedAtLte }), queryFn: () => TaskInstanceService.getMappedTaskInstances({ dagId, dagRunId, durationGte, durationLte, endDateGte, endDateLte, executor, limit, logicalDateGte, logicalDateLte, offset, orderBy, pool, queue, startDateGte, startDateLte, state, taskId, updatedAtGte, updatedAtLte }) });
/**
...
* @throws ApiError
*/
export const prefetchUseTaskInstanceServiceGetTaskInstanceDependencies1 = (queryClient: QueryClient, { dagId, dagRunId, mapIndex, taskId }: {
  dagId: string;
  dagRunId: string;
  mapIndex?: number;
  taskId: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseTaskInstanceServiceGetTaskInstanceDependencies1KeyFn({ dagId, dagRunId, mapIndex, taskId }), queryFn: () => TaskInstanceService.getTaskInstanceDependencies1({ dagId, dagRunId, mapIndex, taskId }) });
/**
...
* @throws ApiError
*/
export const prefetchUseTaskInstanceServiceGetTaskInstances = (queryClient: QueryClient, { dagId, dagRunId, durationGte, durationLte, endDateGte, endDateLte, executor, limit, logicalDateGte, logicalDateLte, offset, orderBy, pool, queue, startDateGte, startDateLte, state, taskDisplayNamePattern, taskId, updatedAtGte, updatedAtLte }: {
  dagId: string;
  dagRunId: string;
  durationGte?: number;
  durationLte?: number;
...
* @throws ApiError
*/
export const prefetchUsePoolServiceGetPools = (queryClient: QueryClient, { limit, offset, orderBy }: {
  limit?: number;
  offset?: number;
  orderBy?: string;
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UsePoolServiceGetPoolsKeyFn({ limit, offset, orderBy }), queryFn: () => PoolService.getPools({ limit, offset, orderBy }) });
/**
* Get Providers
* Get providers.
* @param data The data for the request.
