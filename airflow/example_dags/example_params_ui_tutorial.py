...
The DAG attribute `params` is used to define a default dictionary of parameters which are usually passed to the DAG and
which are used to render a trigger form.
"""
...
<table width="100%" cellspacing="5"><tbody><tr><td>
    ...
    <div id="preview_{name}" style="line-height: 40px; margin-bottom: 7px; width: 100%; background-color: {value};">&nbsp;</div>
    <input class="form-control" type="text" maxlength="7" id="{name}" name="{name}" value="{value}" onchange="v_{name}()" />
</td></tr><tr><td>
...
with DAG(
    ...
    tags=["example_ui"],
    params={
        # Let's start simple: Standard dict values are detected from type and are offered as entry form fields.
        ...
        "most_loved_number": Param(
            ...
            "If you can not think of any at the moment please think of the 42 which is very famous because of the book "
        ...
        "optional_field": Param(
            ...
            description="This field is optional. As field content is JSON schema validated you must allow the "
            "<code>null</code> type.",
        ),
        ...
        "checked_text": Param(
            ...
            description="This field is required. And you need to provide something between 10 and 30 characters. "
            "See the <a href='https://json-schema.org/understanding-json-schema/reference/string.html'>"
        ...
        "color_picker": Param(
            ...
            "    <li><code>{value}</code>: (Default) value that should be displayed when showing/loading the form.</li>"
    ...
    def show_params(ti: TaskInstance = None) -> None:
        ...
        print(
            f"This DAG was triggert with the following parameters:\n{json.dumps(ti.dag_run.conf, indent=4)}"
        )
