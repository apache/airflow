...
with DAG(dag_id="hello6c", start_date=pendulum.now()):
    w1 = BashOperator(task_id="w1", bash_command="echo 'Hello from root_setup'")
    s1 = BashOperator.as_setup(task_id="s1", bash_command="echo 'Hello from root_setup'")
    s2 = BashOperator.as_setup(task_id="s2", bash_command="echo 'Hello from root_setup'")
    t1 = BashOperator.as_teardown(task_id="t1", bash_command="echo 'Hello from root_setup'")
...
with DAG(dag_id="hello6d", start_date=pendulum.now()):
    w1 = BashOperator(task_id="w1", bash_command="echo 'Hello from root_setup'")
    s1 = BashOperator.as_setup(task_id="s1", bash_command="echo 'Hello from root_setup'")
    s2 = BashOperator.as_setup(task_id="s2", bash_command="echo 'Hello from root_setup'")
    t1 = BashOperator.as_teardown(task_id="t1", bash_command="echo 'Hello from root_setup'")
    t2 = BashOperator.as_teardown(task_id="t2", bash_command="echo 'Hello from root_setup'")
    with s1 >> [t1, t2]:
        w2 = BashOperator(task_id="w2", bash_command="echo 'Hello from root_setup'")
...
with DAG(dag_id="hello9", start_date=pendulum.now()):
    ...
    w1 >> s1  # since we don't mutate s1, this is not a problem
...
with DAG(dag_id="hello10", start_date=pendulum.now()):
    w1 = BashOperator(task_id="w1", bash_command="echo 'Hello from root_setup'")
...
with pytest.raises(RuntimeError, match="May only set one level of deps in context mgr"):
    with DAG(dag_id="hello6b", start_date=pendulum.now()):
        w1 = BashOperator(task_id="w1", bash_command="echo 'Hello from root_setup'")
        s1 = BashOperator.as_setup(task_id="s1", bash_command="echo 'Hello from root_setup'")
        s2 = BashOperator.as_setup(task_id="s2", bash_command="echo 'Hello from root_setup'")
        t1 = BashOperator.as_teardown(task_id="t1", bash_command="echo 'Hello from root_setup'")
...
with DAG(dag_id="hello11", start_date=pendulum.now()):
...
with DAG(dag_id="hello11a", start_date=pendulum.now()):
    with TaskGroup("group") as tg:
        w1 = BashOperator(task_id="w1", bash_command="echo 'Hello from root_setup'")
...
with pytest.raises(RuntimeError, match="May only set one level of deps in context mgr"):
    with DAG(dag_id="hello11b", start_date=pendulum.now()):
        with TaskGroup("group") as tg:
            w1 = BashOperator(task_id="w1", bash_command="echo 'Hello from root_setup'")
