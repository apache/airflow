...
from typing import Any, Callable, Collection, Dict, Iterable, Mapping, Optional, Tuple, Union
...
class PythonOperator(BaseOperator):
    ...
    template_fields: Iterable[str] = ('templates_dict', 'op_args', 'op_kwargs')
