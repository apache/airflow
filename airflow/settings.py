...
# If the flag is set to False, we remove the 'console' handler from the root logger
# and add 'task' handler from 'airflow.task' logger to the root Logger. This is done
