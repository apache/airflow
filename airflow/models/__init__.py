...
from airflow import settings, utils, plugins_manager
...
class DagBag(BaseDagBag, LoggingMixin):
    ...
    def __init__(
        ...
        self.put_dag_plugins_on_disk(dag_folder)
        self.collect_dags(
            dag_folder=dag_folder,
            include_examples=include_examples,
            safe_mode=safe_mode)
        self.collect_dags_from_plugins()
    ...
    def put_dag_plugins_on_disk(self, dag_folder):
        for plugin in plugins_manager.dag_sources:
            plugin.put_dags_on_disk(
                dag_folder=dag_folder
            )

    def collect_dags_from_plugins(self):
        """
        Provide an entrypoint for plugins to inject dags directly
        into the dagbag
        """
        ...
        for plugin in plugins_manager.dag_sources:
            ...
            # @TODO Extend dagbag loading report to include plugins
