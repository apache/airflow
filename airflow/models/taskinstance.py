...
def _get_template_context(
    *,
    ...
    def get_next_logical_date() -> pendulum.DateTime | None:
        ...
        # to execution date for consistency with how logical_date is set
    ...
    def get_next_ds() -> str | None:
        logical_date = get_next_logical_date()
    ...
    def get_prev_ds() -> str | None:
        logical_date = get_prev_logical_date()
        if logical_date is None:
            return None
        return logical_date.strftime("%Y-%m-%d")
...
def _handle_failure(
    *,
    ...
    with Trace.start_span_from_taskinstance(ti=task_instance) as span:
        ...
        span.set_attribute("logical_date", str(task_instance.logical_date))
