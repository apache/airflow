...
class DAG(LoggingMixin):
    ...
    :param catchup: Perform scheduler catchup (or only run latest)? Defaults to enable.
    ...
    def iter_dagrun_infos_between(
        ...
        *,
        ...
        restriction = TimeRestriction(earliest, latest, catchup=Catchup.ENABLE)
