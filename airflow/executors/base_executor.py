...
class BaseExecutor(LoggingMixin):
    ...
    def heartbeat(self) -> None:
        ...
        Stats.gauge("executor.open_slots", value=open_slots, tags={"status": "open", **name})
        Stats.gauge("executor.queued_tasks", value=num_queued_tasks, tags={"status": "queued", **name})
        Stats.gauge("executor.running_tasks", value=num_running_tasks, tags={"status": "running", **name})
