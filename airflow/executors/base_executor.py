...
QueuedTaskInstance = Tuple[CommandType, int, Optional[str], SimpleTaskInstance]
...
class BaseExecutor(LoggingMixin):
    ...
    def __init__(self, parallelism: int = PARALLELISM):
        ...
        self.queued_tasks: OrderedDict[TaskInstanceKey, QueuedTaskInstance] \
            = OrderedDict()
        self.running: Set[TaskInstanceKey] = set()
        self.event_buffer: Dict[TaskInstanceKey, str] = {}
    ...
    def get_event_buffer(self, dag_ids=None) -> Dict[TaskInstanceKey, str]:
        ...
        """
        cleared_events: Dict[TaskInstanceKey, str] = dict()
        if dag_ids is None:
