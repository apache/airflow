...
from airflow.executors.base_executor import BaseExecutor, CommandType, QueuedTaskInstance
from airflow.models.taskinstance import SimpleTaskInstance, TaskInstanceKey, TaskInstanceState
...
@app.task
def execute_command(command_to_exec: str):
    """Executes command."""
...
def fetch_celery_task_state(celery_task: Tuple[TaskInstanceKey, AsyncResult]) \
        -> Union[TaskInstanceState, ExceptionWithTraceback]:
    """
...
class CeleryExecutor(BaseExecutor):
    ...
    def order_queued_tasks_by_priority(self) -> List[Tuple[TaskInstanceKey, QueuedTaskInstance]]:
        """
    ...
    def update_task_states(self, task_keys_to_states: List[Union[TaskInstanceState, ExceptionWithTraceback]]):
    ...
    def update_task_state(self, key: TaskInstanceKey, state: str):
