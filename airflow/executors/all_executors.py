...
class AllExecutors:
    ...
    def get_default_executor(cls) -> BaseExecutor:
        ...
        cls._default_executor = AllExecutors._get_executor(executor_name)
    ...
    def _get_executor(executor_name: str) -> BaseExecutor:
        ...
        """
        if executor_name == AllExecutors.LOCAL_EXECUTOR:
            from airflow.executors.local_executor import LocalExecutor
            return LocalExecutor()
        elif executor_name == AllExecutors.SEQUENTIAL_EXECUTOR:
            from airflow.executors.sequential_executor import SequentialExecutor
            return SequentialExecutor()
        elif executor_name == AllExecutors.CELERY_EXECUTOR:
            from airflow.executors.celery_executor import CeleryExecutor
            return CeleryExecutor()
        elif executor_name == AllExecutors.DASK_EXECUTOR:
            from airflow.executors.dask_executor import DaskExecutor
            return DaskExecutor()
        elif executor_name == AllExecutors.KUBERNETES_EXECUTOR:
            ...
            plugins_manager._integrate_plugins()  # pylint: disable=protected-access
