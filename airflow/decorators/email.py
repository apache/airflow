...
class _EmailDecoratedOperator(DecoratedOperator, EmailOperator):
    """
    ...
    template_fields: Sequence[str] = (*DecoratedOperator.template_fields, *EmailOperator.template_fields)
    template_fields_renderers: dict[str, str] = {
        **DecoratedOperator.template_fields_renderers,
        **EmailOperator.template_fields_renderers,
    }

    custom_operator_name: str = "@task.email"
    ...
    def execute(self, context: Context) -> Any:
        ...
        self.html_content = self.python_callable(*self.op_args, **kwargs)

        if not isinstance(self.html_content, str) or self.html_content.strip() == "":
...
def email_task(
    ...
    **kwargs,
    ...
    """
    Wrap a function into a EmailOperator.
    ...
    return task_decorator_factory(
        python_callable=python_callable,
        decorated_operator_class=_EmailDecoratedOperator,
        **kwargs,
    )
