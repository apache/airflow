...
class DecoratedOperator(BaseOperator):
    ...
    def execute(self, context: Dict):
        ...
        self.handle_output(return_value=return_value, context=context, xcom_push=self.xcom_push)
        return return_value

    def handle_output(self, return_value: Any, context: Dict, xcom_push: Callable):
        """
