...
class Airflow(AirflowBaseView):  # noqa: D101  pylint: disable=too-many-public-methods
    ...
    def index(self):  # pylint: disable=too-many-locals,too-many-statements
        ...
        filter_dag_ids = current_app.appbuilder.sm.get_readable_dag_ids()
    ...
    def dag_stats(self, session=None):
        ...
        allowed_dag_ids = current_app.appbuilder.sm.get_readable_dag_ids()
    ...
    def task_stats(self, session=None):
        """Task Statistics"""
        allowed_dag_ids = set(current_app.appbuilder.sm.get_readable_dag_ids())
