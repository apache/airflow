...
class SlaMissModelView(AirflowModelView):
    ...
    list_columns = ["dag_id", "task_id", "logical_date", "email_sent", "notification_sent", "timestamp"]

    label_columns = {
        "logical_date": "Logical Date",
    }

    add_columns = ["dag_id", "task_id", "logical_date", "email_sent", "notification_sent", "timestamp"]
    edit_columns = ["dag_id", "task_id", "logical_date", "email_sent", "notification_sent", "timestamp"]
    search_columns = ["dag_id", "task_id", "email_sent", "notification_sent", "timestamp", "logical_date"]
