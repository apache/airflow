...
export type Backfill = CamelCasedPropertiesDeep<components['schemas']['Backfill']>;
export type BackfillCollection = CamelCasedPropertiesDeep<components['schemas']['BackfillCollection']>;
...
export type DagStatsCollectionSchema = CamelCasedPropertiesDeep<components['schemas']['DagStatsCollectionSchema']>;
export type DagStatsCollectionItem = CamelCasedPropertiesDeep<components['schemas']['DagStatsCollectionItem']>;
export type DagStatsStateCollectionItem = CamelCasedPropertiesDeep<components['schemas']['DagStatsStateCollectionItem']>;
...
export type TriggererStatus = CamelCasedPropertiesDeep<components['schemas']['TriggererStatus']>;
export type DagProcessorStatus = CamelCasedPropertiesDeep<components['schemas']['DagProcessorStatus']>;
...
export type TaskFailedDependency = CamelCasedPropertiesDeep<components['schemas']['TaskFailedDependency']>;
export type TaskInstanceDependencyCollection = CamelCasedPropertiesDeep<components['schemas']['TaskInstanceDependencyCollection']>;
...
export type TaskOutletAssetReference = CamelCasedPropertiesDeep<components['schemas']['TaskOutletAssetReference']>;
export type DagScheduleAssetReference = CamelCasedPropertiesDeep<components['schemas']['DagScheduleAssetReference']>;
export type AssetCollection = CamelCasedPropertiesDeep<components['schemas']['AssetCollection']>;
export type AssetEvent = CamelCasedPropertiesDeep<components['schemas']['AssetEvent']>;
export type CreateAssetEvent = CamelCasedPropertiesDeep<components['schemas']['CreateAssetEvent']>;
export type QueuedEvent = CamelCasedPropertiesDeep<components['schemas']['QueuedEvent']>;
export type QueuedEventCollection = CamelCasedPropertiesDeep<components['schemas']['QueuedEventCollection']>;
export type BasicDAGRun = CamelCasedPropertiesDeep<components['schemas']['BasicDAGRun']>;
export type AssetEventCollection = CamelCasedPropertiesDeep<components['schemas']['AssetEventCollection']>;
...
export type UpdateTaskState = CamelCasedPropertiesDeep<components['schemas']['UpdateTaskState']>;
...
export type ListBackfillsVariables = CamelCasedPropertiesDeep<operations['list_backfills']['parameters']['query']>;
export type CreateBackfillVariables = CamelCasedPropertiesDeep<operations['create_backfill']['requestBody']['content']['application/json']>;
export type GetBackfillVariables = CamelCasedPropertiesDeep<operations['get_backfill']['parameters']['path']>;
export type PauseBackfillVariables = CamelCasedPropertiesDeep<operations['pause_backfill']['parameters']['path']>;
export type UnpauseBackfillVariables = CamelCasedPropertiesDeep<operations['unpause_backfill']['parameters']['path']>;
export type CancelBackfillVariables = CamelCasedPropertiesDeep<operations['cancel_backfill']['parameters']['path']>;
...
export type GetDagVariables = CamelCasedPropertiesDeep<operations['get_dag']['parameters']['path'] & operations['get_dag']['parameters']['query']>;
...
export type GetTaskInstanceDependenciesVariables = CamelCasedPropertiesDeep<operations['get_task_instance_dependencies']['parameters']['path']>;
export type GetMappedTaskInstanceDependenciesVariables = CamelCasedPropertiesDeep<operations['get_mapped_task_instance_dependencies']['parameters']['path']>;
...
export type GetDagRunVariables = CamelCasedPropertiesDeep<operations['get_dag_run']['parameters']['path'] & operations['get_dag_run']['parameters']['query']>;
...
export type GetUpstreamAssetEventsVariables = CamelCasedPropertiesDeep<operations['get_upstream_asset_events']['parameters']['path']>;
...
export type GetDagAssetQueuedEventVariables = CamelCasedPropertiesDeep<operations['get_dag_asset_queued_event']['parameters']['path'] & operations['get_dag_asset_queued_event']['parameters']['query']>;
export type DeleteDagAssetQueuedEventVariables = CamelCasedPropertiesDeep<operations['delete_dag_asset_queued_event']['parameters']['path'] & operations['delete_dag_asset_queued_event']['parameters']['query']>;
export type GetDagAssetQueuedEventsVariables = CamelCasedPropertiesDeep<operations['get_dag_asset_queued_events']['parameters']['path'] & operations['get_dag_asset_queued_events']['parameters']['query']>;
export type DeleteDagAssetQueuedEventsVariables = CamelCasedPropertiesDeep<operations['delete_dag_asset_queued_events']['parameters']['path'] & operations['delete_dag_asset_queued_events']['parameters']['query']>;
export type ReparseDagFileVariables = CamelCasedPropertiesDeep<operations['reparse_dag_file']['parameters']['path']>;
export type GetAssetQueuedEventsVariables = CamelCasedPropertiesDeep<operations['get_asset_queued_events']['parameters']['path'] & operations['get_asset_queued_events']['parameters']['query']>;
export type DeleteAssetQueuedEventsVariables = CamelCasedPropertiesDeep<operations['delete_asset_queued_events']['parameters']['path'] & operations['delete_asset_queued_events']['parameters']['query']>;
...
export type GetTaskInstanceTryDetailsVariables = CamelCasedPropertiesDeep<operations['get_task_instance_try_details']['parameters']['path']>;
export type GetTaskInstanceTriesVariables = CamelCasedPropertiesDeep<operations['get_task_instance_tries']['parameters']['path'] & operations['get_task_instance_tries']['parameters']['query']>;
export type GetMappedTaskInstanceTriesVariables = CamelCasedPropertiesDeep<operations['get_mapped_task_instance_tries']['parameters']['path'] & operations['get_mapped_task_instance_tries']['parameters']['query']>;
export type GetMappedTaskInstanceTryDetailsVariables = CamelCasedPropertiesDeep<operations['get_mapped_task_instance_try_details']['parameters']['path']>;
...
export type GetDagDetailsVariables = CamelCasedPropertiesDeep<operations['get_dag_details']['parameters']['path'] & operations['get_dag_details']['parameters']['query']>;
...
export type GetDagStatsVariables = CamelCasedPropertiesDeep<operations['get_dag_stats']['parameters']['query']>;
...
export type GetAssetsVariables = CamelCasedPropertiesDeep<operations['get_assets']['parameters']['query']>;
export type GetAssetVariables = CamelCasedPropertiesDeep<operations['get_asset']['parameters']['path']>;
export type GetAssetEventsVariables = CamelCasedPropertiesDeep<operations['get_asset_events']['parameters']['query']>;
export type CreateAssetEventVariables = CamelCasedPropertiesDeep<operations['create_asset_event']['requestBody']['content']['application/json']>;
export type GetConfigVariables = CamelCasedPropertiesDeep<operations['get_config']['parameters']['query']>;
export type GetValueVariables = CamelCasedPropertiesDeep<operations['get_value']['parameters']['path']>;
