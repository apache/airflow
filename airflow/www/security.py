...
class AirflowSecurityManager(SecurityManager, LoggingMixin):  # pylint: disable=too-many-public-methods
    ...
    VIEWER_PERMISSIONS = [
        ...
        (permissions.ACTION_CAN_ACCESS_MENU, permissions.RESOURCE_DOCS_WEBSITE),
        (permissions.ACTION_CAN_ACCESS_MENU, permissions.RESOURCE_DOCS_REPO),
        (permissions.ACTION_CAN_ACCESS_MENU, permissions.RESOURCE_DOCS_API_SWAGGER),
        (permissions.ACTION_CAN_ACCESS_MENU, permissions.RESOURCE_DOCS_API_REDOC),
