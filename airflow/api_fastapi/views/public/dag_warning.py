...
from airflow.api_fastapi.serializers.dag_warning import DAGWarningCollectionResponse, DAGWarningResponse
...
async def list_dag_warnings(
    ...
    offset: QueryOffset,
    order_by: Annotated[
        SortParam, Depends(SortParam(["dag_id", "warning_type", "message", "timestamp"]).depends)
    ],
