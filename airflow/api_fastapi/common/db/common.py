...
def apply_filters_to_select(
    *, statement: Select, filters: Sequence[OrmFilterClause | None] | None = None
) -> Select:
    if filters is None:
        return statement
    for f in filters:
...
async def paginated_select_async(
    *,
    ...
    offset: OrmFilterClause | None = None,
    limit: OrmFilterClause | None = None,
...
async def paginated_select_async(
    *,
    statement: Select,
    filters: Sequence[OrmFilterClause | None] | None = None,
    order_by: OrmFilterClause | None = None,
    offset: OrmFilterClause | None = None,
    limit: OrmFilterClause | None = None,
    session: AsyncSession,
