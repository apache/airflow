...
def validate_logging_config(logging_config):
    ...
    if REMOTE_LOGGING and logging_config['handlers']['task'] is __stock_task_handler:
        raise AirflowConfigException(
            "[logging] remote_logging config was enabled, but no suitable backend was detected. Please check"
