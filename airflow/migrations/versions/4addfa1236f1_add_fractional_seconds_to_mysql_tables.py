...
def upgrade():
    if 'mysql' in context.config.get_main_option('sqlalchemy.url'):
        ...
        op.alter_column(table_name='task_counter', column_name='execution_date', type_=mysql.DATETIME(fsp=6), nullable=False)
...
def downgrade():
    if 'mysql' in context.config.get_main_option('sqlalchemy.url'):
        ...
        op.alter_column(table_name='task_counter', column_name='execution_date', type_=mysql.DATETIME(), nullable=False)
