...
"""Add dag_directory column to DagModel and SerializedDagModel tables.
...
def upgrade():
    """Apply Add dag_directory to DagModel and SerializedDagModel"""
    conn = op.get_bind()
...
def downgrade():
    """Unapply Add dag_directory to DagModel and SerializedDagModel"""
