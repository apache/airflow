...
mapping = {
    ...
    ("LogModelView", "can_list"): [(permissions.ACTION_CAN_READ, permissions.RESOURCE_AUDIT_LOG)],
    ("Log", "can_read"): [(permissions.ACTION_CAN_READ, permissions.RESOURCE_AUDIT_LOG)],
