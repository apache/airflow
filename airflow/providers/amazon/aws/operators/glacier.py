...
class GlacierDownloadArchiveOperator(BaseOperator):
    """
    This operator retrieves results from GlacierCreateJobOperator

    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:GlacierDownloadArchiveOperator`
    ...
    def execute(self, context):
        hook = GlacierHook(aws_conn_id="aws_default")
        response = hook.retrieve_inventory_results(vault_name=self.vault_name, job_id=self.job_id)
        return response
