...
with models.DAG(
    ...
    # [START howto_operator_datasync_simple_1]
    datasync_task_1 = AWSDataSyncOperator(
        aws_conn_id="aws_default",
        task_id="datasync_task_1",
        task_arn=TASK_ARN
    )
    # [END howto_operator_datasync_simple_1]

with models.DAG(
    "example_datasync_simple_2",
    default_args=default_args,
    schedule_interval=None,  # Override to match your needs
) as dag:
    # [START howto_operator_datasync_simple_2]
    ...
    # [END howto_operator_datasync_simple_2]
