...
from airflow.providers.microsoft.azure.hooks.functions import AzureFunctionsHook
...
class AzureFunctionsInvokeOperator(BaseOperator):
    ...
    :param method_type: request type of the Azure function POST, GET etc.
    ...
    def __init__(
        ...
        *,
        ...
        azure_functions_conn_id: str = "azure_functions_default",
        **kwargs,
    ):
    ...
    def hook(self) -> AzureFunctionsHook:
        return AzureFunctionsHook(azure_functions_conn_id=self.azure_functions_conn_id)
    ...
    def execute(self, context: Context):
        ...
        response = self.hook.run(endpoint=self.endpoint_url, data=self.payload)
