...
class LocalFileSystemToAzureStorageBlobOperator(BaseOperator):
    ...
    :type length: int
    :param upload_options: Extra optional argument to supply to `AzureStorageBlobHook.upload`
        method
    :type upload_options: Optional[dict]
    """
    ...
    def __init__(self, container_name, source_path, destination_path: Optional[str] = None,
                 ...
                 length: Optional[int] = None, upload_options=None, *args,
                 **kwargs):
        ...
        if os.path.isdir(self.source_path):
            ...
            for root, _, files in os.walk(self.source_path):
                for name in files:
                    ...
                    self._upload_single_file(self.hook, file_path, blob_path)
        else:
            ...
            self._upload_single_file(self.hook, self.source_path, self.destination_path)
