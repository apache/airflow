...
"""Setup.py for the apache-airflow-backport-providers-microsoft-winrm package."""
...
try:
    with open(
        os.path.join(my_dir, 'airflow/providers/microsoft/winrm/BACKPORT_PROVIDER_README.md'),
        encoding='utf-8',
    ) as f:
...
def do_setup(version_suffix_for_pypi=''):
    """Perform the package apache-airflow-backport-providers-microsoft-winrm setup."""
    setup(
        name='apache-airflow-backport-providers-microsoft-winrm',
        description='Backport provider package '
        'apache-airflow-backport-providers-microsoft-winrm for Apache Airflow',
        ...
        zip_safe=False,
        install_requires=['apache-airflow~=1.10', 'pywinrm~=0.4'],
