...
try:
    with open(os.path.join(my_dir, 'airflow/providers/microsoft/mssql/README.md'), encoding='utf-8') as f:
...
def do_setup(version_suffix_for_pypi=''):
    ...
    setup(
        ...
        zip_safe=False,
        install_requires=['apache-airflow>=2.0.0a0', 'pymssql~=2.1,>=2.1.5'],
