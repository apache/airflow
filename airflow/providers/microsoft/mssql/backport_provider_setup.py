...
"""Setup.py for the apache-airflow-backport-providers-microsoft-mssql package."""
...
try:
    with open(
        os.path.join(my_dir, 'airflow/providers/microsoft/mssql/BACKPORT_PROVIDER_README.md'),
        encoding='utf-8',
    ) as f:
...
def do_setup(version_suffix_for_pypi=''):
    """Perform the package apache-airflow-backport-providers-microsoft-mssql setup."""
    setup(
        name='apache-airflow-backport-providers-microsoft-mssql',
        description='Backport provider package '
        'apache-airflow-backport-providers-microsoft-mssql for Apache Airflow',
        ...
        zip_safe=False,
        install_requires=['apache-airflow~=1.10', 'pymssql~=2.1,>=2.1.5'],
        setup_requires=['setuptools', 'wheel'],
        extras_require={'odbc': ['apache-airflow-backport-providers-odbc']},
        classifiers=[
