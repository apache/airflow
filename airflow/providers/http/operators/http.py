...
# By default, SimpleHttpOperator pass a request.Response object as parameter to
# injected functions, and return a str object (from request.Response.text) as result.
Response = TypeVar("Response", bound=Union[RequestResponse, Any])
ResponseText = TypeVar("ResponseText", bound=Union[str, Any])


class SimpleHttpOperator(BaseOperator, Generic[Response, ResponseText]):
    """
    ...
    def process_response(self, context: Context, response: Response) -> Any:
    ...
    @staticmethod
    def default_response_maker(response: Response) -> ResponseText:
        return cast(ResponseText, response.text)
