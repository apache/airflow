...
try:
    with open(os.path.join(my_dir, 'airflow/providers/celery/README.md'), encoding='utf-8') as f:
...
def do_setup(version_suffix_for_pypi=''):
    ...
    setup(
        ...
        zip_safe=False,
        install_requires=['apache-airflow>=2.0.0a0', 'celery~=4.4.2', 'flower>=0.7.3, <1.0', 'vine~=1.3'],
