...
"""Setup.py for the apache-airflow-backport-providers-qubole package."""
...
try:
    with open(
        os.path.join(my_dir, 'airflow/providers/qubole/BACKPORT_PROVIDER_README.md'), encoding='utf-8'
    ) as f:
...
def do_setup(version_suffix_for_pypi=''):
    """Perform the package apache-airflow-backport-providers-qubole setup."""
    setup(
        name='apache-airflow-backport-providers-qubole',
        description='Backport provider package '
        'apache-airflow-backport-providers-qubole for Apache Airflow',
