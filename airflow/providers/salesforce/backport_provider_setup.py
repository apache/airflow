...
try:
    with open(
        os.path.join(my_dir, 'airflow/providers/salesforce/BACKPORT_PROVIDER_README.md'), encoding='utf-8'
    ) as f:
...
def do_setup(version_suffix_for_pypi=''):
    ...
    setup(
        ...
        zip_safe=False,
        install_requires=['apache-airflow~=1.10', 'simple-salesforce>=1.0.0'],
