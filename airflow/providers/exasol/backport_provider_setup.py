...
"""Setup.py for the apache-airflow-backport-providers-exasol package."""
...
try:
    with open(
        os.path.join(my_dir, 'airflow/providers/exasol/BACKPORT_PROVIDER_README.md'), encoding='utf-8'
    ) as f:
...
def do_setup(version_suffix_for_pypi=''):
    """Perform the package apache-airflow-backport-providers-exasol setup."""
    setup(
        name='apache-airflow-backport-providers-exasol',
        description='Backport provider package '
        'apache-airflow-backport-providers-exasol for Apache Airflow',
        ...
        zip_safe=False,
        install_requires=['apache-airflow~=1.10', 'pyexasol>=0.5.1,<1.0.0'],
