...
try:
    with open(os.path.join(my_dir, 'airflow/providers/apache/hive/README.md'), encoding='utf-8') as f:
...
def do_setup(version_suffix_for_pypi=''):
    ...
    setup(
        ...
        zip_safe=False,
        install_requires=['apache-airflow>=2.0.0a0', 'hmsclient>=0.1.0', 'pyhive[hive]>=0.6.0'],
