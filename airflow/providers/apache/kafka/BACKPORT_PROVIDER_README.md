...
# Package apache-airflow-backport-providers-apache-kafka
...
This is a backport providers package for `apache.kafka` provider. All classes for this provider package
...
`pip install apache-airflow-backport-providers-apache-kafka`
