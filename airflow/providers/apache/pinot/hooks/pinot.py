...
class PinotDbApiHook(DbApiHook):
    ...
    def get_records(self, sql: str, parameters: dict[str, Any] | Iterable[Any] | None = None) -> Any:
        """
    ...
    def get_first(self, sql: str, parameters: dict[str, Any] | Iterable[Any] | None = None) -> Any:
        """
