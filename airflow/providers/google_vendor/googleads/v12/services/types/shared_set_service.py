...
class MutateSharedSetsRequest(proto.Message):
    ...
    [SharedSetService.MutateSharedSets][google.ads.googleads.v12.services.SharedSetService.MutateSharedSets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose shared
            sets are being modified.
        operations (Sequence[google.ads.googleads.v12.services.types.SharedSetOperation]):
...
class SharedSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.SharedSet):
            Create operation: No resource name is
            expected for the new shared set.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v12.resources.types.SharedSet):
...
class MutateSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateSharedSetResult]):
