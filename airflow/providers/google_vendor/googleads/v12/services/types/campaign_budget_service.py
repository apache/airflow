...
class MutateCampaignBudgetsRequest(proto.Message):
    ...
    [CampaignBudgetService.MutateCampaignBudgets][google.ads.googleads.v12.services.CampaignBudgetService.MutateCampaignBudgets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign budgets are being modified.
        operations (Sequence[google.ads.googleads.v12.services.types.CampaignBudgetOperation]):
...
class CampaignBudgetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.CampaignBudget):
            Create operation: No resource name is
            expected for the new budget.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v12.resources.types.CampaignBudget):
...
class MutateCampaignBudgetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateCampaignBudgetResult]):
