...
class CustomerNegativeCriterionOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v12.resources.types.CustomerNegativeCriterion):
...
class MutateCustomerNegativeCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateCustomerNegativeCriteriaResult]):
