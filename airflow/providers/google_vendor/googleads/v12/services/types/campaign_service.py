...
class MutateCampaignsRequest(proto.Message):
    ...
    [CampaignService.MutateCampaigns][google.ads.googleads.v12.services.CampaignService.MutateCampaigns].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaigns are being modified.
        operations (Sequence[google.ads.googleads.v12.services.types.CampaignOperation]):
...
class CampaignOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.Campaign):
            Create operation: No resource name is
            expected for the new campaign.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v12.resources.types.Campaign):
...
class MutateCampaignsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateCampaignResult]):
