...
class MutateFeedItemTargetsRequest(proto.Message):
    ...
    [FeedItemTargetService.MutateFeedItemTargets][google.ads.googleads.v12.services.FeedItemTargetService.MutateFeedItemTargets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose feed
            item targets are being modified.
        operations (Sequence[google.ads.googleads.v12.services.types.FeedItemTargetOperation]):
...
class FeedItemTargetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v12.resources.types.FeedItemTarget):
...
class MutateFeedItemTargetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateFeedItemTargetResult]):
