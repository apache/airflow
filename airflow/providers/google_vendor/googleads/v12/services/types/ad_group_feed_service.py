...
class MutateAdGroupFeedsRequest(proto.Message):
    ...
    [AdGroupFeedService.MutateAdGroupFeeds][google.ads.googleads.v12.services.AdGroupFeedService.MutateAdGroupFeeds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ad
            group feeds are being modified.
        operations (Sequence[google.ads.googleads.v12.services.types.AdGroupFeedOperation]):
...
class AdGroupFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.AdGroupFeed):
...
class MutateAdGroupFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateAdGroupFeedResult]):
...
class MutateAdGroupFeedResult(proto.Message):
    ...
    ad_group_feed = proto.Field(
        proto.MESSAGE, number=2, message=gagr_ad_group_feed.AdGroupFeed,
    )
