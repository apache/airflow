...
from airflow.providers.google_vendor.googleads.v12.resources.types import customer_label
...
class CustomerLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v12.resources.types.CustomerLabel):
...
class MutateCustomerLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateCustomerLabelResult]):
