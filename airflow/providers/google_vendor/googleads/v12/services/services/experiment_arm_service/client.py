...
class ExperimentArmServiceClient(metaclass=ExperimentArmServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, ExperimentArmServiceTransport, None] = None,
        ...
        Args:
            ...
            transport (Union[str, ExperimentArmServiceTransport]): The
        ...
        if isinstance(transport, ExperimentArmServiceTransport):
    ...
    def mutate_experiment_arms(
        self,
        request: Union[
            experiment_arm_service.MutateExperimentArmsRequest, dict
        ] = None,
        *,
        customer_id: str = None,
        operations: Sequence[
            experiment_arm_service.ExperimentArmOperation
        ] = None,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateExperimentArmsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateExperimentArmsResponse:
        ...
        # in a experiment_arm_service.MutateExperimentArmsRequest.
