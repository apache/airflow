...
class CustomerAssetServiceClient(metaclass=CustomerAssetServiceClientMeta):
    ...
    def mutate_customer_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCustomerAssetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCustomerAssetsResponse:
