...
class CampaignBidModifierServiceClient(
    metaclass=CampaignBidModifierServiceClientMeta
):
    ...
    def mutate_campaign_bid_modifiers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCampaignBidModifiersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v12.services.types.CampaignBidModifierOperation]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCampaignBidModifiersResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_campaign_bid_modifiers
        ]
