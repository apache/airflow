...
class ThirdPartyAppAnalyticsLinkServiceClient(
    ...
    def regenerate_shareable_link_id(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.RegenerateShareableLinkIdRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.RegenerateShareableLinkIdResponse:
