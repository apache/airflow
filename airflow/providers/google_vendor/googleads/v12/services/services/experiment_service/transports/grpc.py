...
class ExperimentServiceGrpcTransport(ExperimentServiceTransport):
    ...
    def mutate_experiments(
        ...
        if "mutate_experiments" not in self._stubs:
            self._stubs["mutate_experiments"] = self.grpc_channel.unary_unary(
    ...
    def end_experiment(
        ...
        if "end_experiment" not in self._stubs:
            self._stubs["end_experiment"] = self.grpc_channel.unary_unary(
    ...
    def graduate_experiment(
        ...
        if "graduate_experiment" not in self._stubs:
            self._stubs["graduate_experiment"] = self.grpc_channel.unary_unary(
    ...
    def schedule_experiment(
        ...
        if "schedule_experiment" not in self._stubs:
            self._stubs["schedule_experiment"] = self.grpc_channel.unary_unary(
    ...
    def promote_experiment(
        ...
        if "promote_experiment" not in self._stubs:
            self._stubs["promote_experiment"] = self.grpc_channel.unary_unary(
