...
from airflow.providers.google_vendor.googleads.v12.services.types import payments_account_service
...
class PaymentsAccountServiceClient(metaclass=PaymentsAccountServiceClientMeta):
    ...
    def list_payments_accounts(
        self,
        request: Union[
            payments_account_service.ListPaymentsAccountsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.ListPaymentsAccountsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.ListPaymentsAccountsResponse:
