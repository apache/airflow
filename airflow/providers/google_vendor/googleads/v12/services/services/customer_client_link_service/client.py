...
class CustomerClientLinkServiceClient(
    ...
    def mutate_customer_client_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCustomerClientLinkRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCustomerClientLinkResponse:
