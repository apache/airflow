...
class CustomConversionGoalServiceClient(
    ...
    def mutate_custom_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCustomConversionGoalsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCustomConversionGoalsResponse:
