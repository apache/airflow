...
class CampaignCustomizerServiceClient(
    metaclass=CampaignCustomizerServiceClientMeta
):
    ...
    def mutate_campaign_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCampaignCustomizersRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCampaignCustomizersResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_campaign_customizers
        ]
