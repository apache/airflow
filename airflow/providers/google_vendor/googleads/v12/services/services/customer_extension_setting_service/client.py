...
from .transports.grpc import CustomerExtensionSettingServiceGrpcTransport


class CustomerExtensionSettingServiceClientMeta(type):
    """Metaclass for the CustomerExtensionSettingService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CustomerExtensionSettingServiceTransport]]
...
class CustomerExtensionSettingServiceClient(
    ...
    def transport(self) -> CustomerExtensionSettingServiceTransport:
        ...
        Returns:
            CustomerExtensionSettingServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, CustomerExtensionSettingServiceTransport, None
        ] = None,
        client_options: Optional[client_options_lib.ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the customer extension setting service client.
        ...
        Args:
            ...
            transport (Union[str, CustomerExtensionSettingServiceTransport]): The
        ...
        if isinstance(transport, CustomerExtensionSettingServiceTransport):
            # transport is a CustomerExtensionSettingServiceTransport instance.
    ...
    def mutate_customer_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCustomerExtensionSettingsRequest, dict]):
                The request object. Request message for
                [CustomerExtensionSettingService.MutateCustomerExtensionSettings][google.ads.googleads.v12.services.CustomerExtensionSettingService.MutateCustomerExtensionSettings].
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v12.services.types.CustomerExtensionSettingOperation]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCustomerExtensionSettingsResponse:
