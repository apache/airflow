...
from .transports.grpc import CustomerConversionGoalServiceGrpcTransport


class CustomerConversionGoalServiceClientMeta(type):
    """Metaclass for the CustomerConversionGoalService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CustomerConversionGoalServiceTransport]]
    _transport_registry["grpc"] = CustomerConversionGoalServiceGrpcTransport
...
class CustomerConversionGoalServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CustomerConversionGoalServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CustomerConversionGoalServiceTransport:
        ...
        Returns:
            CustomerConversionGoalServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, CustomerConversionGoalServiceTransport, None
        ] = None,
        client_options: Optional[client_options_lib.ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the customer conversion goal service client.
        ...
        Args:
            ...
            transport (Union[str, CustomerConversionGoalServiceTransport]): The
        ...
        if isinstance(transport, CustomerConversionGoalServiceTransport):
            # transport is a CustomerConversionGoalServiceTransport instance.
    ...
    def mutate_customer_conversion_goals(
        ...
        *,
        ...
        r"""Creates, updates or removes customer conversion
        goals. Operation statuses are returned.

        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCustomerConversionGoalsRequest, dict]):
            ...
            customer_id (str):
                ...
                whose customer conversion goals are
                being modified.
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCustomerConversionGoalsResponse:
        ...
        # in a customer_conversion_goal_service.MutateCustomerConversionGoalsRequest.
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_customer_conversion_goals
        ]
...
__all__ = ("CustomerConversionGoalServiceClient",)
