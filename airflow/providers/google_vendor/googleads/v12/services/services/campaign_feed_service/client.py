...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def mutate_campaign_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCampaignFeedsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCampaignFeedsResponse:
