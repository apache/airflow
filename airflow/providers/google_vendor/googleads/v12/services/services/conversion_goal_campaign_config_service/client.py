...
class ConversionGoalCampaignConfigServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, ConversionGoalCampaignConfigServiceTransport, None
        ] = None,
    ...
    def mutate_conversion_goal_campaign_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateConversionGoalCampaignConfigsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateConversionGoalCampaignConfigsResponse:
