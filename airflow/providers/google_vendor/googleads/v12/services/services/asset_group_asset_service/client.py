...
class AssetGroupAssetServiceClient(metaclass=AssetGroupAssetServiceClientMeta):
    ...
    def mutate_asset_group_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAssetGroupAssetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAssetGroupAssetsResponse:
