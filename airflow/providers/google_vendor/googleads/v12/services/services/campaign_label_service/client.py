...
class CampaignLabelServiceClient(metaclass=CampaignLabelServiceClientMeta):
    ...
    def mutate_campaign_labels(
        self,
        request: Union[
            campaign_label_service.MutateCampaignLabelsRequest, dict
        ] = None,
        *,
        customer_id: str = None,
        operations: Sequence[
            campaign_label_service.CampaignLabelOperation
        ] = None,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCampaignLabelsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCampaignLabelsResponse:
