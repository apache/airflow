...
from airflow.providers.google_vendor.googleads.v12.services.types import user_data_service
...
class UserDataServiceTransport(abc.ABC):
...
__all__ = ("UserDataServiceTransport",)
