...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def mutate_feed_item_set_links(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateFeedItemSetLinksRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateFeedItemSetLinksResponse:
