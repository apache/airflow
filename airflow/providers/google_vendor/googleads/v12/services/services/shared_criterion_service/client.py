...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def mutate_shared_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateSharedCriteriaRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateSharedCriteriaResponse:
