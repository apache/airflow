...
class FeedItemSetServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[FeedItemSetServiceTransport]]
...
class FeedItemSetServiceClient(metaclass=FeedItemSetServiceClientMeta):
    ...
    def mutate_feed_item_sets(
        self,
        request: Union[
            feed_item_set_service.MutateFeedItemSetsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateFeedItemSetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateFeedItemSetsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_feed_item_sets
        ]
