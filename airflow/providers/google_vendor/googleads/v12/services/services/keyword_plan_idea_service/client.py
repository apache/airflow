...
from airflow.providers.google_vendor.googleads.v12.services.services.keyword_plan_idea_service import (
    pagers,
)
...
class KeywordPlanIdeaServiceClient(metaclass=KeywordPlanIdeaServiceClientMeta):
    ...
    def generate_keyword_ideas(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.GenerateKeywordIdeasRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.services.keyword_plan_idea_service.pagers.GenerateKeywordIdeasPager:
    ...
    def generate_keyword_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.GenerateKeywordHistoricalMetricsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.GenerateKeywordHistoricalMetricsResponse:
                Response message for
                   [KeywordPlanIdeaService.GenerateKeywordHistoricalMetrics][google.ads.googleads.v12.services.KeywordPlanIdeaService.GenerateKeywordHistoricalMetrics].
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a keyword_plan_idea_service.GenerateKeywordHistoricalMetricsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
            request,
    ...
    def generate_ad_group_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.GenerateAdGroupThemesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.GenerateAdGroupThemesResponse:
                Response message for
                   [KeywordPlanIdeaService.GenerateAdGroupThemes][google.ads.googleads.v12.services.KeywordPlanIdeaService.GenerateAdGroupThemes].
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a keyword_plan_idea_service.GenerateAdGroupThemesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
