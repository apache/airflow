...
from airflow.providers.google_vendor.googleads.v12.services.types import customer_asset_set_service
...
class CustomerAssetSetServiceTransport(abc.ABC):
    """Abstract transport class for CustomerAssetSetService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_asset_sets: gapic_v1.method.wrap_method(
