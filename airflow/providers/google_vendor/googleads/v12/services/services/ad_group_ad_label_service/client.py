...
class AdGroupAdLabelServiceClient(metaclass=AdGroupAdLabelServiceClientMeta):
    ...
    def mutate_ad_group_ad_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAdGroupAdLabelsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAdGroupAdLabelsResponse:
