...
class CustomerManagerLinkServiceClient(
    ...
    def mutate_customer_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCustomerManagerLinkRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCustomerManagerLinkResponse:
    ...
    def move_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MoveManagerLinkRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.MoveManagerLinkResponse:
                Response message for a
