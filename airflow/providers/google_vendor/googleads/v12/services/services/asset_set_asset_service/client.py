...
class AssetSetAssetServiceClient(metaclass=AssetSetAssetServiceClientMeta):
    ...
    def mutate_asset_set_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAssetSetAssetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAssetSetAssetsResponse:
