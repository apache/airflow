...
class KeywordPlanCampaignKeywordServiceClient(
    ...
    def mutate_keyword_plan_campaign_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateKeywordPlanCampaignKeywordsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateKeywordPlanCampaignKeywordsResponse:
