...
class GeoTargetConstantServiceClient(
    ...
    def suggest_geo_target_constants(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.SuggestGeoTargetConstantsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.SuggestGeoTargetConstantsResponse:
