...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def mutate_feed_item_targets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateFeedItemTargetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateFeedItemTargetsResponse:
