...
class ConversionAdjustmentUploadServiceClient(
    ...
    def upload_conversion_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.UploadConversionAdjustmentsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.UploadConversionAdjustmentsResponse:
