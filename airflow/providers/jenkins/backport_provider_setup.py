...
"""Setup.py for the apache-airflow-backport-providers-jenkins package."""
...
try:
    with open(
        os.path.join(my_dir, 'airflow/providers/jenkins/BACKPORT_PROVIDER_README.md'), encoding='utf-8'
    ) as f:
...
def do_setup(version_suffix_for_pypi=''):
    """Perform the package apache-airflow-backport-providers-jenkins setup."""
    setup(
        name='apache-airflow-backport-providers-jenkins',
        description='Backport provider package '
        'apache-airflow-backport-providers-jenkins for Apache Airflow',
        ...
        zip_safe=False,
        install_requires=['apache-airflow~=1.10', 'python-jenkins>=1.0.0'],
