...
from airflow.providers.google.ads._vendor.googleads.v12.services.types import invoice_service
...
class InvoiceServiceTransport(abc.ABC):
...
__all__ = ("InvoiceServiceTransport",)
