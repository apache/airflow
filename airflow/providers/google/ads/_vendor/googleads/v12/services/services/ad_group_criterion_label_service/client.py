...
class AdGroupCriterionLabelServiceClient(
    ...
    def mutate_ad_group_criterion_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAdGroupCriterionLabelsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAdGroupCriterionLabelsResponse:
