...
class CustomizerAttributeOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.CustomizerAttribute):
...
class MutateCustomizerAttributesResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v12.services.types.MutateCustomizerAttributeResult]):
