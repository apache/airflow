...
class KeywordPlanAdGroupKeywordServiceClient(
    ...
    def mutate_keyword_plan_ad_group_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateKeywordPlanAdGroupKeywordsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateKeywordPlanAdGroupKeywordsResponse:
