...
class MutateAdGroupAdsRequest(proto.Message):
    ...
    [AdGroupAdService.MutateAdGroupAds][google.ads.googleads.v12.services.AdGroupAdService.MutateAdGroupAds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ads
            are being modified.
        operations (Sequence[google.ads.googleads.v12.services.types.AdGroupAdOperation]):
...
class AdGroupAdOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.AdGroupAd):
            Create operation: No resource name is
            expected for the new ad.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v12.resources.types.AdGroupAd):
...
class MutateAdGroupAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateAdGroupAdResult]):
