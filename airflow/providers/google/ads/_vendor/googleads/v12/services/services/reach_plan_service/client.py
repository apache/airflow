...
from airflow.providers.google.ads._vendor.googleads.v12.services.types import reach_plan_service
...
class ReachPlanServiceClient(metaclass=ReachPlanServiceClientMeta):
    ...
    def list_plannable_locations(
        self,
        request: Union[
            reach_plan_service.ListPlannableLocationsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.ListPlannableLocationsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.ListPlannableLocationsResponse:
    ...
    def list_plannable_products(
        self,
        request: Union[
            reach_plan_service.ListPlannableProductsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.ListPlannableProductsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.ListPlannableProductsResponse:
    ...
    def generate_reach_forecast(
        self,
        request: Union[
            reach_plan_service.GenerateReachForecastRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.GenerateReachForecastRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.GenerateReachForecastResponse:
