...
class MutateAdGroupAssetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v12.services.types.AdGroupAssetOperation]):
...
class AdGroupAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.AdGroupAsset):
...
class MutateAdGroupAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateAdGroupAssetResult]):
...
class MutateAdGroupAssetResult(proto.Message):
    ...
    ad_group_asset = proto.Field(
        proto.MESSAGE, number=2, message=gagr_ad_group_asset.AdGroupAsset,
    )
