...
from airflow.providers.google.ads._vendor.googleads.v12.services.types import billing_setup_service
...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def mutate_billing_setup(
        self,
        request: Union[
            billing_setup_service.MutateBillingSetupRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateBillingSetupRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateBillingSetupResponse:
