...
class KeywordPlanAdGroupServiceClient(
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateKeywordPlanAdGroupsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateKeywordPlanAdGroupsResponse:
