...
class AccountBudgetProposalServiceClient(
    ...
    def mutate_account_budget_proposal(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAccountBudgetProposalRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAccountBudgetProposalResponse:
