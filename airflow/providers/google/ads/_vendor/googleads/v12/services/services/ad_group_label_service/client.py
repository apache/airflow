...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
    ...
    def mutate_ad_group_labels(
        self,
        request: Union[
            ad_group_label_service.MutateAdGroupLabelsRequest, dict
        ] = None,
        *,
        customer_id: str = None,
        operations: Sequence[
            ad_group_label_service.AdGroupLabelOperation
        ] = None,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAdGroupLabelsRequest, dict]):
                The request object. Request message for
                [AdGroupLabelService.MutateAdGroupLabels][google.ads.googleads.v12.services.AdGroupLabelService.MutateAdGroupLabels].
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v12.services.types.AdGroupLabelOperation]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAdGroupLabelsResponse:
