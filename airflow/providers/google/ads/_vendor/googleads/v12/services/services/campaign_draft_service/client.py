...
from airflow.providers.google.ads._vendor.googleads.v12.services.services.campaign_draft_service import (
    pagers,
)
...
class CampaignDraftServiceClient(metaclass=CampaignDraftServiceClientMeta):
    ...
    def mutate_campaign_drafts(
        self,
        request: Union[
            campaign_draft_service.MutateCampaignDraftsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCampaignDraftsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCampaignDraftsResponse:
    ...
    def promote_campaign_draft(
        self,
        request: Union[
            campaign_draft_service.PromoteCampaignDraftRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.PromoteCampaignDraftRequest, dict]):
                The request object. Request message for
    ...
    def list_campaign_draft_async_errors(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.ListCampaignDraftAsyncErrorsRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v12.services.CampaignDraftService.ListCampaignDraftAsyncErrors].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v12.services.services.campaign_draft_service.pagers.ListCampaignDraftAsyncErrorsPager:
