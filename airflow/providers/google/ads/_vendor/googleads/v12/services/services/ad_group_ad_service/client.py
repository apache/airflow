...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def mutate_ad_group_ads(
        self,
        request: Union[
            ad_group_ad_service.MutateAdGroupAdsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAdGroupAdsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAdGroupAdsResponse:
