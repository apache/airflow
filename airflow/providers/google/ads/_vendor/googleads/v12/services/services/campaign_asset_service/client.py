...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def mutate_campaign_assets(
        self,
        request: Union[
            campaign_asset_service.MutateCampaignAssetsRequest, dict
        ] = None,
        *,
        customer_id: str = None,
        operations: Sequence[
            campaign_asset_service.CampaignAssetOperation
        ] = None,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCampaignAssetsRequest, dict]):
                The request object. Request message for
                [CampaignAssetService.MutateCampaignAssets][google.ads.googleads.v12.services.CampaignAssetService.MutateCampaignAssets].
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v12.services.types.CampaignAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCampaignAssetsResponse:
