...
class MutateCampaignGroupsRequest(proto.Message):
    ...
    [CampaignGroupService.MutateCampaignGroups][google.ads.googleads.v12.services.CampaignGroupService.MutateCampaignGroups].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign groups are being modified.
        operations (Sequence[google.ads.googleads.v12.services.types.CampaignGroupOperation]):
...
class CampaignGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.CampaignGroup):
            Create operation: No resource name is
            expected for the new campaign group.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v12.resources.types.CampaignGroup):
...
class MutateCampaignGroupsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v12.services.types.MutateCampaignGroupResult]):
