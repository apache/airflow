...
class AdGroupCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v12.resources.types.AdGroupCustomizer):
...
class MutateAdGroupCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v12.services.types.MutateAdGroupCustomizerResult]):
