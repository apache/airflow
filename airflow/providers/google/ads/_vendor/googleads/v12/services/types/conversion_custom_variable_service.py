...
class MutateConversionCustomVariablesRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v12.services.types.ConversionCustomVariableOperation]):
...
class ConversionCustomVariableOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.ConversionCustomVariable):
            Create operation: No resource name is
            expected for the new conversion custom variable.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v12.resources.types.ConversionCustomVariable):
...
class MutateConversionCustomVariablesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateConversionCustomVariableResult]):
