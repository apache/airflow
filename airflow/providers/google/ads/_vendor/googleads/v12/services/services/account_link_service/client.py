...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def create_account_link(
        self,
        request: Union[
            account_link_service.CreateAccountLinkRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.CreateAccountLinkRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.CreateAccountLinkResponse:
    ...
    def mutate_account_link(
        self,
        request: Union[
            account_link_service.MutateAccountLinkRequest, dict
        ] = None,
        *,
        customer_id: str = None,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAccountLinkRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAccountLinkResponse:
