...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
    ...
    def mutate_ad_group_assets(
        self,
        request: Union[
            ad_group_asset_service.MutateAdGroupAssetsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAdGroupAssetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAdGroupAssetsResponse:
