...
class CampaignBudgetServiceClient(metaclass=CampaignBudgetServiceClientMeta):
    ...
    def mutate_campaign_budgets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCampaignBudgetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCampaignBudgetsResponse:
