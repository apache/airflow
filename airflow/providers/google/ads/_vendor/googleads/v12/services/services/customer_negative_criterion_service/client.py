...
class CustomerNegativeCriterionServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, CustomerNegativeCriterionServiceTransport, None
        ] = None,
    ...
    def mutate_customer_negative_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCustomerNegativeCriteriaRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v12.services.types.CustomerNegativeCriterionOperation]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCustomerNegativeCriteriaResponse:
