...
class MutateAdGroupBidModifiersRequest(proto.Message):
    ...
    [AdGroupBidModifierService.MutateAdGroupBidModifiers][google.ads.googleads.v12.services.AdGroupBidModifierService.MutateAdGroupBidModifiers].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose ad group
            bid modifiers are being modified.
        operations (Sequence[google.ads.googleads.v12.services.types.AdGroupBidModifierOperation]):
...
class AdGroupBidModifierOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.AdGroupBidModifier):
            Create operation: No resource name is
            expected for the new ad group bid modifier.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v12.resources.types.AdGroupBidModifier):
...
class MutateAdGroupBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateAdGroupBidModifierResult]):
