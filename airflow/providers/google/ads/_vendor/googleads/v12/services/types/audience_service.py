...
class MutateAudiencesResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v12.services.types.MutateAudienceResult]):
...
class AudienceOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v12.resources.types.Audience):
            Create operation: No resource name is
            expected for the new audience

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v12.resources.types.Audience):
