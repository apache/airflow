...
class AssetGroupListingGroupFilterServiceGrpcTransport(
    ...
    """gRPC backend transport for AssetGroupListingGroupFilterService.
    ...
    def mutate_asset_group_listing_group_filters(
        ...
        r"""Return a callable for the mutate asset group listing
        group filters method over gRPC.

        Creates, updates or removes asset group listing group
        filters. Operation statuses are returned.

        Returns:
            Callable[[~.MutateAssetGroupListingGroupFiltersRequest],
        ...
        if "mutate_asset_group_listing_group_filters" not in self._stubs:
            self._stubs[
                ...
                request_serializer=asset_group_listing_group_filter_service.MutateAssetGroupListingGroupFiltersRequest.serialize,
                response_deserializer=asset_group_listing_group_filter_service.MutateAssetGroupListingGroupFiltersResponse.deserialize,
            )
        return self._stubs["mutate_asset_group_listing_group_filters"]

    def close(self):
        self.grpc_channel.close()


__all__ = ("AssetGroupListingGroupFilterServiceGrpcTransport",)
