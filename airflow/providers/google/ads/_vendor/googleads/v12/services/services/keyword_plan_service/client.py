...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def mutate_keyword_plans(
        self,
        request: Union[
            keyword_plan_service.MutateKeywordPlansRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateKeywordPlansRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateKeywordPlansResponse:
    ...
    def generate_forecast_curve(
        self,
        request: Union[
            keyword_plan_service.GenerateForecastCurveRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.GenerateForecastCurveRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.GenerateForecastCurveResponse:
    ...
    def generate_forecast_time_series(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.GenerateForecastTimeSeriesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.GenerateForecastTimeSeriesResponse:
                Response message for
                [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v12.services.KeywordPlanService.GenerateForecastTimeSeries].
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.generate_forecast_time_series
        ]
    ...
    def generate_forecast_metrics(
        self,
        request: Union[
            keyword_plan_service.GenerateForecastMetricsRequest, dict
        ] = None,
        *,
        keyword_plan: str = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.GenerateForecastMetricsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.GenerateForecastMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v12.services.KeywordPlanService.GenerateForecastMetrics].
    ...
    def generate_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.GenerateHistoricalMetricsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.GenerateHistoricalMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v12.services.KeywordPlanService.GenerateHistoricalMetrics].
