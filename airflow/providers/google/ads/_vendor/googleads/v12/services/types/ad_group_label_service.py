...
from airflow.providers.google.ads._vendor.googleads.v12.resources.types import ad_group_label
...
class AdGroupLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v12.resources.types.AdGroupLabel):
...
class MutateAdGroupLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v12.services.types.MutateAdGroupLabelResult]):
