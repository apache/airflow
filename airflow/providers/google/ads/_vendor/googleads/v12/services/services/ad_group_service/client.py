...
class AdGroupServiceClient(metaclass=AdGroupServiceClientMeta):
    ...
    def mutate_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAdGroupsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v12.services.types.AdGroupOperation]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAdGroupsResponse:
