...
from .transports.grpc import CustomerCustomizerServiceGrpcTransport


class CustomerCustomizerServiceClientMeta(type):
    """Metaclass for the CustomerCustomizerService client.
...
class CustomerCustomizerServiceClient(
    metaclass=CustomerCustomizerServiceClientMeta
):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CustomerCustomizerServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CustomerCustomizerServiceTransport:
        ...
        Returns:
            CustomerCustomizerServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, CustomerCustomizerServiceTransport, None] = None,
        client_options: Optional[client_options_lib.ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the customer customizer service client.
        ...
        Args:
            ...
            transport (Union[str, CustomerCustomizerServiceTransport]): The
        ...
        if isinstance(transport, CustomerCustomizerServiceTransport):
            # transport is a CustomerCustomizerServiceTransport instance.
    ...
    def mutate_customer_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCustomerCustomizersRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCustomerCustomizersResponse:
        ...
        # in a customer_customizer_service.MutateCustomerCustomizersRequest.
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_customer_customizers
        ]
