...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def mutate_ad_parameters(
        self,
        request: Union[
            ad_parameter_service.MutateAdParametersRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateAdParametersRequest, dict]):
                The request object. Request message for
                [AdParameterService.MutateAdParameters][google.ads.googleads.v12.services.AdParameterService.MutateAdParameters]
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v12.services.types.AdParameterOperation]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateAdParametersResponse:
