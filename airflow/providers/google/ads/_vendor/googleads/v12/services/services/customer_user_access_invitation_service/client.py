...
class CustomerUserAccessInvitationServiceClientMeta(type):
    """Metaclass for the CustomerUserAccessInvitationService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[CustomerUserAccessInvitationServiceTransport]]
    _transport_registry[
        "grpc"
...
class CustomerUserAccessInvitationServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CustomerUserAccessInvitationServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CustomerUserAccessInvitationServiceTransport:
        ...
        Returns:
            CustomerUserAccessInvitationServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, CustomerUserAccessInvitationServiceTransport, None
        ] = None,
        client_options: Optional[client_options_lib.ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the customer user access invitation service client.
        ...
        Args:
            ...
            transport (Union[str, CustomerUserAccessInvitationServiceTransport]): The
        ...
        if isinstance(transport, CustomerUserAccessInvitationServiceTransport):
            # transport is a CustomerUserAccessInvitationServiceTransport instance.
    ...
    def mutate_customer_user_access_invitation(
        ...
        *,
        ...
        r"""Creates or removes an access invitation.
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateCustomerUserAccessInvitationRequest, dict]):
                The request object. Request message for
                [CustomerUserAccessInvitation.MutateCustomerUserAccessInvitation][]
            customer_id (str):
                Required. The ID of the customer
                whose access invitation is being
                modified.
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateCustomerUserAccessInvitationResponse:
                Response message for access
                invitation mutate.
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_customer_user_access_invitation
        ]
