...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def mutate_bidding_strategies(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.MutateBiddingStrategiesRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v12.services.types.MutateBiddingStrategiesResponse:
