...
class SmartCampaignSuggestServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[
            str, SmartCampaignSuggestServiceTransport, None
        ] = None,
    ...
    def suggest_smart_campaign_budget_options(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.SuggestSmartCampaignBudgetOptionsRequest, dict]):
    ...
    def suggest_smart_campaign_ad(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.SuggestSmartCampaignAdRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.SuggestSmartCampaignAdResponse:
                Response message for
                   [SmartCampaignSuggestService.SuggestSmartCampaignAd][google.ads.googleads.v12.services.SmartCampaignSuggestService.SuggestSmartCampaignAd].
    ...
    def suggest_keyword_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v12.services.types.SuggestKeywordThemesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v12.services.types.SuggestKeywordThemesResponse:
                Response message for
                   [SmartCampaignSuggestService.SuggestKeywordThemes][google.ads.googleads.v12.services.SmartCampaignSuggestService.SuggestKeywordThemes].
