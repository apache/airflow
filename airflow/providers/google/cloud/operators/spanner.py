    ...
    def execute(self, context) -> None:
        ...
        if not hook.get_database(
            ...
            raise AirflowException(
                f"The Cloud Spanner database '{self.database_id}' in project '{self.project_id}' and instance '{self.instance_id}' is missing. Create the database first before you can update it."
            )
        else:
