...
class BigQueryHook(GoogleBaseHook, DbApiHook):
    ...
    def create_external_table(
        ...
        Cloud Storage. See here: https://cloud.google.com/bigquery/docs/reference/rest/v2/tables#resource.
    ...
    def run_with_configuration(self, configuration: dict) -> str:
        """
        Executes a BigQuery SQL query. See here: https://cloud.google.com/bigquery/docs/reference/v2/jobs.
    ...
    def run_load(
        ...
        to BigQuery. See here: https://cloud.google.com/bigquery/docs/reference/v2/jobs.
    ...
    def run_copy(
        ...
        to another. See here: https://cloud.google.com/bigquery/docs/reference/v2/jobs#configuration.copy.
    ...
    def run_extract(
        ...
        Google Cloud Storage. See here: https://cloud.google.com/bigquery/docs/reference/v2/jobs.
    ...
    def run_query(
        ...
        table. See here: https://cloud.google.com/bigquery/docs/reference/v2/jobs.
