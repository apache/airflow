...
const config = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      {from: 'node_modules/nvd3/build/\*.min.\*(css|js)',flatten:true},
      // Update this when upgrade d3 package, as the path in new D3 is different
      {from: 'node_modules/d3/d3.min.js', flatten:true},
      {from: 'node_modules/d3-tip/dist/index.js', to:'d3-tip.js', flatten:true},
      {from: 'node_modules/bootstrap-3-typeahead/\*min.js', flatten:true},
      {from: 'node_modules/bootstrap-toggle/**/*bootstrap-toggle.min.\*(css|js)',
        flatten:true},
      {from: 'node_modules/datatables.net/**/*\*.min.js',flatten:true},
      {from: 'node_modules/datatables.net-bs/**/*\*.min.\*(css|js)',flatten:true},
    ], {copyUnmodified: true})
  ],
};
