...
Agent-drafted PR descriptions start with a human written summary that the user types and
you paste verbatim — never write, suggest, or paraphrase it yourself. Agent generated
output can only go in a `<details><summary>AI Summary</summary>` section
