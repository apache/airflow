...
The `regenerate-java-sdk-verification-metadata` prek hook runs the same script, so a change that moves the resolved dependency set fails until the rewritten file is staged too.
