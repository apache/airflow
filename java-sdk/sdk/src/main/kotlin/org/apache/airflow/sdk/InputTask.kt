 ...
 *
 * The type argument is the [TaskInput] the task expects, and it is the only
 * place that declaration lives. Each of its public fields binds **by name**,
 * ignoring case and underscores, so the stub's `snake_case` arguments reach
 * `camelCase` Java fields with nothing declared.
 *
 * ```java
