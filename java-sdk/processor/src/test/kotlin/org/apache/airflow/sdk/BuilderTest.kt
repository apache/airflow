...
class BuilderTest {
  ...
  @Test
  @DisplayName("bind input-bundle fields by wire name with a wholesale wiring fallback")
        ...
        """
         ...
         public final class TestExampleBuilder {
           ...
           public static final class Score implements Task {
             @Override
             public void execute(Context context, Client client) throws Exception {
               TestExample.ScoreInput input;
               if (ArgValues.hasRuntimeBindings(client)) {
                 input = new TestExample.ScoreInput();
                 ...
                 input = ArgValues.optionalInput(context, client, 0, TestExample.ScoreInput.class);
               }
