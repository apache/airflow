...
.. code-block:: bash
     ...
     ./breeze  --static-check-all-files

Run mypy checks for all changed files:

.. code-block:: bash

     ./breeze  --static-check mypy

Run mypy checks for selected files:

.. code-block:: bash

     ./breeze  --static-check mypy -- --files airflow/configuration.py


Run mypy checks for all files:
