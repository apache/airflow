...
.. code-block:: bash
     ...
     breeze publish-docs --package-filter apache-airflow-providers-amazon
...
.. code-block:: bash
     ...
     breeze publish-docs --override-versioned
...
.. code-block:: bash
     ...
     breeze publish-docs --airflow-site-directory
...
Those are all available flags of ``publish-docs`` command:

.. image:: ./images/breeze/output_publish-docs.svg
  :target: https://raw.githubusercontent.com/apache/airflow/main/images/breeze/output_publish-docs.svg
  :width: 100%
