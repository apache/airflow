...
* Migration rules needed
  ...
  * No migration needed — asset partitioning is an opt-in feature. Existing DAGs and assets
    are unaffected unless you explicitly adopt ``CronPartitionTimetable`` or
