...
The value can be a raw color (a hex code like ``#e8b7e4`` or a CSS name) or a Chakra palette token
such as ``blue.500`` (including tokens added through custom UI theming); a token resolves through a
