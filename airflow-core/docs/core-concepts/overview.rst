...
* A *Task SDK*, which is an isolated runtime environment inside the *workers* that executes the user-defined Dag code.
  ...
  More about task execution can be found in :doc:`/development/task-sdk`
