...
For a complete list of available context variables see :ref:`Templates reference <templates:variables>` and the :class:`airflow.utils.context.Context` type definition in the Airflow codebase (`view on GitHub <https://github.com/apache/airflow/blob/main/airflow-core/src/airflow/utils/context.py>`_).
