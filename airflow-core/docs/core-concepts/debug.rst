...
.. code-block:: bash
  ...
  root@ef2c84ad4856:/opt/airflow# python -m pdb airflow-core/src/airflow/example_dags/example_bash_operator.py
  > /opt/airflow/airflow-core/src/airflow/example_dags/example_bash_operator.py(18)<module>()
  -> """Example DAG demonstrating the usage of the BashOperator."""
  (Pdb) b 45
  Breakpoint 1 at /opt/airflow/airflow-core/src/airflow/example_dags/example_bash_operator.py:45
  (Pdb) c
  > /opt/airflow/airflow-core/src/airflow/example_dags/example_bash_operator.py(45)<module>()
  -> bash_command='echo 1',
  (Pdb) run_this_last
