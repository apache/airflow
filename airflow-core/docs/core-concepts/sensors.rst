...
Or, in the case when that thing does *not* happen within the configured timeout, *fails* so that you can be alerted to the failure through the usual mechanisms.
