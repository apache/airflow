...
The request format and supported content types are also defined by the configured auth manager.

The list of supported auth managers is available in :doc:`apache-airflow-providers:core-extensions/auth-managers` list.
