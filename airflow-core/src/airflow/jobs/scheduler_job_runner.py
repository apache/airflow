...
class SchedulerJobRunner(BaseJobRunner, LoggingMixin):
    ...
    @start_debug_span("scheduler._acquire_pool_capacity")
    ...
    @start_debug_span("scheduler._select_task_instances_to_queue")
    ...
    @start_debug_span("scheduler._build_schedulable_tis_query")
    ...
    @start_debug_span("scheduler._mark_task_instances_queued")
