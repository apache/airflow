...
# Connection port is parsed as an int by argparse; valid range (1-65535) is enforced by the Connection model
ARG_CONN_PORT = Arg(
    ("--conn-port",), help="Connection port (1-65535), optional when adding a connection", type=int
)
ARG_CONN_EXTRA = Arg(
