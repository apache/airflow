    ...
    def handle_bulk_delete(
        ...
        for entity in action.entities:
            if isinstance(entity, str):
                # String task ID - targets the non-mapped task instance (map_index = -1 in DB)
                ...
                if entity.map_index == -1:
                    ...
                    db_map_index = -1 if entity.map_index is None else entity.map_index
        ...
        try:
            ...
            if delete_specific_task_keys:
                ...
                not_found_task_ids = [
                    f"{task_id}" if map_index == -1 else f"{task_id}[{map_index}]"
