...
from airflow.api_fastapi.core_api.routes.public.dag_parsing import dag_parsing_router, dag_reparse_router
...
authenticated_router.include_router(dag_reparse_router)
