...
from airflow.api_fastapi.common.parameters import (
    ...
    QueryTITaskGroupDisplayNamePatternSearch,
...
def get_task_instances(
    ...
    task_group_display_name_pattern: QueryTITaskGroupDisplayNamePatternSearch,
    ...
    if dag_id != "~":
        ...
        if dag:
            task_group_display_name_pattern.dag = dag
    ...
    task_instance_select, total_entries = paginated_select(
        ...
        filters=[
            ...
            task_group_display_name_pattern,
            dag_id_pattern,
            run_id_pattern,
            version_number,
            readable_ti_filter,
