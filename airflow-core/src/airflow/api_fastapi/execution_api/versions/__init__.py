...
from airflow.api_fastapi.execution_api.versions.v2026_06_30 import AddQueuedDttmField, AddVariableKeysEndpoint

bundle = VersionBundle(
    HeadVersion(),
    Version("2026-06-30", AddVariableKeysEndpoint, AddQueuedDttmField),
    Version(
        "2026-06-16",
        AddRetryPolicyFields,
        AddTeamNameField,
