...
with DAG(
    ...
    This Dag demonstrates multi-asset partition alignment using TruncateToHourlyMapper.
    """
...
@asset(
    ...
    # If we want to other temporal mapper (e.g., TruncateToHourlyMapper) here,
...
with DAG(
    ...
    schedule=PartitionedAssetTimetable(
        ...
        partition_mapper_config={
            combined_player_stats: TruncateToYearlyMapper(),  # incompatible on purpose
            team_a_player_stats: TruncateToHourlyMapper(),
            Asset.ref(name="team_b_player_stats"): TruncateToHourlyMapper(),
        },
    ),
    catchup=False,
    tags=["player-stats", "odds"],
...
with DAG(
    ...
    IdentityMapper to the region segment and TruncateToDailyMapper to the timestamp segment,
