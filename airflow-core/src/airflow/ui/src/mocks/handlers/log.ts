...
export const handlers: Array<HttpHandler> = [
  http.get("/ui/dags/log_grouping/dagRuns/manual__2025-02-18T12:19/taskInstances/generate/-1", () =>
    HttpResponse.json({
      dag_id: "log_grouping",
  ...
  http.get("/ui/dags/log_grouping/dagRuns/manual__2025-02-18T12:19/taskInstances/generate/logs/1", () =>
    HttpResponse.json({
      content: [
        {
