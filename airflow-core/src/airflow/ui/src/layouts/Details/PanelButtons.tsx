...
type Props = {
  ...
  readonly setDagRunStateFilter: (value: DagRunState | undefined) => void;
  readonly setDagView: (value: DagView) => void;
  readonly setLimit: (value: number) => void;
  readonly setRunAfterGte: (value: string | undefined) => void;
  readonly setRunAfterLte: (value: string | undefined) => void;
  readonly setRunTypeFilter: (value: DagRunType | undefined) => void;
  readonly setShowVersionIndicatorMode: React.Dispatch<React.SetStateAction<VersionIndicatorOptions>>;
  readonly setTriggeringUserFilter: (value: string | undefined) => void;
