...
import MarkGroupTaskInstanceAsButton from "src/components/MarkAs/TaskInstance/MarkGroupTaskInstanceAsButton";
  ...
  return (
    <Box>
      <HeaderCard
        actions={
          <>
            <ClearTaskInstanceButton groupTaskInstance={taskInstance} isHotkeyEnabled withText={true} />
            <MarkGroupTaskInstanceAsButton groupTaskInstance={taskInstance} isHotkeyEnabled withText={true} />
          </>
        }
        icon={<MdOutlineTask />}
