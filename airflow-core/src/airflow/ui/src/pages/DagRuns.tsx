  ...
  return (
    <>
      <HStack paddingY="4px">
        ...
        >
          <Select.Trigger colorPalette="button" isActive={Boolean(filteredState)} minW="max-content">
        ...
        >
          <Select.Trigger colorPalette="button" isActive={Boolean(filteredType)} minW="max-content">
            <Select.ValueText width="auto">
              {() =>
                filteredType === null ? (
