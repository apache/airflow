...
export const DagsList = () => {
  ...
  // while loading, or when a folder is selected so the user can always navigate back to "All Dags".
  const showFolderTree = foldersLoading || folders.length > 0 || Boolean(selectedFolder);
