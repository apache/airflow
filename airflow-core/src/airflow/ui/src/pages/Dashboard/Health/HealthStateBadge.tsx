...
import { StateBadge, type Props as StateBadgeProps } from "src/components/StateBadge";
...
export const HealthStateBadge = forwardRef<HTMLDivElement, Props>(({ children, status, ...rest }, ref) => {
