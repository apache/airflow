      ...
      en: {
        common: {
          settings: {
            ...
            graph: {
              defaultDependencyView: { helper: "helper", label: "Default dependency view" },
        ...
        dag: {
          panel: {
            dependencies: {
              options: {
                allDagDependencies: "ALL-DEP-OPT",
                externalConditions: "IMMEDIATE-DEP-OPT",
                onlyTasks: "TASKS-DEP-OPT",
              },
            },
          },
        },
...
describe("Settings page", () => {
  ...
  it("reflects stored values in the controls", () => {
    ...
    localStorage.setItem(DEFAULT_DEPENDENCY_VIEW_KEY, JSON.stringify("all"));
    ...
    expect(screen.getByTestId("default-dependency-view")).toHaveTextContent("ALL-DEP-OPT");
