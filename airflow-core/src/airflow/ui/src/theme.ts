...
import type { Palette } from "src/utils/generatePalette";
...
const defaultBrandPalette: Palette = {
...
export const createTheme = (palette: Palette | undefined = defaultBrandPalette) => {
