...
export const getInlineMessage = ({
  ...
  if (isPartitioned) {
    ...
    // Assumes totalEntries === backfills.length (create_backfill_dry_run returns all rows,
    // unpaginated). If the dry run response is ever paginated, this count will be wrong.
