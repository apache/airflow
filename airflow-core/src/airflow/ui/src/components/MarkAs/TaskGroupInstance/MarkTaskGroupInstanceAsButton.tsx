...
import MarkTaskGroupInstanceAsDialog from "./MarkTaskGroupInstanceAsDialog";
...
const MarkTaskGroupInstanceAsButton = ({
  groupTaskInstance,
...
export default MarkTaskGroupInstanceAsButton;
