...
It should be announced when the median coverage across all translations is below the completeness threshold, or when needed (e.g., due to a critical UI feature that requires many new terms to be added).
