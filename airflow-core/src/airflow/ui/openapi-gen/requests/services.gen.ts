...
export class DagService {
     ...
     * @throws ApiError
     */
    public static getLatestRunUi(data: GetLatestRunUiData): CancelablePromise<GetLatestRunUiResponse> {
        return __request(OpenAPI, {
            method: 'GET',
