...
export class GraphService {
     ...
     * @throws ApiError
     */
    public static getGroupIds(data: GetGroupIdsData): CancelablePromise<GetGroupIdsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/ui/graph/group_ids/{dag_id}',
            path: {
                dag_id: data.dagId
            },
            query: {
