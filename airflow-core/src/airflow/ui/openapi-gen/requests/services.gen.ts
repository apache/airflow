...
export class DagParsingService {
     ...
     * @throws ApiError
     */
    public static reparseDag(data: ReparseDagData): CancelablePromise<ReparseDagResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/v2/dags/{dag_id}/reparse',
            path: {
                dag_id: data.dagId
            },
            errors: {
