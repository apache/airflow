...
export class DagRunService {
     ...
     * @throws ApiError
     */
    public static watchDagRunUntilFinished(data: WatchDagRunUntilFinishedData): CancelablePromise<WatchDagRunUntilFinishedResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}/watch',
            path: {
                dag_id: data.dagId,
                dag_run_id: data.dagRunId
            },
