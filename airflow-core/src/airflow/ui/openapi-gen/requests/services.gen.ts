...
export class DagBundleService {
     ...
     * @throws ApiError
     */
    public static refreshDagBundle(data: RefreshDagBundleData): CancelablePromise<RefreshDagBundleResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v2/dagBundles/{bundle_name}/refresh',
            path: {
