...
export class TimeScheduleService {
     ...
     * @throws ApiError
     */
    public static getTimeScheduleStream(data: GetTimeScheduleStreamData = {}): CancelablePromise<GetTimeScheduleStreamResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/ui/time-schedule',
            query: {
                aggregation_mode: data.aggregationMode,
                limit: data.limit,
                show_scheduled_only: data.showScheduledOnly,
                time_scale: data.timeScale,
