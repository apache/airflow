...
export class AssetService {
     ...
     * @throws ApiError
     */
    public static getAssetLineage(data: GetAssetLineageData): CancelablePromise<GetAssetLineageResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getAssetOnlyLineage(data: GetAssetOnlyLineageData): CancelablePromise<GetAssetOnlyLineageResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/assets/{asset_id}/lineage/asset-only',
            path: {
                asset_id: data.assetId
            },
            query: {
