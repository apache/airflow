...
export class TaskInstanceService {
     ...
     * @throws ApiError
     */
    public static getHitlDetailTry(data: GetHitlDetailTryData): CancelablePromise<GetHitlDetailTryResponse> {
        return __request(OpenAPI, {
            method: 'GET',
