...
export class DagService {
     ...
     * @throws ApiError
     */
    public static getLatestRunTaskInstanceStateCountsUi(data: GetLatestRunTaskInstanceStateCountsUiData): CancelablePromise<GetLatestRunTaskInstanceStateCountsUiResponse> {
        return __request(OpenAPI, {
            method: 'GET',
