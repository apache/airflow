...
export class ConfigService {
    ...
    public static getBackendsOrderValue(data: GetBackendsOrderValueData = {}): CancelablePromise<GetBackendsOrderValueResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/config/backends_order',
            headers: {
                accept: data.accept
            },
            errors: {
