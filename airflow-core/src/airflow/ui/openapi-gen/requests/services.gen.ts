...
export class TaskInstanceService {
     ...
     * @throws ApiError
     */
    public static bulkTaskInstancesDryRun(data: BulkTaskInstancesDryRunData): CancelablePromise<BulkTaskInstancesDryRunResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    public static postPatchTaskInstances(data: PostPatchTaskInstancesData): CancelablePromise<PostPatchTaskInstancesResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/patchTaskInstances',
            path: {
                dag_id: data.dagId,
                dag_run_id: data.dagRunId
            },
    ...
    /**
     * Post Patch Task Instances Dry Run
     ...
     * @throws ApiError
     */
    public static postPatchTaskInstancesDryRun(data: PostPatchTaskInstancesDryRunData): CancelablePromise<PostPatchTaskInstancesDryRunResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/patchTaskInstances/dry_run',
            path: {
                dag_id: data.dagId,
                dag_run_id: data.dagRunId
            },
