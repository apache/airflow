...
export class VariableService {
     ...
     * @throws ApiError
     */
    public static exportVariables(data: ExportVariablesData): CancelablePromise<ExportVariablesResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v2/variables/export',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                401: 'Unauthorized',
