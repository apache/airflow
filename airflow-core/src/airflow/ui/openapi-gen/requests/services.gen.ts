...
export class ConnectionService {
     ...
     * @throws ApiError
     */
    public static hookMetaDataForType(data: HookMetaDataForTypeData): CancelablePromise<HookMetaDataForTypeResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/ui/connections/hook_meta/{connection_type}',
            path: {
