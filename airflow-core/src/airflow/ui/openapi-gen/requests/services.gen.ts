...
export class GridService {
     ...
     * @throws ApiError
     */
    public static getGridTiSummariesBatch(data: GetGridTiSummariesBatchData): CancelablePromise<GetGridTiSummariesBatchResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/ui/grid/ti_summaries_batch/{dag_id}',
            path: {
                dag_id: data.dagId
            },
            body: data.requestBody,
