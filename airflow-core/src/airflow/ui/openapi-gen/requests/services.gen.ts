...
export class TaskInstanceService {
     ...
     * @throws ApiError
     */
    public static runOnDemandSection(data: RunOnDemandSectionData): CancelablePromise<RunOnDemandSectionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/runOnDemandSection',
            path: {
                dag_id: data.dagId,
                dag_run_id: data.dagRunId,
                task_id: data.taskId
