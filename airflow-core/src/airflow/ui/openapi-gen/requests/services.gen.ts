...
export class TaskInstanceService {
     ...
     * @throws ApiError
     */
    public static getTaskInstanceRetryDetails(data: GetTaskInstanceRetryDetailsData): CancelablePromise<GetTaskInstanceRetryDetailsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/retryDetails',
            path: {
                dag_id: data.dagId,
                dag_run_id: data.dagRunId,
                task_id: data.taskId
     ...
     * @throws ApiError
     */
    public static getMappedTaskInstanceRetryDetails(data: GetMappedTaskInstanceRetryDetailsData): CancelablePromise<GetMappedTaskInstanceRetryDetailsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/{map_index}/retryDetails',
            path: {
                dag_id: data.dagId,
                dag_run_id: data.dagRunId,
                task_id: data.taskId,
