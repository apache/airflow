...
export class ProviderService {
    ...
    public static getProvider(data: GetProviderData): CancelablePromise<GetProviderResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/providers/{provider_name}',
            path: {
