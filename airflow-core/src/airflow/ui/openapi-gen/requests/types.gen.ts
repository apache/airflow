...
export type GetXcomEntriesData = {
    ...
    offset?: number;
    /**
     * Attributes to order by, multi criteria sort is supported. Prefix with `-` for descending order. Supported attributes: `key, dag_id, run_id, run_after, map_index, timestamp, run_after`
     */
    orderBy?: Array<(string)>;
    runAfterGt?: string | null;
    runAfterGte?: string | null;
