...
export const $GridDAGRunwithTIs = {
    ...
    type: 'object',
    required: ['run_id', 'queued_at', 'start_date', 'end_date', 'run_after', 'logical_date', 'state', 'run_type', 'data_interval_start', 'data_interval_end', 'note', 'task_instances'],
    title: 'GridDAGRunwithTIs',
    description: 'DAG Run with Task Instances model for the Grid UI.'
} as const;
...
export const $GridResponse = {
    ...
    required: ['dag_runs'],
    title: 'GridResponse',
    description: 'Grid Response model for the Grid UI.'
} as const;
