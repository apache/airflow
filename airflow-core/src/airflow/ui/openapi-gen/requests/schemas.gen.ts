...
export const $ExternalViewResponse = {
    ...
    description: 'Serializer for External View responses.'
} as const;
...
export const $PluginResponse = {
    ...
    type: 'object',
    required: ['name', 'macros', 'flask_blueprints', 'fastapi_apps', 'fastapi_root_middlewares', 'iframe_views', 'appbuilder_views', 'external_views', 'global_operator_extra_links', 'operator_extra_links', 'source', 'listeners', 'timetables'],
