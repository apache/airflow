...
export const UseHumanInTheLoopServiceGetHitlDetailsKeyFn = ({ bodySearch, dagId, dagIdPattern, dagRunId, limit, offset, orderBy, respondedBy, responseReceived, state, subjectSearch, taskId, taskIdPattern }: {
  bodySearch?: string;
  dagId?: string;
  dagIdPattern?: string;
  dagRunId?: string;
  ...
  taskId?: string;
  taskIdPattern?: string;
} = {}, queryKey?: Array<unknown>) => [useHumanInTheLoopServiceGetHitlDetailsKey, ...(queryKey ?? [{ bodySearch, dagId, dagIdPattern, dagRunId, limit, offset, orderBy, respondedBy, responseReceived, state, subjectSearch, taskId, taskIdPattern }])];
