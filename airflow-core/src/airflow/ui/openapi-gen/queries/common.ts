...
export const UseBackfillServiceListBackfills1KeyFn = ({ active, dagId, limit, offset, orderBy }: {
  active?: boolean;
  dagId?: string;
  limit?: number;
  offset?: number;
  orderBy?: string;
} = {}, queryKey?: Array<unknown>) => [useBackfillServiceListBackfills1Key, ...(queryKey ?? [{ active, dagId, limit, offset, orderBy }])];
...
export type DagServiceRecentDagRunsQueryResult<TData = DagServiceRecentDagRunsDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useDagServiceRecentDagRunsKey = "DagServiceRecentDagRuns";
export const UseDagServiceRecentDagRunsKeyFn = ({ dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, excludeStale, lastDagRunState, limit, offset, owners, paused, tags, tagsMatchMode }: {
  dagDisplayNamePattern?: string;
  dagIdPattern?: string;
  dagIds?: string[];
  dagRunsLimit?: number;
  ...
  tags?: string[];
  tagsMatchMode?: "any" | "all";
} = {}, queryKey?: Array<unknown>) => [useDagServiceRecentDagRunsKey, ...(queryKey ?? [{ dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, excludeStale, lastDagRunState, limit, offset, owners, paused, tags, tagsMatchMode }])];
