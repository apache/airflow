...
* @throws ApiError
*/
export const ensureUseAssetServiceGetAssetEventsData = (queryClient: QueryClient, { assetId, limit, namePattern, namePrefixPattern, offset, orderBy, partitionKey, partitionKeyPattern, sourceDagId, sourceMapIndex, sourceRunId, sourceTaskId, timestampGt, timestampGte, timestampLt, timestampLte }: {
  assetId?: number;
  limit?: number;
  namePattern?: string;
  namePrefixPattern?: string;
  ...
  timestampLt?: string;
  timestampLte?: string;
} = {}) => queryClient.ensureQueryData({ queryKey: Common.UseAssetServiceGetAssetEventsKeyFn({ assetId, limit, namePattern, namePrefixPattern, offset, orderBy, partitionKey, partitionKeyPattern, sourceDagId, sourceMapIndex, sourceRunId, sourceTaskId, timestampGt, timestampGte, timestampLt, timestampLte }), queryFn: () => AssetService.getAssetEvents({ assetId, limit, namePattern, namePrefixPattern, offset, orderBy, partitionKey, partitionKeyPattern, sourceDagId, sourceMapIndex, sourceRunId, sourceTaskId, timestampGt, timestampGte, timestampLt, timestampLte }) });
/**
...
* @throws ApiError
*/
export const ensureUseAssetStoreServiceListAssetStoreData = (queryClient: QueryClient, { assetId, limit, offset }: {
  assetId: number;
  limit?: number;
  offset?: number;
}) => queryClient.ensureQueryData({ queryKey: Common.UseAssetStoreServiceListAssetStoreKeyFn({ assetId, limit, offset }), queryFn: () => AssetStoreService.listAssetStore({ assetId, limit, offset }) });
/**
* Get Asset Store
...
* @throws ApiError
*/
export const ensureUseAssetStoreServiceGetAssetStoreData = (queryClient: QueryClient, { assetId, key }: {
  assetId: number;
  key: string;
}) => queryClient.ensureQueryData({ queryKey: Common.UseAssetStoreServiceGetAssetStoreKeyFn({ assetId, key }), queryFn: () => AssetStoreService.getAssetStore({ assetId, key }) });
/**
* List Task Store
...
* @throws ApiError
*/
export const ensureUseTaskStoreServiceListTaskStoreData = (queryClient: QueryClient, { dagId, dagRunId, limit, mapIndex, offset, taskId }: {
  dagId: string;
  dagRunId: string;
  limit?: number;
  mapIndex?: number;
  offset?: number;
  taskId: string;
}) => queryClient.ensureQueryData({ queryKey: Common.UseTaskStoreServiceListTaskStoreKeyFn({ dagId, dagRunId, limit, mapIndex, offset, taskId }), queryFn: () => TaskStoreService.listTaskStore({ dagId, dagRunId, limit, mapIndex, offset, taskId }) });
/**
* Get Task Store
...
* @throws ApiError
*/
export const ensureUseTaskStoreServiceGetTaskStoreData = (queryClient: QueryClient, { dagId, dagRunId, key, mapIndex, taskId }: {
  dagId: string;
  dagRunId: string;
  key: string;
  mapIndex?: number;
  taskId: string;
}) => queryClient.ensureQueryData({ queryKey: Common.UseTaskStoreServiceGetTaskStoreKeyFn({ dagId, dagRunId, key, mapIndex, taskId }), queryFn: () => TaskStoreService.getTaskStore({ dagId, dagRunId, key, mapIndex, taskId }) });
/**
* Get Xcom Entry
* Get an XCom entry.
* @param data The data for the request.
