...
* @throws ApiError
*/
export const ensureUseGanttServiceGetGanttDataData = (queryClient: QueryClient, { dagId, endDateGt, endDateGte, endDateLt, endDateLte, runId, startDateGt, startDateGte, startDateLt, startDateLte }: {
  dagId: string;
  endDateGt?: string;
  endDateGte?: string;
  endDateLt?: string;
