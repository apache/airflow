...
* @throws ApiError
*/
export const ensureUseCircuitBreakerServiceGetCircuitBreakerData = (queryClient: QueryClient, { dagId, taskId }: {
  dagId: string;
  taskId: string;
}) => queryClient.ensureQueryData({ queryKey: Common.UseCircuitBreakerServiceGetCircuitBreakerKeyFn({ dagId, taskId }), queryFn: () => CircuitBreakerService.getCircuitBreaker({ dagId, taskId }) });
/**
...
* @throws ApiError
*/
export const ensureUseCircuitBreakerServiceListCircuitBreakersData = (queryClient: QueryClient, { dagId }: {
  dagId: string;
}) => queryClient.ensureQueryData({ queryKey: Common.UseCircuitBreakerServiceListCircuitBreakersKeyFn({ dagId }), queryFn: () => CircuitBreakerService.listCircuitBreakers({ dagId }) });
/**
* Get Connection
...
* @throws ApiError
*/
export const ensureUseAssetStateServiceListAssetStatesData = (queryClient: QueryClient, { assetId, limit, offset }: {
  assetId: number;
  limit?: number;
  offset?: number;
}) => queryClient.ensureQueryData({ queryKey: Common.UseAssetStateServiceListAssetStatesKeyFn({ assetId, limit, offset }), queryFn: () => AssetStateService.listAssetStates({ assetId, limit, offset }) });
/**
* Get Asset State
...
* @throws ApiError
*/
export const ensureUseTaskStateServiceListTaskStatesData = (queryClient: QueryClient, { dagId, dagRunId, limit, mapIndex, offset, taskId }: {
  dagId: string;
  dagRunId: string;
  limit?: number;
  mapIndex?: number;
  offset?: number;
  taskId: string;
}) => queryClient.ensureQueryData({ queryKey: Common.UseTaskStateServiceListTaskStatesKeyFn({ dagId, dagRunId, limit, mapIndex, offset, taskId }), queryFn: () => TaskStateService.listTaskStates({ dagId, dagRunId, limit, mapIndex, offset, taskId }) });
/**
* Get Task State
