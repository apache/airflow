...
* @throws ApiError
*/
export const ensureUseBackfillServiceListBackfills1Data = (queryClient: QueryClient, { active, dagId, limit, offset, orderBy }: {
  active?: boolean;
  dagId?: string;
  limit?: number;
  offset?: number;
  orderBy?: string;
} = {}) => queryClient.ensureQueryData({ queryKey: Common.UseBackfillServiceListBackfills1KeyFn({ active, dagId, limit, offset, orderBy }), queryFn: () => BackfillService.listBackfills1({ active, dagId, limit, offset, orderBy }) });
/**
* Get Connection
...
* @throws ApiError
*/
export const ensureUseDagServiceRecentDagRunsData = (queryClient: QueryClient, { dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, excludeStale, lastDagRunState, limit, offset, owners, paused, tags, tagsMatchMode }: {
  dagDisplayNamePattern?: string;
  dagIdPattern?: string;
  dagIds?: string[];
  dagRunsLimit?: number;
  ...
  tags?: string[];
  tagsMatchMode?: "any" | "all";
} = {}) => queryClient.ensureQueryData({ queryKey: Common.UseDagServiceRecentDagRunsKeyFn({ dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, excludeStale, lastDagRunState, limit, offset, owners, paused, tags, tagsMatchMode }), queryFn: () => DagService.recentDagRuns({ dagDisplayNamePattern, dagIdPattern, dagIds, dagRunsLimit, excludeStale, lastDagRunState, limit, offset, owners, paused, tags, tagsMatchMode }) });
/**
* Get Event Log
* @param data The data for the request.
