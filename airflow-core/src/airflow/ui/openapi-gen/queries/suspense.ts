...
* @throws ApiError
*/
export const useTaskInstanceServiceGetTaskInstanceRetryDetailsSuspense = <TData = Common.TaskInstanceServiceGetTaskInstanceRetryDetailsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ dagId, dagRunId, taskId }: {
  dagId: string;
  dagRunId: string;
  taskId: string;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseTaskInstanceServiceGetTaskInstanceRetryDetailsKeyFn({ dagId, dagRunId, taskId }, queryKey), queryFn: () => TaskInstanceService.getTaskInstanceRetryDetails({ dagId, dagRunId, taskId }) as TData, ...options });
/**
...
* @throws ApiError
*/
export const useTaskInstanceServiceGetMappedTaskInstanceRetryDetailsSuspense = <TData = Common.TaskInstanceServiceGetMappedTaskInstanceRetryDetailsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ dagId, dagRunId, mapIndex, taskId }: {
  dagId: string;
  dagRunId: string;
  mapIndex: number;
  taskId: string;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseTaskInstanceServiceGetMappedTaskInstanceRetryDetailsKeyFn({ dagId, dagRunId, mapIndex, taskId }, queryKey), queryFn: () => TaskInstanceService.getMappedTaskInstanceRetryDetails({ dagId, dagRunId, mapIndex, taskId }) as TData, ...options });
/**
* Get Task Instances
