...
* @throws ApiError
*/
export const useDagVersionServiceGetDagVersionDiffSuspense = <TData = Common.DagVersionServiceGetDagVersionDiffDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ baseVersionNumber, dagId, includeSource, includeValues, maxChanges, targetVersionNumber }: {
