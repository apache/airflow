...
* @throws ApiError
*/
export const prefetchUseDagServiceGetDagTimetableTypesUi = (queryClient: QueryClient, { limit, offset, timetableTypePrefixPattern }: {
  limit?: number;
  offset?: number;
...
* @throws ApiError
*/
export const prefetchUseTaskInstanceServiceGetTaskInstanceRetryDetails = (queryClient: QueryClient, { dagId, dagRunId, taskId }: {
  dagId: string;
  dagRunId: string;
  taskId: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseTaskInstanceServiceGetTaskInstanceRetryDetailsKeyFn({ dagId, dagRunId, taskId }), queryFn: () => TaskInstanceService.getTaskInstanceRetryDetails({ dagId, dagRunId, taskId }) });
/**
...
* @throws ApiError
*/
export const prefetchUseTaskInstanceServiceGetMappedTaskInstanceRetryDetails = (queryClient: QueryClient, { dagId, dagRunId, mapIndex, taskId }: {
  dagId: string;
  dagRunId: string;
  mapIndex: number;
  taskId: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseTaskInstanceServiceGetMappedTaskInstanceRetryDetailsKeyFn({ dagId, dagRunId, mapIndex, taskId }), queryFn: () => TaskInstanceService.getMappedTaskInstanceRetryDetails({ dagId, dagRunId, mapIndex, taskId }) });
/**
* Get Task Instances
...
* @throws ApiError
*/
export const prefetchUseDeadlinesServiceGetDeadlines = (queryClient: QueryClient, { dagId, dagRunId, deadlineTimeGt, deadlineTimeGte, deadlineTimeLt, deadlineTimeLte, lastUpdatedAtGt, lastUpdatedAtGte, lastUpdatedAtLt, lastUpdatedAtLte, limit, missed, offset, orderBy, teams }: {
  dagId: string;
  dagRunId: string;
...
* @throws ApiError
*/
export const prefetchUseStructureServiceStructureData = (queryClient: QueryClient, { dagId, depth, includeDownstream, includeUpstream, root, versionNumber }: {
  dagId: string;
  depth?: number;
  ...
  root?: string;
  versionNumber?: number;
}) => queryClient.prefetchQuery({ queryKey: Common.UseStructureServiceStructureDataKeyFn({ dagId, depth, includeDownstream, includeUpstream, root, versionNumber }), queryFn: () => StructureService.structureData({ dagId, depth, includeDownstream, includeUpstream, root, versionNumber }) });
/**
* Get Dag Structure
