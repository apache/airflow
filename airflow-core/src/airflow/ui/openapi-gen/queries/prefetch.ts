...
* @throws ApiError
*/
export const prefetchUseConnectionServiceGetConnectionTestStatus = (queryClient: QueryClient, { requestId }: {
  requestId: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseConnectionServiceGetConnectionTestStatusKeyFn({ requestId }), queryFn: () => ConnectionService.getConnectionTestStatus({ requestId }) });
/**
* Get Connection
