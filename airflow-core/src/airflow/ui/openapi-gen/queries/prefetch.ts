...
* @throws ApiError
*/
export const prefetchUseHumanInTheLoopSharedLinksServiceRedirectSharedLink = (queryClient: QueryClient, { token }: {
  token: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseHumanInTheLoopSharedLinksServiceRedirectSharedLinkKeyFn({ token }), queryFn: () => HumanInTheLoopSharedLinksService.redirectSharedLink({ token }) });
/**
* Get Health
