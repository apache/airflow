...
* @throws ApiError
*/
export const prefetchUseHumanInTheLoopServiceGetHitlSharedResponse = (queryClient: QueryClient, { payload, signature, taskInstanceId }: {
  payload: string;
  signature: string;
  taskInstanceId: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseHumanInTheLoopServiceGetHitlSharedResponseKeyFn({ payload, signature, taskInstanceId }), queryFn: () => HumanInTheLoopService.getHitlSharedResponse({ payload, signature, taskInstanceId }) });
/**
* Redirect To Hitl Ui
...
* @throws ApiError
*/
export const prefetchUseHumanInTheLoopServiceRedirectToHitlUi = (queryClient: QueryClient, { payload, signature, taskInstanceId }: {
  payload: string;
  signature: string;
  taskInstanceId: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseHumanInTheLoopServiceRedirectToHitlUiKeyFn({ payload, signature, taskInstanceId }), queryFn: () => HumanInTheLoopService.redirectToHitlUi({ payload, signature, taskInstanceId }) });
/**
* Get Hitl Shared Response
* Get HITL response details via shared link.
* @param data The data for the request.
...
* @throws ApiError
*/
export const prefetchUseHumanInTheLoopServiceGetHitlSharedResponse1 = (queryClient: QueryClient, { payload, signature, taskInstanceId }: {
  payload: string;
  signature: string;
  taskInstanceId: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseHumanInTheLoopServiceGetHitlSharedResponse1KeyFn({ payload, signature, taskInstanceId }), queryFn: () => HumanInTheLoopService.getHitlSharedResponse1({ payload, signature, taskInstanceId }) });
/**
* Get Health
