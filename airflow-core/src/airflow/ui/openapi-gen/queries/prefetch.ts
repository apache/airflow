...
* @throws ApiError
*/
export const prefetchUseTimeScheduleServiceGetTimeScheduleStream = (queryClient: QueryClient, { aggregationMode, dagIdPattern, durationGt, durationGte, durationLt, durationLte, limit, runAfterGt, runAfterGte, runAfterLt, runAfterLte, runType, showScheduledOnly, startDateGt, startDateGte, startDateLt, startDateLte, state, tags, tagsMatchMode, teams, timeScale, timetableType, timezone, viewMode }: {
  ...
  timezone?: string;
  viewMode?: "day" | "week";
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseTimeScheduleServiceGetTimeScheduleStreamKeyFn({ aggregationMode, dagIdPattern, durationGt, durationGte, durationLt, durationLte, limit, runAfterGt, runAfterGte, runAfterLt, runAfterLte, runType, showScheduledOnly, startDateGt, startDateGte, startDateLt, startDateLte, state, tags, tagsMatchMode, teams, timeScale, timetableType, timezone, viewMode }), queryFn: () => TimeScheduleService.getTimeScheduleStream({ aggregationMode, dagIdPattern, durationGt, durationGte, durationLt, durationLte, limit, runAfterGt, runAfterGte, runAfterLt, runAfterLte, runType, showScheduledOnly, startDateGt, startDateGte, startDateLt, startDateLte, state, tags, tagsMatchMode, teams, timeScale, timetableType, timezone, viewMode }) });
