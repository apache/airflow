...
* @throws ApiError
*/
export const prefetchUseScheduleOverviewServiceGetDagScheduleOverview = (queryClient: QueryClient, { dagDisplayNamePattern, dagIdPattern, runAfterGte, runAfterLte }: {
  dagDisplayNamePattern?: string;
  dagIdPattern?: string;
  runAfterGte?: string;
  runAfterLte?: string;
