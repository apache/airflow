...
* @throws ApiError
*/
export const prefetchUseAssetServiceGetAssets = (queryClient: QueryClient, { dagIds, groupPattern, limit, namePattern, offset, onlyActive, orderBy, searchMatchMode, uriPattern }: {
  dagIds?: string[];
  groupPattern?: string;
  limit?: number;
  namePattern?: string;
  ...
  uriPattern?: string;
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseAssetServiceGetAssetsKeyFn({ dagIds, groupPattern, limit, namePattern, offset, onlyActive, orderBy, searchMatchMode, uriPattern }), queryFn: () => AssetService.getAssets({ dagIds, groupPattern, limit, namePattern, offset, onlyActive, orderBy, searchMatchMode, uriPattern }) });
/**
* Get Asset Groups
* Get asset groups.
* @param data The data for the request.
...
* @throws ApiError
*/
export const prefetchUseAssetServiceGetAssetGroups = (queryClient: QueryClient, { group, limit, offset, onlyActive, orderBy }: {
  group?: string;
  limit?: number;
  offset?: number;
  onlyActive?: boolean;
  orderBy?: string;
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseAssetServiceGetAssetGroupsKeyFn({ group, limit, offset, onlyActive, orderBy }), queryFn: () => AssetService.getAssetGroups({ group, limit, offset, onlyActive, orderBy }) });
/**
* Get Asset Aliases
* Get asset aliases.
* @param data The data for the request.
...
* @throws ApiError
*/
export const prefetchUseDependenciesServiceGetDependencies = (queryClient: QueryClient, { nodeId, nodeIds }: {
  nodeId?: string;
  nodeIds?: string[];
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseDependenciesServiceGetDependenciesKeyFn({ nodeId, nodeIds }), queryFn: () => DependenciesService.getDependencies({ nodeId, nodeIds }) });
/**
* Historical Metrics
