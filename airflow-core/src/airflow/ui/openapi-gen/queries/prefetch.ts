...
* @throws ApiError
*/
export const prefetchUseHitlSharedLinksServiceRedirectSharedLink = (queryClient: QueryClient, { token }: {
  token: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseHitlSharedLinksServiceRedirectSharedLinkKeyFn({ token }), queryFn: () => HitlSharedLinksService.redirectSharedLink({ token }) });
/**
...
* @throws ApiError
*/
export const prefetchUseHitlSharedLinksServiceExecuteSharedLinkAction = (queryClient: QueryClient, { token }: {
  token: string;
}) => queryClient.prefetchQuery({ queryKey: Common.UseHitlSharedLinksServiceExecuteSharedLinkActionKeyFn({ token }), queryFn: () => HitlSharedLinksService.executeSharedLinkAction({ token }) });
/**
* Get Health
