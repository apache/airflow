...
class ConnectionsClient:
    ...
    def get(self, connection_id: str) -> ConnectionResponse:
        ...
        resp = self._http.get(f"/api/v2/connections/{quote_segment(connection_id)}")
    ...
    def update(
        ...
        *,
        ...
        resp = self._http.patch(
            f"/api/v2/connections/{quote_segment(connection_id)}",
            json=body,
    ...
    def delete(self, connection_id: str) -> None:
        ...
        resp = self._http.delete(f"/api/v2/connections/{quote_segment(connection_id)}")
        resp.raise_for_status()
