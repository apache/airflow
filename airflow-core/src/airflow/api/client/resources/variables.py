...
from airflow.api.client.resources import quote_segment
...
class VariablesClient:
    ...
    def get(self, key: str) -> VariableResponse:
        ...
        resp = self._http.get(f"/api/v2/variables/{quote_segment(key)}")
    ...
    def update(
        ...
        *,
        ...
        resp = self._http.patch(
            f"/api/v2/variables/{quote_segment(key)}",
            json=body,
    ...
    def delete(self, key: str) -> None:
        ...
        resp = self._http.delete(f"/api/v2/variables/{quote_segment(key)}")
        resp.raise_for_status()
