...
if TYPE_CHECKING:
    ...
    SdkOperator = BaseOperator | MappedOperator
    SchedulerOperator: TypeAlias = "SerializedBaseOperator | SchedulerMappedOperator"
...
class SerializedDAG(DAG, BaseSerialization):
    ...
    def deserialize_dag(cls, encoded_dag: dict[str, Any]) -> SerializedDAG:
        ...
        for task in dag.task_dict.values():
            SerializedBaseOperator.set_task_dag_references(task, dag)  # type: ignore[arg-type]
