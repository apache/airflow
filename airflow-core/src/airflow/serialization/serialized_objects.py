...
class SerializedDAG(BaseSerialization):
    ...
    def set_task_group_state(
        ...
        *,
        ...
        """
        Set the state of a TaskGroup to the given state, and clear downstream tasks in failed or upstream_failed state.
