...
from airflow.serialization.definitions.param import SerializedParam, SerializedParamsDict, merge_into_params
...
class SerializedDAG(DAG, BaseSerialization):
    ...
    # TODO (GH-52141): These should contain serialized containers, but currently
    # this class inherits from an SDK one.
    params: SerializedParamsDict  # type: ignore[assignment]
    ...
    def create_dagrun(
        ...
        *,
        ...
        merge_into_params(self.params, conf).validate()
