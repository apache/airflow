...
def gen_context(trace_id, span_id):
    ...
    from airflow.observability.traces.otel_tracer import gen_context as otel_gen_context
...
def gen_links_from_kv_list(list):
    ...
    from airflow.observability.traces.otel_tracer import gen_links_from_kv_list
