...
class HITLSharedLinkManager:
    ...
    def __init__(self):
        self.secret_key = conf.get("api", "hitl_shared_link_secret_key", fallback="")
    ...
    def generate_link(
        ...
        return {
            "task_instance_id": f"{dag_id}.{dag_run_id}.{task_id}.{map_index or -1}",
            "link_url": link_url,
    ...
    def verify_link(self, payload: str, signature: str) -> dict[str, Any]:
        """
