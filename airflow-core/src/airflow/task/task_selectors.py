...
TASK_SELECTOR_PARAMS_PROVIDERS: dict[str, Callable[[AirflowConfigParser], dict[str, Any]]] = {}

TASK_SELECTORS[OPTIMISTIC_SELECTOR] = OptimisticTaskSelector()
TASK_SELECTORS[PESSIMISTIC_SELECTOR] = PessimisticTaskSelector()


def _get_params_from_scheduler(conf: AirflowConfigParser) -> dict[str, Any]:
    params = {}
...
TASK_SELECTOR_PARAMS_PROVIDERS[OPTIMISTIC_SELECTOR] = _get_params_from_scheduler
TASK_SELECTOR_PARAMS_PROVIDERS[PESSIMISTIC_SELECTOR] = _get_params_from_scheduler
