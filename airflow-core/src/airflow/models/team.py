...
dag_bundle_team_association_table = Table(
    ...
    Column("team_id", UUIDString(binary=False), ForeignKey("team.id", ondelete="CASCADE"), primary_key=True),
...
class Team(Base):
    ...
    id: Mapped[str] = mapped_column(UUIDString(binary=False), primary_key=True, default=uuid6.uuid7)
