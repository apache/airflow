...
class TaskInstance(Base, LoggingMixin, BaseWorkload):
    ...
    def are_dependencies_met(
        self, dep_context: DepContext | None = None, verbose: bool = False, *, session: Session = NEW_SESSION
    ) -> bool:
        """
    ...
    @provide_session
    def get_num_running_task_instances(self, same_dagrun: bool = False, *, session: Session) -> int:
