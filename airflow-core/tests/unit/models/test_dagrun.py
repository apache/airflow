...
class TestDagRun:
    ...
    def test_start_dr_spans_if_needed_new_span(self, testing_dag_bundle, dag_maker, session):
        ...
        assert dag_run.active_spans.get("dr:" + dag_run.run_id) is None
        ...
        assert dag_run.active_spans.get("dr:" + dag_run.run_id) is not None
    ...
    def test_end_dr_span_if_needed(self, testing_dag_bundle, dag_maker, session):
        ...
        active_spans.set("dr:" + dag_run.run_id, dr_span)
