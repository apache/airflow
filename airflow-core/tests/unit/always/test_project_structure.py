...
class TestProjectStructure:
    ...
    def test_providers_modules_should_have_tests(self):
        ...
        OVERLOOKED_TESTS = [
            ...
            "providers/edgeexecutor/tests/unit/edgeexecutor/models/test_edge_job.py",
            "providers/edgeexecutor/tests/unit/edgeexecutor/models/test_edge_logs.py",
            "providers/edgeexecutor/tests/unit/edgeexecutor/models/test_edge_worker.py",
            "providers/edgeexecutor/tests/unit/edgeexecutor/test_version_compat.py",
            "providers/edgeexecutor/tests/unit/edgeexecutor/worker_api/routes/test__v2_compat.py",
            "providers/edgeexecutor/tests/unit/edgeexecutor/worker_api/routes/test__v2_routes.py",
            "providers/edgeexecutor/tests/unit/edgeexecutor/worker_api/routes/test_jobs.py",
            "providers/edgeexecutor/tests/unit/edgeexecutor/worker_api/test_app.py",
            "providers/edgeexecutor/tests/unit/edgeexecutor/worker_api/test_auth.py",
            "providers/edgeexecutor/tests/unit/edgeexecutor/worker_api/test_datamodels.py",
