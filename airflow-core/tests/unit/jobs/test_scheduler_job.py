...
class TestSchedulerJobQueriesCount:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ([40, 21, 21, 21], 1, 1, "1d", "@once", "no_structure"),
            ([40, 21, 21, 21], 1, 1, "1d", "@once", "linear"),
            ([40, 21, 21, 21], 1, 1, "1d", "30m", "no_structure"),
            ([40, 21, 21, 21], 1, 1, "1d", "30m", "linear"),
            ([40, 21, 21, 21], 1, 1, "1d", "30m", "binary_tree"),
            ([40, 21, 21, 21], 1, 1, "1d", "30m", "star"),
            ([40, 21, 21, 21], 1, 1, "1d", "30m", "grid"),
            # One DAG with five tasks per DAG file.
            ([10, 10, 10, 10], 1, 5, "1d", "None", "no_structure"),
            ([10, 10, 10, 10], 1, 5, "1d", "None", "linear"),
            ([40, 21, 21, 21], 1, 5, "1d", "@once", "no_structure"),
            ([41, 22, 22, 22], 1, 5, "1d", "@once", "linear"),
            ([40, 21, 21, 21], 1, 5, "1d", "30m", "no_structure"),
            ([41, 22, 22, 22], 1, 5, "1d", "30m", "linear"),
            ([41, 22, 22, 22], 1, 5, "1d", "30m", "binary_tree"),
            ([41, 22, 22, 22], 1, 5, "1d", "30m", "star"),
            ([41, 22, 22, 22], 1, 5, "1d", "30m", "grid"),
            # 10 DAGs with 10 tasks per DAG file.
            ([10, 10, 10, 10], 10, 10, "1d", "None", "no_structure"),
            ([10, 10, 10, 10], 10, 10, "1d", "None", "linear"),
            ([238, 77, 70, 70], 10, 10, "1d", "@once", "no_structure"),
            ([248, 85, 85, 85], 10, 10, "1d", "@once", "linear"),
            ([238, 77, 70, 70], 10, 10, "1d", "30m", "no_structure"),
            ([248, 85, 85, 85], 10, 10, "1d", "30m", "linear"),
            ([248, 87, 80, 80], 10, 10, "1d", "30m", "binary_tree"),
            ([248, 87, 80, 80], 10, 10, "1d", "30m", "star"),
            ([248, 87, 80, 80], 10, 10, "1d", "30m", "grid"),
        ],
    )
