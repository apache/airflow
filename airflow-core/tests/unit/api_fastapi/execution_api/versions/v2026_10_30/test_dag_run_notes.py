...
MISSING_TI_NOTE_URL = "/execution/task-instances/00000000-0000-0000-0000-000000000000/dag-run-note"


class TestUpdateDagRunNoteEndpointVersioning:
    """The task-instances/{task_instance_id}/dag-run-note endpoint didn't exist before 2026-10-30."""
    ...
    def test_old_version_returns_404(self, client):
        ...
        response = client.patch(MISSING_TI_NOTE_URL, json={"note": "from runtime"})
