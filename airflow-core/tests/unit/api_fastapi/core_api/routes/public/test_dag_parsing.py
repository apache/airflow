...
from airflow.models.dagbag import DagPriorityParsingRequest, SchedulerDagBag
...
class TestDagParsingEndpoint:
    ...
    def test_201_and_400_requests(self, url_safe_serializer, session, test_client):
        ...
        test_dag = SchedulerDagBag(load_op_links=False).get_latest_version_of_dag(
            TEST_DAG_ID, session=session
        )
