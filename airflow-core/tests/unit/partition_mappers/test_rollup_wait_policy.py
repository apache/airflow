...
class TestSerializeRoundTrip:
    ...
    def test_round_trip_fast_path_uses_core_wait_for_all(self):
        ...
        from airflow.partition_mappers.wait_policy import WaitForAll as CoreWaitForAll
        from airflow.serialization.decoders import decode_partition_mapper
        from airflow.serialization.encoders import encode_partition_mapper
        ...
        restored = decode_partition_mapper(encode_partition_mapper(mapper))
        assert isinstance(restored, RollupMapper)
        assert isinstance(restored.wait_policy, CoreWaitForAll)
...
class TestSchedulerDispatch:
    ...
    def runner(self):
        ...
        # has *no* ``self.log``, ``self.executors``, ``self._partition_audit_seen``,
