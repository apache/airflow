...
class TestCliDagsTriggerSpan:
    ...
    def test_emits_span(self, mock_get_client, captured_spans, parser, monkeypatch):
        mock_get_client.return_value.trigger_dag.return_value = None
        ...
        mock_get_client.return_value.trigger_dag.assert_called_once()

    @mock.patch("airflow.cli.commands.dag_command.get_current_api_client")
    def test_no_span_without_traceparent(self, mock_get_client, captured_spans, parser, monkeypatch):
        mock_get_client.return_value.trigger_dag.return_value = None
    ...
    @mock.patch("airflow.cli.commands.dag_command.get_current_api_client")
    def test_honours_traceparent(self, mock_get_client, captured_spans, parser, monkeypatch):
        mock_get_client.return_value.trigger_dag.return_value = None
        monkeypatch.setenv("TRACEPARENT", EXAMPLE_TRACEPARENT)
