...
MIGRATED_CLI_COMMANDS = [
    ...
    (dag_command.dag_list_dag_runs, "airflowctl dags list-runs"),
    (dag_command.dag_list_jobs, "airflowctl dags list-jobs"),
    (dag_command.dag_report, "airflowctl dags report"),
    (dag_command.dag_clear, "airflowctl dags clear"),
