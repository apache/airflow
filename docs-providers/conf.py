...
DOCS_DIR = os.path.abspath(os.path.join(CONF_DIR, 'docs'))

PACKAGE_NAME = os.environ['AIRFLOW_PACKAGE_NAME']
PACKAGE_DIR = os.environ['AIRFLOW_PACKAGE_DIR']
PACKAGE_VERSION = os.environ['AIRFLOW_PACKAGE_VERSION']
...
if PACKAGE_NAME == 'apache-airflow-providers-google':
