...
```bash
python .agents/skills/airflow-contributor/scripts/context_detect.py <skill_id> [key=value ...]
```
...
```bash
python .agents/skills/airflow-contributor/scripts/context_detect.py --list
```
...
4. Resolve and run:
   ...
   ```bash
   # example
   python .agents/skills/airflow-contributor/scripts/context_detect.py \
