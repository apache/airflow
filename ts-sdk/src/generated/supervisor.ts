...
export type Type88 = "XComDeleteCountResult";
...
/**
 * This interface was referenced by `SupervisorWireSchema`'s JSON-Schema
 * via the `definition` "BulkDeleteXCom".
 */
export interface BulkDeleteXCom {
  dag_id: DagId1;
  run_id: RunId1;
  task_id?: TaskId;
  key?: Key;
...
/**
 * This interface was referenced by `SupervisorWireSchema`'s JSON-Schema
 * via the `definition` "XComDeleteCountResult".
 */
export interface XComDeleteCountResult {
  count: Count2;
  type?: Type88;
}
/**
