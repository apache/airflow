...
const (
	...
	TypeDagSkippedIntervalsCallbackRequest = "DagSkippedIntervalsCallbackRequest"
...
func EnsureType(m any) any {
	...
	case DagRunStateResult:
		...
		return b
	case DagSkippedIntervalsCallbackRequest:
		b.Type = TypeDagSkippedIntervalsCallbackRequest
		return b
	case DeferTask:
