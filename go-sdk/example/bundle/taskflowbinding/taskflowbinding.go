...
func MakeNumbers(actx airflow.Context) (any, error) {
	...
	actx.Logger().InfoContext(actx, "Pushing numbers", "numbers", fmt.Sprint(numbers))
	return numbers, nil
}
...
func ViaStructNoTags(actx airflow.Context, input ViaStructNoTagsInput) (any, error) {
...
func ViaStructMap(actx airflow.Context, input StructMapInput) (any, error) {
	...
	actx.Logger().
		InfoContext(actx, "Bound map onto struct field", "payload", fmt.Sprint(input.Payload))
...
func ViaPlainMap(actx airflow.Context, labels map[string]string) (any, error) {
	...
	actx.Logger().InfoContext(actx, "Bound dict into a plain map", "labels", fmt.Sprint(labels))
