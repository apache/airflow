...
class TestPytestSnowflakeHookAsync:
    ...
    @mock.patch("airflow.providers.snowflake.hooks.snowflake.SnowflakeHookAsync.get_conn")
    ...
    @pytest.mark.asyncio
    @mock.patch(
        "airflow.providers.snowflake.hooks.snowflake.SnowflakeHookAsync.get_conn",
        side_effect=Exception("Connection Errors"),
    )
