...
TEST_API_ENDPOINT = "/remote_worker/v1/rpcapi"
...
class TestRpcApiEndpoint:
    ...
    @pytest.fixture
    def setup_attrs(self, minimal_app_for_remote_api: Flask) -> Generator:
        self.app = minimal_app_for_remote_api
        self.client = self.app.test_client()  # type:ignore
        mock_test_method.reset_mock()
        mock_test_method.side_effect = None
        with mock.patch(
            "airflow.providers.remote.api_endpoints.rpc_api_endpoint._initialize_method_map"
