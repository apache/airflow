...
class TestXcomObjectStoreBackend:
    ...
    def setup_test_cases(self, tmp_path):
        ...
        configuration = {
            ("core", "xcom_backend"): "airflow.providers.common.io.xcom.backend.XComObjectStoreBackend",
            ("common.io", "xcom_objectstore_path"): self.path,
            ("common.io", "xcom_objectstore_threshold"): "50",
        }
