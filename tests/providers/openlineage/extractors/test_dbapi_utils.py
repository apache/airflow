...
def test_create_create_information_schema_query():
    ...
    assert (
        ...
        == 'SELECT information_schema.columns."table_schema", information_schema.columns."table_name", '
        'information_schema.columns."column_name", information_schema.columns."ordinal_position", '
...
def test_create_create_information_schema_query_cross_db():
    ...
    assert (
        ...
        'db2.information_schema.columns."data_type" FROM db2.information_schema.columns '
