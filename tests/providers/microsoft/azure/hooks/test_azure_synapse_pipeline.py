...
from airflow.providers.microsoft.azure.hooks.synapse_pipeline import AzureSynapsePipelineHook, AzureSynapsePipelineRunException, AzureSynapsePipelineRunStatus
...
SYNAPSE_WORKSPACE_URL = f"https://web.azuresynapse.net?workspace=%2fsubscriptions%2f222f1459-6ebd-4896-82ab-652d5f6883cf%2fresourceGroups%2fabnarain-rg%2fproviders%2fMicrosoft.Synapse%2fworkspaces%2fambika-synapse-workspace"
AZURE_SYNAPSE_WORKSPACE_DEV_ENDPOINT = "azure_synapse_workspace_dev_endpoint" 
PIPELINE_NAME = "pipeline 1"
RUN_ID = "0df528e2-63ad-11ee-9e6c-82bbaeab0fd5"
...
@pytest.fixture
def hook():
    client = AzureSynapsePipelineHook(azure_synapse_conn_id=DEFAULT_CONNECTION_DEFAULT_CREDENTIAL, azure_synapse_workspace_dev_endpoint=AZURE_SYNAPSE_WORKSPACE_DEV_ENDPOINT)
...
def test_get_connection_by_credential_client_secret(connection_id: str, credential_type: type):
    hook = AzureSynapsePipelineHook(azure_synapse_conn_id=connection_id, azure_synapse_workspace_dev_endpoint=AZURE_SYNAPSE_WORKSPACE_DEV_ENDPOINT)
