...
from airflow.providers.microsoft.mssql.transfer.mssql_to_oracle import MsSqlToOracleOperator
...
class TestMsSqlToOracle(unittest.TestCase):
    ...
    def test_execute():
        ...
        source_sql = "select sysdate from dual cast(getdate() As Date) = @p_data"
