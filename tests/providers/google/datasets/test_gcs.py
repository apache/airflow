...
from airflow.providers.google.datasets.gcs import convert_dataset_to_openlineage, create_dataset, sanitize_uri
...
def test_create_dataset():
    assert create_dataset(bucket="test-bucket", key="test-path") == Dataset(uri="gs://test-bucket/test-path")
...
def test_convert_dataset_to_openlineage_valid():
    ...
    ol_dataset = convert_dataset_to_openlineage(dataset=Dataset(uri=uri), lineage_context=None)
