...
from openlineage.client.facet import DataSourceDatasetFacet, ExternalQueryRunFacet
...
class TestBigQueryInsertJobOperator:
    ...
    def test_execute_openlineage_events(self, mock_hook):
        ...
        with open(file="tests/providers/google/cloud/utils/job_details.json") as f:
