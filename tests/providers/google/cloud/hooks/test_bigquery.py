...
class TestBigQueryHookMethods(unittest.TestCase):
    ...
    @mock.patch("airflow.providers.google.common.hooks.base.GoogleBaseHook.__init__")
...
class TestBigQueryHookLocation(unittest.TestCase):
    @mock.patch(
        'airflow.providers.google.common.hooks.base.CloudBaseHook._get_credentials_and_project_id',
        return_value=(CREDENTIALS, PROJECT_ID)
    )
    @mock.patch("airflow.providers.google.cloud.hooks.bigquery.BigQueryHook.get_service")
    @mock.patch("airflow.providers.google.cloud.hooks.bigquery.BigQueryHook.run_with_configuration")
...
class TestBigQueryWithKMS(unittest.TestCase):
    ...
    @mock.patch(
        'airflow.providers.google.common.hooks.base.CloudBaseHook.project_id',
