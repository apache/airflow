...
class TestGcpSecretsManagerBackend(TestCase):
    ...
    def test_get_conn_uri(self, connections_prefix, mock_client_callable, mock_get_creds):
        ...
        secrets_manager_backend = GcpSecretsManagerSecretsBackend(connections_prefix=connections_prefix)
    ...
    def test_get_connections(self, mock_get_uri, mock_get_creds):
        ...
        conns = GcpSecretsManagerSecretsBackend().get_connections(conn_id=CONN_ID)
