...
class TestS3AsyncHook:
    ...
    async def test_s3_key_hook_get_file_metadata(self, mock_client):
        ...
        s3_hook_async = S3AsyncHook(client_type="S3", resource_type="S3")
    ...
    # @pytest.mark.asyncio
    # @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async.head_object")
    # @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    # async def test_s3_key_hook_get_head_object(self, mock_client, mock_head_object):
    #     """
    ...
    @pytest.mark.asyncio
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    async def test_s3_key_hook_get_head_object_with_error(self, mock_client):
        """
    ...
    async def test_s3_key_hook_get_head_object_raise_exception(self, mock_client):
        """
    ...
    @pytest.mark.asyncio
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    async def test_s3_key_hook_get_files_without_wildcard(self, mock_client):
        """
    ...
    @pytest.mark.asyncio
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    async def test_s3_key_hook_get_files_with_wildcard(self, mock_client):
        """
        Test get_files for a valid response
        :return:
        """
    ...
    @pytest.mark.asyncio
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    async def test_s3_key_hook_list_keys(self, mock_client):
        """
    ...
    @pytest.mark.asyncio
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook._list_keys")
    async def test_s3_key_hook_is_keys_unchanged_false(self, mock_list_keys, mock_client):
        """
    ...
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook._list_keys")
    async def test_s3_key_hook_is_keys_unchanged_exception(self, mock_list_keys, mock_client):
        """
    ...
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook._list_keys")
    async def test_s3_key_hook_is_keys_unchanged_pending(self, mock_list_keys, mock_client):
        """
        Test is_key_unchanged gives AirflowException
        :return:
        """
    ...
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook._list_keys")
    async def test_s3_key_hook_is_keys_unchanged_inactivity_error(self, mock_list_keys, mock_client):
        """
        Test is_key_unchanged gives AirflowException
        :return:
        """
    ...
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_client_async")
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook._list_keys")
    async def test_s3_key_hook_is_keys_unchanged_true(self, mock_list_keys, mock_client):
        """
        Test is_key_unchanged gives AirflowException
        :return:
        """
    ...
    @async_mock.patch("airflow.providers.amazon.aws.hooks.s3.S3AsyncHook.get_client_async")
    ...
    @async_mock.patch("airflow.providers.amazon.aws.hooks.s3.S3AsyncHook.get_client_async")
    @async_mock.patch("airflow.providers.amazon.aws.hooks.s3.S3AsyncHook.list_prefixes")
    ...
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_head_object")
    @async_mock.patch("airflow.providers.amazon.aws.hooks.s3.S3AsyncHook.get_client_async")
    async def test_s3__check_key_without_wild_card(self, mock_client, mock_head_object, mock_get_bucket_key):
    ...
    @pytest.mark.asyncio
    @async_mock.patch("airflow.providers.amazon.aws.hooks.s3.S3Hook.get_s3_bucket_key")
    @async_mock.patch("airflow.providers.amazon.aws.triggers.s3.S3AsyncHook.get_file_metadata")
    @async_mock.patch("airflow.providers.amazon.aws.hooks.s3.S3AsyncHook.get_client_async")
