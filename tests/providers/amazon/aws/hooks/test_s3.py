...
class TestAwsS3Hook:
    ...
    def test_download_file(self, mock_temp_file, tmp_path, hook_lineage_collector):
    ...
    def test_download_file_with_preserve_name(self, mock_open, tmp_path, hook_lineage_collector):
