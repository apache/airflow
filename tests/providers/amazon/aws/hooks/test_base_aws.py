...
class TestAwsBaseHook:
    ...
    @mock.patch(
        "botocore.utils.FileWebIdentityTokenLoader.__init__.__defaults__", new=(mock_open(read_data="TOKEN"),)
    )
    @mock.patch.object(
        AwsBaseHook,
        "get_connection",
    ...
    @mock.patch("botocore.credentials.AssumeRoleWithWebIdentityCredentialFetcher")
