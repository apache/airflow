...
class TestGoogleApiToS3Transfer(unittest.TestCase):
    ...
    @patch('airflow.providers.amazon.aws.transfers.google_api_to_s3_transfer.GoogleDiscoveryApiHook.query')
    @patch('airflow.providers.amazon.aws.transfers.google_api_to_s3_transfer.S3Hook.load_string')
    @patch('airflow.providers.amazon.aws.transfers.google_api_to_s3_transfer.json.dumps')
    ...
    @patch('airflow.providers.amazon.aws.transfers.google_api_to_s3_transfer.json.dumps')
    @patch(
        'airflow.providers.amazon.aws.transfers.google_api_to_s3_transfer.sys.getsizeof',
