...
class TestDAGRunSchema(TestDAGRunBase):
    ...
    def test_serialize(self, session):
        ...
        expected_deserialized_dagrun.update({"triggered_by": "test"} if AIRFLOW_V_2_10_PLUS else {})
...
class TestDagRunCollection(TestDAGRunBase):
    ...
    def test_serialize(self, session):
        triggered_by_rest_api_kwargs = (
            {"triggered_by": DagRunTriggeredByType.REST_API} if AIRFLOW_V_2_10_PLUS else {}
        )
        ...
        triggered_by_ui_kwargs = {"triggered_by": DagRunTriggeredByType.UI} if AIRFLOW_V_2_10_PLUS else {}
        ...
        expected_deserialized_dagruns_rest_api.update(
            {"triggered_by": "rest_api"} if AIRFLOW_V_2_10_PLUS else {}
        )
        ...
        expected_deserialized_dagruns_ui.update({"triggered_by": "ui"} if AIRFLOW_V_2_10_PLUS else {})
