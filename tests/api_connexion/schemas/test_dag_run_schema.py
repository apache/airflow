...
class TestDAGRunSchema(TestDAGRunBase):
    ...
    def test_serialize(self, session):
        ...
        expected_deserialized_dagrun.update(
...
class TestDagRunCollection(TestDAGRunBase):
    ...
    def test_serialize(self, session):
        ...
        triggered_by_ui_kwargs = (
            {"triggered_by": DagRunTriggeredByType.UI} if AIRFLOW_V_3_0_PLUS else {}
        )
        ...
        expected_deserialized_dagruns_ui.update(
            {"triggered_by": "ui"} if AIRFLOW_V_3_0_PLUS else {}
        )
