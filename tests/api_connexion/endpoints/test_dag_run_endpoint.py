...
class TestGetDagRun(TestDagRunEndpoint):
    def test_should_respond_200(self, session):
        ...
        expected_response_json.update({"triggered_by": "test"} if AIRFLOW_V_2_10_PLUS else {})
...
class TestGetDagRuns(TestDagRunEndpoint):
    def test_should_respond_200(self, session):
        ...
        expected_response_json_1.update({"triggered_by": "test"} if AIRFLOW_V_2_10_PLUS else {})
        ...
        expected_response_json_2.update({"triggered_by": "test"} if AIRFLOW_V_2_10_PLUS else {})
        result = session.query(DagRun).all()
        assert len(result) == 2
        response = self.client.get(
...
class TestPostDagRun(TestDagRunEndpoint):
    ...
    def test_should_respond_200(
        ...
        expected_response_json.update({"triggered_by": "rest_api"} if AIRFLOW_V_2_10_PLUS else {})
...
class TestSetDagRunNote(TestDagRunEndpoint):
    def test_should_respond_200(self, dag_maker, session):
        ...
        expected_response_json_new.update({"triggered_by": "test"} if AIRFLOW_V_2_10_PLUS else {})
