...
def test_config_copy_mode(
    tmp_configuration_copy, subprocess_call, dag_maker, impersonation
):
    ...
    tmp_configuration_copy.assert_called_with(
        chmod=0o600, include_env=includes, include_cmds=includes
    )
