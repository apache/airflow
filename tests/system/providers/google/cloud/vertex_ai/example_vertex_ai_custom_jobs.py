...
with models.DAG(
    ...
    create_custom_container_training_job = CreateCustomContainerTrainingJobOperator(
        ...
        display_name=f"train-housing-container-{ENV_ID}",
...
with models.DAG(
    ...
    create_custom_python_package_training_job = CreateCustomPythonPackageTrainingJobOperator(
        ...
        display_name=f"train-housing-py-package-{ENV_ID}",
...
custom_container_test_run = get_test_run(custom_container_dag)
python_package_test_run = get_test_run(python_package_dag)
custom_test_run = get_test_run(custom_dag)
list_custom_test_run = get_test_run(list_custom_job_dag)
