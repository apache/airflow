...
from airflow.providers.google.cloud.operators.translate import TranslateTextOperator, TranslateTextBatchOperator
...
# TODO: put the actual resource files to the bucket
...
BATCH_TRANSLATE_INPUT = {
    "gcs_source": {
        "input_uri": BATCH_TRANSLATE_SAMPLE_URI},
    "mime_type": "text/plain",
}
DATA_SAMPLE_GCS_BUCKET_NAME = f"bucket_{DAG_ID}_{ENV_ID}".replace("_", "-")
GCS_OUTPUT_DST = {
    "gcs_destination": {
        "output_uri_prefix": f"gs://{DATA_SAMPLE_GCS_BUCKET_NAME}/translate_output/"
    }
}
...
with DAG(
    ...
    batch_translate_input_1 = {
        "gcs_source": {"input_uri": "gs://okchr-dev-translate-usc1/V3_translate/text_batch/inputs/translate_sample_de_1.txt"},
        "mime_type": "text/plain",
    }
