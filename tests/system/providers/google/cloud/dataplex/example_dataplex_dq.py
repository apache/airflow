...
from airflow.providers.google.cloud.operators.dataplex import (
    ...
    DataplexExecuteDataQualityScanOperator,
...
with models.DAG(
    ...
    # [START howto_dataplex_execute_data_quality_operator]
    execute_data_scan = DataplexExecuteDataQualityScanOperator(
        task_id="execute_data_scan",
        project_id=PROJECT_ID,
        region=REGION,
        data_scan_id=DATA_SCAN_ID,
    )
    # [END howto_dataplex_execute_data_quality_operator]
    # [START howto_dataplex_execute_data_quality_def_operator]
    execute_data_scan_def = DataplexExecuteDataQualityScanOperator(
        task_id="execute_data_scan_def",
        project_id=PROJECT_ID,
        region=REGION,
        data_scan_id=DATA_SCAN_ID,
        deferrable=True,
    )
    # [END howto_dataplex_execute_data_quality_def_operator]
    # [START howto_dataplex_run_data_quality_operator]
    run_data_scan = DataplexRunDataQualityScanOperator(
        task_id="run_data_scan", project_id=PROJECT_ID, region=REGION, data_scan_id=DATA_SCAN_ID
    )
    # [END howto_dataplex_run_data_quality_operator]
    job_id = run_data_scan.output
