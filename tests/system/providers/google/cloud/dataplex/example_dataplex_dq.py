...
from airflow.providers.google.cloud.sensors.dataplex import DataplexJobStatusSensor
...
with models.DAG(
    ...
    # [START howto_dataplex_run_data_quality_async_operator]
    run_data_scan_async = DataplexRunDataQualityOperator(
    ...
    # [END howto_dataplex_run_data_quality_async_operator]
    # [START howto_dataplex_data_scan_job_state_sensor]
    get_data_scan_job_status = DataplexJobStatusSensor(
        task_id="get_data_scan_job_status",
        project_id=PROJECT_ID,
        region=REGION,
        name=cast(str, XComArg(run_data_scan_async, key="job_id")),
    )
    # [END howto_dataplex_data_scan_job_state_sensor]
    # [START howto_dataplex_get_data_quality_job_operator]
    get_data_scan_job = DataplexGetDataQualityJobOperator(
    ...
    get_data_scan = DataplexGetDataQualityOperator(
