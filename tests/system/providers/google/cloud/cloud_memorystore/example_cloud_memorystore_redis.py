...
MEMORYSTORE_REDIS_INSTANCE_NAME = f"redis-{str(ENV_ID).lower()}-1"
MEMORYSTORE_REDIS_INSTANCE_NAME_2 = f"redis-{str(ENV_ID).lower()}-2"
MEMORYSTORE_REDIS_INSTANCE_NAME_3 = f"redis-{str(ENV_ID).lower()}-3"
