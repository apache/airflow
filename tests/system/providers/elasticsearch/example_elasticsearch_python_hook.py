...
"""
Example Airflow DAG that is using ElasticsearchPythonHook.
"""
import os
...
with models.DAG(
    ...
    es_test = PythonOperator(task_id='print_data_from_elasticsearch', python_callable=use_elasticsearch_hook)
