...
class CloudSqlExampleDagsSystemTest(DagGcpSystemTestCase):
    def __init__(self, method_name='runTest'):
        super(CloudSqlExampleDagsSystemTest, self).__init__(
            method_name,
    ...
    def tearDown(self):
        ...
        super(CloudSqlExampleDagsSystemTest, self).tearDown()
