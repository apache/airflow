    ...
    def test_should_copy_single_file(self, mock_named_temporary_file, mock_gdrive, mock_gcs_hook):
        ...
        mock_gcs_hook.assert_has_calls(
            [
                ...
                mock.call().download(
                    bucket="data", filename="TMP1", object="sales/sales-2017/january.avro"
                ),
            ]
        )
    ...
    def test_should_copy_files(self, mock_named_temporary_file, mock_gdrive, mock_gcs_hook):
        ...
        mock_gcs_hook.assert_has_calls(
            [
                ...
                mock.call().download(bucket="data", filename="TMP1", object="sales/A.avro"),
                mock.call().download(bucket="data", filename="TMP2", object="sales/B.avro"),
                mock.call().download(bucket="data", filename="TMP3", object="sales/C.avro"),
            ]
        )
