...
"""
Tests for the Azure Kubernetes Operator
"""
...
from airflow.contrib.operators.azure_kubernetes_operator import AzureKubernetesOperator


class AzureKubernetesKubernetesOperatorTest(unittest.TestCase):
    """
    Tests for the AKS Operator
    """

    @mock.patch('airflow.contrib.operators.azure_kubernetes_operator.AzureKubernetesServiceHook')
    def test_execute_existing_kubernetes(self, aks_hook_mock):
        """ Test if the AKS cluster exists """
        aks = AzureKubernetesOperator(ci_conn_id='azure_default',
    ...
    def test_execute_create_kubernetes(self, aks_hook_mock):
        ...
        resp.text = '{"Message": "The Resource Microsoft.ContainerService/managedClusters/name \
            under resource group resource_group was not found."}'
