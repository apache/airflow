...
class TestTextToSpeechOperator(unittest.TestCase):
    ...
    def test_synthesize_speech(self, get_conn):
        ...
        self.gcp_text_to_speech_hook.synthesize_speech(input_=INPUT, voice=VOICE, audio_config=AUDIO_CONFIG)
        synthesize_method.assert_called_once_with(input_=INPUT, voice=VOICE, audio_config=AUDIO_CONFIG)
