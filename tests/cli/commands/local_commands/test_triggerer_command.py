...
from airflow.cli.commands.local_commands import triggerer_command
...
class TestTriggererCommand:
    ...
    @mock.patch("airflow.cli.commands.local_commands.triggerer_command._serve_logs")
    ...
    @mock.patch("airflow.cli.commands.local_commands.triggerer_command.TriggererJobRunner")
    @mock.patch("airflow.cli.commands.local_commands.triggerer_command.run_job")
    @mock.patch("airflow.cli.commands.local_commands.triggerer_command.Process")
