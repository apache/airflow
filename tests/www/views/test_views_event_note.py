...
#         session.query(EventNote).delete()
...
#
#     admin_client.post(
#         f'event_note?dag_id={test_dag_id}&task_id={test_task_id}&execution_date={str_execution_date}',
#         data={"note": event_note},
#     )
#
...
#     ).first()
#
#     assert note is not None and note.event_note == event_note
#
#
# def test_submit_event_note_not_ascii(session, admin_client):
#     test_dag_id = "example_bash_operator"
#     test_task_id = "runme_0"
...
#
#
# def test_submit_event_note_not_existing_task(session, admin_client):
#     test_dag_id = "example_bash_operator"
#     test_task_id = "runme_0"
...
#         f'event_note?dag_id={test_dag_id}&task_id={test_task_id}&execution_date={str_wrong_execution_date}',
#         data={"note": event_note},
#     )
#
...
#
#
# def test_get_event_note(admin_client, session):
#     test_dag_id = "example_bash_operator"
#     test_task_id = "runme_0"
...
#     )
#
#     check_content_in_response(event_note, resp, 200)
#
#
