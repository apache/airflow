...
def test_historical_metrics_data(admin_client, session, time_machine):
    ...
    assert resp.json == {
        ...
        "dag_run_types": {"backfill": 0, "dataset_triggered": 1, "manual": 0, "scheduled": 2, "triggered": 0},
...
def test_historical_metrics_data_date_filters(admin_client, session):
    ...
    assert resp.json == {
        ...
        "dag_run_types": {"backfill": 0, "dataset_triggered": 1, "manual": 0, "scheduled": 0, "triggered": 0},
        "task_instance_states": {
            "deferred": 0,
            "failed": 2,
            "no_status": 0,
