...
class TestSecurity(unittest.TestCase):
    ...
    def _has_dag_perm(self, perm, dag_id):
        return self.security_manager.has_access(
            perm, self.security_manager.prefixed_dag_id(dag_id), self.user
        )
    ...
    def test_all_dag_access_doesnt_give_non_dag_access(self):
        username = 'all_dag_access_doesnt_give_non_dag_access_user'
        role_name = 'all_dag_access_doesnt_give_non_dag_access_role'
    ...
    def test_access_control_stale_perms_are_revoked(self):
        ...
        self.assert_user_has_dag_perms(
            perms=['can_read'], dag_id='access_control_test',
        )
        self.assert_user_does_not_have_dag_perms(
            perms=['can_edit'], dag_id='access_control_test',
        )
