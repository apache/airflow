...
class TestDagTags(TestDagEndpoint):
    ...
    def test_get_dag_tags(
        ...
        response = test_client.get("/v2/dagTags", params=query_params)
    ...
    def test_should_respond_401(self, unauthenticated_test_client):
        response = unauthenticated_test_client.get("/v2/dagTags")
        assert response.status_code == 401

    def test_should_respond_403(self, unauthorized_test_client):
        response = unauthorized_test_client.get("/v2/dagTags")
