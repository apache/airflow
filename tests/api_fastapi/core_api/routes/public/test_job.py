...
class TestJobEndpoint:
    """Common class for /v2/jobs related unit tests."""
...
class TestGetJobs(TestJobEndpoint):
    ...
    def test_get_jobs(
        ...
        self.setup(testcase)
        response = test_client.get("/v2/jobs", params=query_params)
    ...
    def test_should_raises_401_unauthenticated(self, unauthenticated_test_client):
        response = unauthenticated_test_client.get("/v2/jobs")
        assert response.status_code == 401

    def test_should_raises_403_unauthorized(self, unauthorized_test_client):
        response = unauthorized_test_client.get("/v2/jobs")
