...
class TestSecretsMasker:
    ...
    def test_redact_max_depth(self, val, expected, max_depth):
        ...
        with patch("airflow.sdk.definitions.secrets_masker._secrets_masker", return_value=secrets_masker):
...
class TestShouldHideValueForKey:
    ...
    def test_hiding_config(self, sensitive_variable_fields, key, expected_result):
        from airflow.sdk.definitions.secrets_masker import get_sensitive_variables_fields
...
class TestRedactedIO:
    ...
    def reset_secrets_masker(self):
        ...
        with patch(
            "airflow.sdk.definitions.secrets_masker._secrets_masker", return_value=self.secrets_masker
        ):
            mask_secret(p)
            yield
...
class TestMaskSecretAdapter:
    ...
    def reset_secrets_masker_and_skip_escape(self):
        ...
        with patch(
            ...
            with patch("airflow.sdk.definitions.secrets_masker.re2.escape", lambda x: x):
                yield
