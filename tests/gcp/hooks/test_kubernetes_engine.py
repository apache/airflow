...
class TestGKEClusterHookClient(unittest.TestCase):
    ...
    def test_gke_cluster_client_creation(
...
class TestGKEClusterHookDelete(unittest.TestCase):
    ...
    @mock.patch("airflow.gcp.hooks.kubernetes_engine.GKEHook.wait_for_operation")
    ...
    def test_delete_cluster_not_found(
        self, wait_mock, convert_mock, log_mock, mock_project_id
    ):
        ...
        self.gke_hook.delete_cluster(
            name="not-existing", project_id=TEST_GCP_PROJECT_ID
        )
...
class TestGKEClusterHookCreate(unittest.TestCase):
    ...
    @mock.patch(
        "airflow.gcp.hooks.kubernetes_engine.GKEHook._get_credentials_and_project_id",
    ...
    def test_create_cluster_already_exists(
        self, wait_mock, convert_mock, log_mock, mock_get_credentials
    ):
...
class TestGKEClusterHook(unittest.TestCase):
    ...
    @mock.patch(
        "airflow.gcp.hooks.kubernetes_engine.container_v1." "ClusterManagerClient"
    )
    ...
    def test_append_label_replace(self):
        ...
        mock_proto = mock.Mock()
        self.gke_hook._append_label(mock_proto, key, val)
        mock_proto.resource_labels.update.assert_called_once_with(
            {key: "test-val-this"}
        )
