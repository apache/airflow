...
class TestBaseChartTest(unittest.TestCase):
    ...
    def test_labels_are_valid(self):
        ...
        kind_names_tuples = [
            ...
            (f"{release_name}-airflow-airflow-result-backend", "Secret", None),
            ...
            (f"{release_name}-airflow-triggerer", "Deployment", "triggerer"),
            (f"{release_name}-airflow-logs", "PersistentVolumeClaim", "logs-pvc"),
            (f"{release_name}-airflow-dags", "PersistentVolumeClaim", "dags-pvc"),
        ]
