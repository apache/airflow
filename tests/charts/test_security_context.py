...
class TestSecurityContext:
    ...
    # Test containerSecurityContext for main containers
    def test_main_container_setting(self):
        ctx_value = {"allowPrivilegeEscalation": False}
        security_context = {"containerSecurityContext": ctx_value}
        docs = render_chart(
            values={
    ...
    # Test containerSecurityContext for log-groomer-sidecar main container
    def test_log_groomer_sidecar_container_setting(self):
        ctx_value = {"allowPrivilegeEscalation": False}
        spec = {"logGroomerSidecar": {"containerSecurityContext": ctx_value}}
        docs = render_chart(
            values={
                "scheduler": {**spec},
                "workers": {**spec},
    ...
    # Test containerSecurityContext for metrics-explorer main container
    def test_metrics_explorer_container_setting(self):
        ...
        docs = render_chart(
            values={
                "pgbouncer": {
                    "enabled": True,
                    "metricsExporterSidecar": {"containerSecurityContext": ctx_value},
                },
            },
    ...
    # Test containerSecurityContext for worker-kerberos main container
    def test_worker_kerberos_container_setting(self):
        ctx_value = {"allowPrivilegeEscalation": False}
        docs = render_chart(
            values={
                "workers": {"kerberosSidecar": {"enabled": True, "containerSecurityContext": ctx_value}},
            },
    ...
    # Test containerSecurityContext for the wait-for-migrations init containers
    def test_wait_for_migrations_init_container_setting(self):
        ctx_value = {"allowPrivilegeEscalation": False}
        spec = {
            "waitForMigrations": {
                "enabled": True,
                "containerSecurityContext": ctx_value,
            }
        }
        docs = render_chart(
            values={
                ...
                "webserver": {**spec},
                "triggerer": {**spec},
                "workers": {"waitForMigrations": {"containerSecurityContext": ctx_value}},
            },
            show_only=[
                "templates/scheduler/scheduler-deployment.yaml",
                "templates/webserver/webserver-deployment.yaml",
    ...
    # Test containerSecurityContext for volume-permissions init container
