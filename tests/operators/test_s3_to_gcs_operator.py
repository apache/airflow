...
from airflow.operators.s3_to_gcs_operator import S3ToGoogleCloudStorageOperator
...
class TestS3ToGoogleCloudStorageOperator(unittest.TestCase):
    ...
    @mock.patch('airflow.operators.s3_to_gcs_operator.S3Hook')
    @mock.patch('airflow.contrib.operators.s3_list_operator.S3Hook')
    @mock.patch(
        'airflow.operators.s3_to_gcs_operator.GoogleCloudStorageHook')
