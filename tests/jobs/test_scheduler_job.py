...
class TestSchedulerJob:
    ...
    def test_execute_task_instances_is_paused_wont_execute(self, session, dag_maker):
        ...
        self.scheduler_job._critical_section_schedule_task_instances(session)
        ti1.refresh_from_db(session=session)
    ...
    def test_critical_section_schedule_task_instances(self, dag_maker):
        ...
        res = self.scheduler_job._critical_section_schedule_task_instances(session)
