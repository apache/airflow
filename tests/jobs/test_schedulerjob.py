...
from airflow.jobs import SchedulerJob, BackfillJob
from airflow.models import DagBag, DAG, TaskInstance as TI, Pool, DagModel, errors, DagRun, SlaMiss
from airflow.operators.bash_operator import BashOperator
from airflow.operators.dummy_operator import DummyOperator
from airflow.utils import timezone
from airflow.utils.dag_processing import SimpleDagBag, SimpleDag, list_py_file_paths
from airflow.utils.dates import days_ago
from airflow.utils.db import create_session, provide_session
from airflow.utils.state import State
from tests.compat import MagicMock, Mock, patch, PropertyMock
from tests.executors.test_executor import TestExecutor
from tests.jobs import DEFAULT_DATE, TEST_DAGS_FOLDER
from tests.test_utils.db import clear_db_runs, clear_db_pools, clear_db_dags, clear_db_sla_miss, \
    clear_db_errors
...
class SchedulerJobTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.patcher = mock.patch('airflow.jobs.schedulerjob.conf.getboolean')
    ...
    def test_scheduler_task_start_date(self):
        ...
        scheduler = SchedulerJob(dag_id,
                                 executor=self.null_exec,
                                 subdir=os.path.join(TEST_DAGS_FOLDER, 'test_scheduler_dags.py'),
                                 num_runs=2)
        scheduler.run()
