...
from airflow.exceptions import DagConcurrencyLimitReached, NoAvailablePoolSlot, \
    TaskConcurrencyLimitReached, AirflowException
...
from tests.jobs import DEFAULT_DATE
from tests.test_utils.db import clear_db_runs, clear_db_pools
...
class BackfillJobTest(unittest.TestCase):
    ...
    @patch('airflow.jobs.basejob.LoggingMixin.log')
    ...
    @patch('airflow.jobs.basejob.LoggingMixin.log')
    @patch('airflow.jobs.backfilljob.conf.getint')
