...
class TestDagRunCancelEndpoint(unittest.TestCase):
    dag_serialzation = "False"

    @classmethod
    def setUpClass(cls):
        super(TestDagRunCancelEndpoint, cls).setUpClass()
        session = Session()
    ...
    def setUp(self):
        super(TestDagRunCancelEndpoint, self).setUp()
    ...
    def test_get_dag_runs_success(self):
        with conf_vars(
            ...
            url_template = '/api/experimental/dags/{}/cancel_dag_run'
            ...
            self.assertEqual(dag_run.state, State.FAILED)
