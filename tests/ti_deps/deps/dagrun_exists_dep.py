...
class DagrunExistsDepTest(unittest.TestCase):
    ...
    def test_dagrun_doesnt_exist(self):
        ...
        self.assertFalse(DagrunExistsDep().is_met(ti=ti, dep_context=None))
    ...
    def test_dagrun_exists(self):
        ...
        self.assertTrue(DagrunExistsDep().is_met(ti=ti, dep_context=None))
