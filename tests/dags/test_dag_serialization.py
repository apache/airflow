...
example_bash_operator_ground_truth=''
...
def make_simple_dag():
    ...
    task = BaseOperator(task_id='simple_task', dag=dag, start_date=datetime(2019, 8, 1))
...
class TestStringifiedDAGs(unittest.TestCase):
    ...
    def test_deserialization(self):
        ...
        self.validate_task_type(stringified_dags['example_skip_dag'])

    def validate_task_type(self, dag):
        """Verify non-airflow operators are casted to BaseOperator."""
        skip_operator_1_task = dag.task_dict['skip_operator_1']
        # The stringified operator is casted to BaseOperator.
        self.assertTrue(isinstance(skip_operator_1_task, BaseOperator))
        # Verify the original operator class is recorded for UI.
        self.assertTrue(skip_operator_1_task.is_stringified)
        self.assertTrue(skip_operator_1_task.operator_class ==
                        'DummySkipOperator')
