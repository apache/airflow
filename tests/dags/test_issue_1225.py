...
dag1 = DAG(dag_id="test_backfill_pooled_task_dag", schedule=None, default_args=default_args)
...
dag3 = DAG(dag_id="test_dagrun_states_fail", schedule=None, default_args=default_args)
...
dag4 = DAG(dag_id="test_dagrun_states_success", schedule=None, default_args=default_args)
...
dag5 = DAG(dag_id="test_dagrun_states_root_fail", schedule=None, default_args=default_args)
...
dag6 = DAG(dag_id="test_dagrun_states_deadlock", schedule=None, default_args=default_args)
...
dag8 = DAG(dag_id="test_dagrun_states_root_fail_unfinished", schedule=None, default_args=default_args)
...
dag9 = DAG(dag_id="test_dagrun_states_root_future", schedule=None, default_args=default_args)
