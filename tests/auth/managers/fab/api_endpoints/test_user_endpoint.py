...
class TestGetUser(TestUserEndpoint):
    def test_should_respond_200(self):
        ...
        self.session.commit()
        response = self.client.get("/security/v1/users/TEST_USER1", environ_overrides={"REMOTE_USER": "test"})
    ...
    def test_last_names_can_be_empty(self):
        ...
        self.session.commit()
        response = self.client.get("/security/v1/users/prince", environ_overrides={"REMOTE_USER": "test"})
        assert response.status_code == 200
        assert response.json == {
            "active": None,
            "changed_on": DEFAULT_TIME,
    ...
    def test_first_names_can_be_empty(self):
        ...
        self.session.commit()
        response = self.client.get("/security/v1/users/liberace", environ_overrides={"REMOTE_USER": "test"})
        assert response.status_code == 200
        assert response.json == {
            "active": None,
            "changed_on": DEFAULT_TIME,
    ...
    def test_both_first_and_last_names_can_be_empty(self):
        ...
        self.session.commit()
        response = self.client.get("/security/v1/users/nameless", environ_overrides={"REMOTE_USER": "test"})
        assert response.status_code == 200
        assert response.json == {
            "active": None,
            "changed_on": DEFAULT_TIME,
    ...
    def test_should_respond_404(self):
        response = self.client.get(
            "/security/v1/users/invalid-user", environ_overrides={"REMOTE_USER": "test"}
        )
    ...
    def test_should_raises_401_unauthenticated(self):
        response = self.client.get("/security/v1/users/TEST_USER1")
        assert_401(response)

    def test_should_raise_403_forbidden(self):
        response = self.client.get(
            "/security/v1/users/TEST_USER1", environ_overrides={"REMOTE_USER": "test_no_permissions"}
        )
...
class TestGetUsers(TestUserEndpoint):
    def test_should_response_200(self):
        response = self.client.get("/security/v1/users", environ_overrides={"REMOTE_USER": "test"})
        assert response.status_code == 200
    ...
    def test_should_raises_401_unauthenticated(self):
        response = self.client.get("/security/v1/users")
        assert_401(response)

    def test_should_raise_403_forbidden(self):
        response = self.client.get(
            "/security/v1/users", environ_overrides={"REMOTE_USER": "test_no_permissions"}
        )
        assert response.status_code == 403
...
class TestGetUsersPagination(TestUserEndpoint):
    @pytest.mark.parametrize(
        ...
        [
            ("/security/v1/users?limit=1", ["test"]),
            ("/security/v1/users?limit=2", ["test", "test_no_permissions"]),
            (
                "/security/v1/users?offset=5",
                [
                    "TEST_USER4",
                    "TEST_USER5",
                    "TEST_USER6",
            ...
            ("/security/v1/users?limit=1&offset=5", ["TEST_USER4"]),
            ("/security/v1/users?limit=1&offset=1", ["test_no_permissions"]),
            (
                "/security/v1/users?limit=2&offset=2",
    ...
    def test_should_response_400_with_invalid_order_by(self):
        ...
        self.session.commit()
        response = self.client.get(
            "/security/v1/users?order_by=myname", environ_overrides={"REMOTE_USER": "test"}
        )
    ...
    def test_limit_of_zero_should_return_default(self):
        ...
        response = self.client.get("/security/v1/users?limit=0", environ_overrides={"REMOTE_USER": "test"})
        assert response.status_code == 200
    ...
    def test_should_return_conf_max_if_req_max_above_conf(self):
        ...
        response = self.client.get("/security/v1/users?limit=180", environ_overrides={"REMOTE_USER": "test"})
        assert response.status_code == 200
...
class TestPatchUser(TestUserEndpoint):
    ...
    def test_change(self, autoclean_username, autoclean_user_payload):
        ...
        response = self.client.patch(
            f"/security/v1/users/{autoclean_username}",
            json=autoclean_user_payload,
            environ_overrides={"REMOTE_USER": "test"},
        )
        assert response.status_code == 200, response.json
    ...
    def test_change_with_update_mask(self, autoclean_username, autoclean_user_payload):
        ...
        response = self.client.patch(
            f"/security/v1/users/{autoclean_username}?update_mask=last_name",
            json=autoclean_user_payload,
            environ_overrides={"REMOTE_USER": "test"},
        )
        assert response.status_code == 200, response.json
    ...
    def test_replace_roles(self, autoclean_username, autoclean_user_payload):
        ...
        response = self.client.patch(
            f"/security/v1/users/{autoclean_username}?update_mask=roles",
            json=autoclean_user_payload,
            environ_overrides={"REMOTE_USER": "test"},
        )
        assert response.status_code == 200, response.json
