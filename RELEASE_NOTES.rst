...
- fix(io.path): add missing conn_id to string representation of ObjectStoragePath (#39313)
...
- Update best-practices.rst: fix Connection.get -> Connection. get_connection_from_secrets (#39560)
