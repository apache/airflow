...
def _get_module_class_registry(
    module_filepath: str, class_extras: dict[str, Callable]
...
def _render_openlineage_supported_classes_content():
    ...
    hook_level_lineage_collector_calls = {
        "airflow.providers.common.compat.lineage.hook.get_hook_lineage_collector.add_input_dataset",
        "airflow.providers.common.compat.lineage.hook.get_hook_lineage_collector.add_output_dataset",
    }
