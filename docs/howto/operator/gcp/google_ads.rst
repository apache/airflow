...
:class:`~airflow.providers.google.marketing_platform.operators.google_ads.GoogleAdsToGcsOperator`.

.. exampleinclude:: ../../../../airflow/providers/google/marketing_platform/example_dags/example_google_ads.py
    :language: python
    :dedent: 4
    :start-after: [START howto_google_ads_to_gsc_operator]
    :end-before: [END howto_google_ads_to_gsc_operator]

Use :ref:`Jinja templating <jinja-templating>` with
:template-fields:`airflow.providers.google.marketing_platform.operators.google_ads.GoogleAdsToGcsOperator`
