...
This is detailed commit list of changes for versions provider package: ``segment``.
...
`548d082008 <https://github.com/apache/airflow/commit/548d082008c0c83f44020937f6ff19ca006b96cc>`_  2021-01-13   ``Update external docs URL for Segment (#13645)``
...
`85cc2a605e <https://github.com/apache/airflow/commit/85cc2a605e82c6ad26f310e989b365d9d490f2f3>`_  2020-08-03   ``Add typing annotations to Segment provider (#10120)``
