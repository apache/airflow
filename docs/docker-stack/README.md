...
* `apache/airflow:2.5.3` - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:2.5.3-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-2.5.3`           - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:slim-2.5.3-pythonX.Y` - the versioned Airflow image with specific Python version
