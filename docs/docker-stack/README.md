...
You can find the following images there (Assuming Airflow version `2.8.2`):
...
* `apache/airflow:2.8.2` - the versioned Airflow image with default Python version (3.8 currently)
* `apache/airflow:2.8.2-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-2.8.2`           - the versioned Airflow image with default Python version (3.8 currently)
* `apache/airflow:slim-2.8.2-pythonX.Y` - the versioned Airflow image with specific Python version
