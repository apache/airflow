...
You can find the following images there (Assuming Airflow version `3.0.0b1`):
...
* `apache/airflow:3.0.0b1` - the versioned Airflow image with default Python version (3.12 currently)
* `apache/airflow:3.0.0b1-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-3.0.0b1`           - the versioned Airflow image with default Python version (3.12 currently)
* `apache/airflow:slim-3.0.0b1-pythonX.Y` - the versioned Airflow image with specific Python version
