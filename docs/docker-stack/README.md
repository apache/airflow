...
* `apache/airflow:2.6.1` - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:2.6.1-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-2.6.1`           - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:slim-2.6.1-pythonX.Y` - the versioned Airflow image with specific Python version
