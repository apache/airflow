...
You can find the following images there (Assuming Airflow version `2.6.0`):
...
* `apache/airflow:2.6.0` - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:2.6.0-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-2.6.0`           - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:slim-2.6.0-pythonX.Y` - the versioned Airflow image with specific Python version
