...
* `apache/airflow:2.6.0.dev0` - the versioned Airflow image with default Python version (3.8 currently)
...
* `apache/airflow:slim-2.6.0.dev0`           - the versioned Airflow image with default Python version (3.8 currently)
