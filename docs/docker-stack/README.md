...
* `apache/airflow:2.10.4` - the versioned Airflow image with default Python version (3.12 currently)
...
* `apache/airflow:slim-2.10.4`           - the versioned Airflow image with default Python version (3.12 currently)
