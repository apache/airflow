...
.. code-block:: bash
  ...
  docker run -it apache/airflow:2.7.3-python3.8 bash -c "ls -la"
  total 16
...
.. code-block:: bash
  ...
  > docker run -it apache/airflow:2.7.3-python3.8 python -c "print('test')"
  test
...
.. code-block:: bash
   ...
   docker run -it apache/airflow:2.7.3-python3.8 airflow webserver

If there are any other arguments - they are simply passed to the "airflow" command

.. code-block:: bash

  > docker run -it apache/airflow:2.7.3-python3.8 help
...
.. code-block:: bash
  ...
  docker run -it -p 8080:8080 \
    ...
    --env "_AIRFLOW_WWW_USER_PASSWORD=admin" \
      apache/airflow:2.7.3-python3.8 webserver
