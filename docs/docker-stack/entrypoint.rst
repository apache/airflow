...
.. code-block:: bash
  ...
  docker run -it apache/airflow:2.6.0.dev0-python3.8 bash -c "ls -la"
  total 16
...
.. code-block:: bash
  ...
  > docker run -it apache/airflow:2.6.0.dev0-python3.8 python -c "print('test')"
  test
...
.. code-block:: bash
   ...
   docker run -it apache/airflow:2.6.0.dev0-python3.8 airflow webserver

If there are any other arguments - they are simply passed to the "airflow" command

.. code-block:: bash

  > docker run -it apache/airflow:2.6.0.dev0-python3.8 help
