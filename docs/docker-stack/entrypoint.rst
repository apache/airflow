...
.. code-block:: bash
  ...
  docker run -it apache/airflow:3.0.0b4-python3.9 bash -c "ls -la"
  total 16
...
.. code-block:: bash
  ...
  > docker run -it apache/airflow:3.0.0b4-python3.9 python -c "print('test')"
  test
...
.. code-block:: bash
   ...
   docker run -it apache/airflow:3.0.0b4-python3.9 airflow webserver

If there are any other arguments - they are simply passed to the "airflow" command

.. code-block:: bash

  > docker run -it apache/airflow:3.0.0b4-python3.9 help
...
.. code-block:: bash
  ...
  docker run -it -p 8080:8080 \
    ...
    --env "_AIRFLOW_WWW_USER_PASSWORD=admin" \
      apache/airflow:3.0.0b4-python3.9 webserver
