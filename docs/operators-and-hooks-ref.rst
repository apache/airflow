...
.. list-table::
   ...
   * - `Azure Blob Storage <https://azure.microsoft.com/en-us/services/storage/blobs/>`__
     - `Google Cloud Storage (GCS) <https://cloud.google.com/gcs/>`__
     - :doc:`How to use <howto/operator/microsoft/azure/blob_storage_to_gcs>`
     - :mod:`airflow.providers.microsoft.azure.transfers.AzureBlobStorageToGCSTransferOperator`
