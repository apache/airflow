...
+=================================+===================+===================+==============================================================+
<<<<<<< HEAD
| ``f5fcbda3e651`` (head)         | ``3c94c427fdf6``  | ``2.3.3``         | Add indexes for CASCADE deletes on task_instance             |
=======
| ``424117c37d18`` (head)         | ``3c94c427fdf6``  | ``2.4.0``         | Add DagWarning model                                         |
>>>>>>> c52b4e02f7 (Add dag configuration error model)
+---------------------------------+-------------------+-------------------+--------------------------------------------------------------+
