...
The API authentication is handled by the auth manager. For more information about the API authentication, please refer to the auth manager documentation used by your environment.
