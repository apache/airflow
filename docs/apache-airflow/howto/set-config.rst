...
Some of Airflow configuration can be configured via local setting, because they require changes in the
...
You should create ``airflow_local_settings.py`` file and put in on ``$PYTHONPATH`` or
