...
It will contain all the default configuration options nicely commented out, with examples and
all the values will be commented out so you can only un-comment and change those that you want to change.
