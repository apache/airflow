...
- :class:`~airflow.providers.standard.core.operators.python.PythonOperator` - calls an arbitrary Python function
...
.. note::
    The ``@task`` decorator is recommended over the classic :class:`~airflow.providers.standard.core.operators.python.PythonOperator`
