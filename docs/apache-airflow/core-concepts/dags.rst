...
To keep the allowed DAGs, you can change the value of the variable ``AIRFLOW__CORE__ENABLE_SCANNING_STALE_DAGS`` to ``False``. By default, it is set to ``True`` in config.yml.
