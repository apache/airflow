...
.. note::
    When notifiers are used with `sla_miss_callback` the context will contain values passed to the callback, refer :ref:`sla_miss_callback<concepts:sla_miss_callback>`.
