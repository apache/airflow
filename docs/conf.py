...
exclude_patterns = [
    ...
    '_api/airflow/providers/aws/example_dags/index.rst',
    '_api/airflow/providers/aws/hooks/index.rst',
    '_api/airflow/providers/aws/operators/index.rst',
    '_api/airflow/providers/aws/sensors/index.rst',
