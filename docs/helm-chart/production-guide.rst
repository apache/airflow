...
----------------------
When running Airflow along with the `Kubernetes Cluster Autoscaler <https://github.com/kubernetes/autoscaler/tree/master/cluster-autoscaler>`_, it is important to configure whether pods can be safely evicted.
...
You can find more information about eviction `here <https://github.com/kubernetes/autoscaler/blob/master/cluster-autoscaler/FAQ.md>`_
