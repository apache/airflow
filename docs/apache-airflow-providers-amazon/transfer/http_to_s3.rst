...
:class:`~airflow.providers.amazon.aws.transfers.http_to_s3.HttpToS3Operator`

Example usage:

.. exampleinclude:: /../../providers/tests/system/amazon/aws/example_http_to_s3.py
    :language: python
    :dedent: 4
    :start-after: [START howto_transfer_http_to_s3]
    :end-before: [END howto_transfer_http_to_s3]
