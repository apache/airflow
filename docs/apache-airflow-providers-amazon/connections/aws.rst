...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  .. code-block:: python
    ...
    conn = Connection(
        ...
        conn_type="aws",
        login="xxxxxxxxxxxxxxxxxxxxxxxxx",  # Reference to AWS Access Key ID
        password="xxxxxxxxxxxxxxxxxxxxxxxxx",  # Reference to AWS Secret Access Key
        extra={
    ...
    # AIRFLOW_CONN_SAMPLE_AWS_CONNECTION=aws://xxxxxxxxxxxxxxxxxxxxxxxxx:wJalrXUtnFEMI%2FK7MDENG%2FbPxRfiCYEXAMPLEKEY@/?region_name=eu-central-1
...
^^^^^^^^^^^^^^^^^^^^^^^
  ...
  **URI format example**
  ...
  .. code-block:: bash
    ...
    export AIRFLOW_CONN_AWS_DEFAULT=aws://xxxxxxxxxxxxxxxxxxxxxxxxx:wJalrXUtnFEMI%2FK7MDENG%2FbPxRfiCYEXAMPLEKEY@
