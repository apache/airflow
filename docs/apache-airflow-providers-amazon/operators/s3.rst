...
:class:`~airflow.providers.amazon.aws.operators.s3.S3GetObejectOperator`.

.. exampleinclude:: /../../tests/system/providers/amazon/aws/example_s3.py
    :language: python
    :dedent: 4
    :start-after: [START howto_operator_s3_get_object]
    :end-before: [END howto_operator_s3_get_object]
