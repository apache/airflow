...
`<https://airflow.apache.org/docs/apache-airflow/stable/authoring-and-scheduling/connections.html>`_. For this purpose the connection type ``Package Index (Python)`` can be used.
