...
`Naming conventions for provider packages <https://github.com/apache/airflow/blob/main/contribution-docs/creating_issues_and_pull_requests.rst#naming-conventions-for-provider-packages>`_
