...
Bit operation like `>>` or `<<` are suggested to set dependency, which visual and easier to explain.
`airflow.utlis.helpers.chain` is deprecation after Airflow 1.10.2
