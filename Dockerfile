...
ARG CONSTRAINT_REQUIREMENTS="${AIRFLOW_SOURCES_FROM}/requirements/requirements-python${PYTHON_MAJOR_MINOR_VERSION}.txt"
...
ARG ENTRYPOINT_FILE="${AIRFLOW_INSTALL_SOURCES}/entrypoint.sh"
