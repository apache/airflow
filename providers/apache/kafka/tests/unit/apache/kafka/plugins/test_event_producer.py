...
def _clear_cached_values():
    ...
    event_producer._get_topic_dagrun.cache_clear()
    event_producer._get_topic_task_instance.cache_clear()
...
def test_get_topic(topic, dagrun_topic, task_instance_topic, dagrun_expected, task_instance_expected):
    ...
    ctxt = pytest.deprecated_call if topic is not None else contextlib.nullcontext
