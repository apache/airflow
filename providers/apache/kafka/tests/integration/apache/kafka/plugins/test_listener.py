...
class TestEventListener:
    ...
    def setup_class(cls):
        ...
        os.environ["AIRFLOW__KAFKA_LISTENER__CONFIG_DICT"] = '{"bootstrap.servers": "broker:29092"}'
        os.environ["AIRFLOW__KAFKA_LISTENER__TOPIC"] = cls.TOPIC
        os.environ["AIRFLOW__KAFKA_LISTENER__SOURCE"] = "dev-breeze"

        # The connection is needed for the topic creation/deletion and the consumer.
