...
class TestSparkSubmitHook:
    ...
    def test_process_spark_submit_log_k8s(self, pod_name):
        ...
        # Then
        assert hook._kubernetes_driver_pod_name == pod_name
    ...
    def test_on_kill_deletes_pod_when_k8s_api_tracking_and_submit_sp_already_exited(self, mock_get_client):
        ...
        hook._kubernetes_driver_pod_name = "spark-app-abc-driver"
    ...
    def test_poll_k8s_driver_custom_container_name_override(self, mock_get_client):
        """An explicit kubernetes_driver_container_name matches by exact name, bypassing the heuristic."""
        hook = SparkSubmitHook(
            conn_id="spark_k8s_cluster",
            track_driver_via_k8s_api=True,
    ...
    def test_poll_k8s_driver_custom_container_name_no_match_raises(self, mock_get_client):
        ...
        hook = SparkSubmitHook(
            conn_id="spark_k8s_cluster",
            track_driver_via_k8s_api=True,
            kubernetes_driver_container_name="does-not-exist",
        )
        hook._kubernetes_driver_pod_name = "spark-app-abc-driver"
        hook._kubernetes_application_id = "spark-abc"
