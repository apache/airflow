  ...
  Console {
    ...
    def test_operator_execute_batch_job(self, seatunnel_service, seatunnel_connection, simple_batch_config):
        ...
        with patch(
            ...
            with open(simple_batch_config) as f:
            ...
            # This test might need to be mocked if SeaTunnel is not
            # fully functional
...
sink {
  Console {
    ...
    def test_provider_info(self):
        ...
        from airflow.providers.apache.seatunnel import get_provider_info

        provider_info = get_provider_info()

        assert provider_info["package-name"] == "apache-airflow-providers-apache-seatunnel"
  ...
  Console {
    plugin_input = "transformed"
        ...
        sensor = SeaTunnelJobSensor(
            ...
            job_id="mock_job_id",
            # In real scenario, this would come from operator output
            target_states=["FINISHED"],
            seatunnel_conn_id="seatunnel_test",
            poke_interval=10,
            timeout=300,
...
class TestSeaTunnelConfigurationValidation:
    ...
    def test_missing_configuration(self):
        ...
        with pytest.raises(ValueError, match="Either config_file or config_content must be provided"):
            SeaTunnelOperator(task_id="test_task", seatunnel_conn_id="seatunnel_test")

    def test_both_configurations_provided(self):
        """Test handling when both config_file and config_content
        are provided"""
        with pytest.raises(ValueError, match="Either config_file or config_content must be provided"):
            SeaTunnelOperator(
                task_id="test_task",
    ...
    def test_sensor_with_invalid_engine(self, seatunnel_connection_params):
        ...
        with patch(
            ...
            with patch(
                ...
                sensor = SeaTunnelJobSensor(
                    task_id="test_sensor", job_id="test_job", seatunnel_conn_id="seatunnel_test"
                )
