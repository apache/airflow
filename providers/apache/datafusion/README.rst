...
This is a provider package for ``apache.datafusion`` provider. All classes for this provider package
are in ``airflow.providers.apache.datafusion`` python package.

You can find package information and changelog for the provider
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-apache-datafusion/0.1.0/>`_.
