...
Extra (optional)
    ...
    * ``fetch_lobs`` (bool) - Specify whether to fetch strings/bytes for CLOBs or BLOBs instead of locators.
    ...
    or only Host `(OracleHook.getconn Documentation) <https://airflow.apache.org/docs/apache-airflow-providers-oracle-oracledb/stable/_modules/airflow/providers/oracle/oracledb/hooks/oracle.html#OracleHook.get_conn>`_.
