...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-sendgrid/4.2.2/>`_.
...
``werkzeug``                                ``>=2.2,<4; python_version >= "3.12" and python_version <= "3.13"``
``werkzeug``                                ``>=3.1.6,<4; python_version >= "3.14"``
==========================================  ===================================================================
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-sendgrid/4.2.2/changelog.html>`_.
