...
order they were queued. :ref:`Callbacks <edge_executor:execute_callback>` are picked up
before any task, in the order they were queued, because they finish work that is already
running.
