...
class TestCleanupZombieKpoPods:
    ...
    def test_only_zombie_pods_deleted_healthy_pods_untouched(self):
        ...
        self.kube_client.delete_namespaced_pod.assert_called_once_with("zombie", "default", body=mock.ANY)
    ...
    def test_mapped_task_pod_matched_by_map_index(self):
        ...
        self.kube_client.delete_namespaced_pod.assert_called_once_with("p1", "default", body=mock.ANY)
