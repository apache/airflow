...
Without the binding, an assertion obtained by an attacker can be posted into somebody else's
browser, silently logging that person into the attacker's account, where anything they do next is
