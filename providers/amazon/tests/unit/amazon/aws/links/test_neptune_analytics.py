...
class TestNeptuneGraphLink(BaseAwsLinksTestCase):
    link_class = NeptuneGraphLink
        ...
        if AIRFLOW_V_3_0_PLUS and mock_supervisor_comms:
            mock_supervisor_comms.send.return_value = XComResult(
                ...
                value={
                    ...
                    "aws_partition": "aws",
                    "graph_id": "g-fake123456",
                },
            )
        self.assert_extra_link_url(
            expected_url=(
                "https://console.aws.amazon.com/neptune/home?region=us-east-1"
                "#analytics-graph-details:id=g-fake123456;tab=connectivity"
            ),
            region_name="us-east-1",
            aws_partition="aws",
            graph_id="g-fake123456",
