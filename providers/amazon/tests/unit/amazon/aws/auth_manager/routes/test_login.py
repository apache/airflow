...
class TestLoginRouter:
    ...
    def test_login_callback_rejects_a_login_state_it_did_not_sign(self, mangle):
        ...
        An attacker who could write this cookie could name their own AuthnRequest id, so the
        response they already hold would match it. The signature is what makes the entry
