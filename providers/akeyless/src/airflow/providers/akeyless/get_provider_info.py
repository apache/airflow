...
def get_provider_info():
    return {
        ...
        "hooks": [
            {"integration-name": "Akeyless", "python-modules": ["airflow.providers.akeyless.hooks.akeyless"]}
        ],
        "connection-types": [
            {
