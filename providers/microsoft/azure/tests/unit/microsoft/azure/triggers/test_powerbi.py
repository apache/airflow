...
class TestPowerBITrigger:
    ...
    @pytest.mark.asyncio
    @mock.patch.object(BaseHook, "get_refresh_details_by_refresh_id")
    @mock.patch.object(BaseHook, "trigger_dataset_refresh")
    ...
    @pytest.mark.asyncio
    @mock.patch.object(BaseHook, "cancel_dataset_refresh")
    @mock.patch.object(BaseHook, "get_refresh_details_by_refresh_id")
    @mock.patch.object(BaseHook, "trigger_dataset_refresh")
