...
class AzureBatchHook(BaseHook):
    ...
    def get_conn(self) -> BatchClient:
        ...
        if conn.login and conn.password:
            ...
            credential = _get_default_azure_credential(
    ...
    def configure_pool(
        ...
        **kwargs,
        ...
        if use_latest_image_and_sku:
            ...
            if not vm_node_agent_sku_id:
                raise ValueError("vm_node_agent_sku_id is required when use_latest_image_and_sku is False.")
    ...
    def wait_for_all_node_state(self, pool_id: str, node_state: set) -> list:
        ...
        while True:
            ...
            pool: BatchPool = self.connection.get_pool(pool_id)
