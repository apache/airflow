...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-http/6.0.5/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-http/6.0.5/changelog.html>`_.
