...
`c48975eb77 <https://github.com/apache/airflow/commit/c48975eb77a1ae6f04380ad1e5ec782e7d89df7a>`__  2024-12-03   ``Remove Provider Deprecations in Jenkins (#44630)``
...
`ccd7b86142 <https://github.com/apache/airflow/commit/ccd7b861427bceac0b5d122f98c3d408882b5175>`__  2024-10-22   ``Remove unnecessary return value from 'jenkins_request_with_headers' (#43207)``
...
`43f5d13535 <https://github.com/apache/airflow/commit/43f5d1353592fe0fba15dc497775e9ddebf0ff88>`__  2023-09-20   ``fix(providers/jenkins): respect soft_fail argument when exception is raised (#34475)``
`0d1f2d9ba8 <https://github.com/apache/airflow/commit/0d1f2d9ba88b1730f7c234f19e43b5e1f9a36c4c>`__  2023-09-18   ``Consolidate hook management in JenkinsJobTriggerOperator (#34433)``
==================================================================================================  ===========  ========================================================================================
...
`a6a7a89fda <https://github.com/apache/airflow/commit/a6a7a89fda258dfa68e67c00828a3550d66efd7f>`__  2023-09-04   ``Refactor attempting loops in jenkins (#34057)``
`794bd43aa8 <https://github.com/apache/airflow/commit/794bd43aa870c08d68488ad7597576f6ad0ed02c>`__  2023-09-01   ``Move the try outside the loop when this is possible in jenkins provider (#33979)``
...
`1f8bf783b8 <https://github.com/apache/airflow/commit/1f8bf783b89d440ecb3e6db536c63ff324d9fc62>`__  2023-03-25   ``'JenkinsHook' fix connection intake on https (#30301)``
==================================================================================================  ===========  ==========================================================
...
`149a7ea3de <https://github.com/apache/airflow/commit/149a7ea3de56c04deb9f74ba0c6e5bb88aef4d10>`__  2023-01-06   ``check jenkins result state (#28659)``
...
`5bd64183f9 <https://github.com/apache/airflow/commit/5bd64183f95e11f47d6b7bc54a4c0d0f74ab5ea6>`__  2022-06-03   ``Migrate Jenkins example DAGs to new design #22451 (#24138)``
...
`e5dd6fdcfd <https://github.com/apache/airflow/commit/e5dd6fdcfd2f53ed90e29070711c121de447b404>`__  2022-04-12   ``Bug Fix for 'apache-airflow-providers-jenkins' 'JenkinsJobTriggerOperator' (#22802)``
==================================================================================================  ===========  =======================================================================================
...
`c30ab6945e <https://github.com/apache/airflow/commit/c30ab6945ea0715889d32e38e943c899a32d5862>`__  2022-04-04   ``extra condition to check returned object not None (#22608)``
`cb41d5c02e <https://github.com/apache/airflow/commit/cb41d5c02e3c53a24f9dc148e45e696891c347c2>`__  2022-04-02   ``Add jenkins connection doc (#22682)``
`4e24b22379 <https://github.com/apache/airflow/commit/4e24b22379e131fe1007e911b93f52e1b6afcf3f>`__  2022-03-24   ``Add 'JenkinsBuildSensor' (#22421)``
==================================================================================================  ===========  ==============================================================
...
`85bedd03c3 <https://github.com/apache/airflow/commit/85bedd03c33a1d6c6339e846558727bf20bc16f7>`__  2021-12-20   ``Clean up JenkinsJobTriggerOperator (#19019)``
...
`a777537594 <https://github.com/apache/airflow/commit/a7775375943633eab90c28cc2a3973608f7ed54c>`__  2021-07-26   ``Updating Jenkins example DAGs to use XComArgs (#16874)``
...
`9ff781ad8f <https://github.com/apache/airflow/commit/9ff781ad8fd6b1d8d678227872b642b540b4dc55>`__  2021-07-13   ``Fixed to check number key from jenkins response (#16963)``
...
Commit                                                                                              Committed    Subject
==================================================================================================  ===========  =======================================================================
`15baf737ee <https://github.com/apache/airflow/commit/15baf737eede47e4fe9f8c0850a67d78884f4583>`__  2021-06-20   ``update example_jenkins_job_trigger.py (#16532)``
...
`78adaed5e6 <https://github.com/apache/airflow/commit/78adaed5e62fa604d2ef2234ad560eb1c6530976>`__  2021-02-08   ``Add allowed_jenkins_states to JenkinsJobTriggerOperator (#14131)``
==================================================================================================  ===========  ====================================================================
...
`a83be66840 <https://github.com/apache/airflow/commit/a83be668402884efe2e40af452dac17750d3c48d>`__  2020-11-06   ``Replace conditional with builtin max (#12122)``
...
`73a08ed757 <https://github.com/apache/airflow/commit/73a08ed757bf9f2af27cfca913200b61528a2d80>`__  2020-08-04   ``Add type annotation to providers/jenkins (#9947)``
...
`dbcd3d8787 <https://github.com/apache/airflow/commit/dbcd3d8787741fd8203b6d9bdbc5d1da4b10a15b>`__  2020-02-18   ``[AIRFLOW-6804] Add the basic test for all example DAGs (#7419)``
...
`633eca1de5 <https://github.com/apache/airflow/commit/633eca1de5042e95e23aaf2e7680ed3106cb0e87>`__  2020-02-02   ``[AIRFLOW-6692] Generate excluded_patterns in docs/conf.py (#7304)``
