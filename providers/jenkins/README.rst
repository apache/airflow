...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-jenkins/4.1.4/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-jenkins/4.1.4/changelog.html>`_.
