...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-jenkins/4.0.1/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-jenkins/4.0.1/changelog.html>`_.
