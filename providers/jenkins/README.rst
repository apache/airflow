...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-jenkins/4.2.0/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-jenkins/4.2.0/changelog.html>`_.
