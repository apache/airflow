...
# under the License.
"""TaskFlow decorator for :class:`~airflow.providers.common.dataquality.operators.dq_check.DQCheckOperator`."""
...
def dq_check_task(
    ...
    **kwargs,
    ...
    exactly as on :class:`~airflow.providers.common.dataquality.operators.dq_check.DQCheckOperator`. The
