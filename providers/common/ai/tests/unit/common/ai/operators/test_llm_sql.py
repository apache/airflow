...
class TestLLMSQLQueryOperator:
    ...
    def test_execute_validation_blocks_unsafe_sql(self, mock_hook_cls):
        ...
        mock_hook_cls.for_connection.return_value.create_agent.return_value = _make_mock_agent(
            "DROP TABLE users"
        )
    ...
    def test_execute_passes_agent_params(self, mock_hook_cls):
        ...
        mock_hook_cls.for_connection.return_value.create_agent.return_value = _make_mock_agent("SELECT 1")
        ...
        create_agent_call = mock_hook_cls.for_connection.return_value.create_agent.call_args
    ...
    def test_system_prompt_appended_to_sql_instructions(self, mock_hook_cls):
        ...
        instructions = mock_hook_cls.for_connection.return_value.create_agent.call_args[1]["instructions"]
