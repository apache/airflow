...
# ---------------------------------------------------------------------------
# 6. ADK Agent: answer a question using Google ADK with custom tools
# ---------------------------------------------------------------------------


# [START howto_operator_agent_adk]
@dag
def example_agent_operator_adk():
...
# [END howto_operator_agent_adk]

example_agent_operator_adk()


# ---------------------------------------------------------------------------
# 7. @task.agent decorator with ADK backend
# ---------------------------------------------------------------------------


# [START howto_decorator_agent_adk]
@dag
def example_agent_decorator_adk():
...
# [END howto_decorator_agent_adk]

example_agent_decorator_adk()
