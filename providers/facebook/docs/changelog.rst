...
* ``Migrate remaining providers to common.compat compatibility layer in facebook (#57079)``
...
* ``Move all BaseHook usages to version_compat in Facebook (#52806)``
...
* ``Bump min version of facebook-business>=22.0 (#50439)``
...
.. Below changes are excluded from the changelog. Move them to
   ...
   * ``Move Facebook provider to new structure (#46114)``
