...
class TestLoginRouter:
    ...
    @patch("airflow.providers.keycloak.auth_manager.routes.login.get_user")
    @patch("airflow.providers.keycloak.auth_manager.routes.login.KeycloakAuthManager.get_keycloak_client")
    @patch("airflow.providers.keycloak.auth_manager.routes.login.get_auth_manager")
    def test_refresh(self, mock_get_auth_manager, mock_get_keycloak_client, mock_get_user, client):
        mock_user = Mock()
        mock_get_user.return_value = mock_user
        mock_get_auth_manager.get_user_from_token.return_value = mock_user
        mock_get_keycloak_client.refresh_token.return_value = {
            "access_token": "new_access_token",
            "refresh_token": "new_refresh_token",
        }
        mock_get_keycloak_client.userinfo.return_value = {
            "sub": "sub",
            "preferred_username": "preferred_username",
        }
