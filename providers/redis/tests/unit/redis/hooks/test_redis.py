...
class TestRedisHook:
    ...
    @pytest.mark.parametrize(
        ("raw_nodes", "expected"),
        [
            pytest.param(["node-2:6379", "node-3:6380"], [("node-2", 6379), ("node-3", 6380)], id="list"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param([{"host": "node-2"}], "must be a comma-separated string", id="list-of-mappings"),
            pytest.param(6379, "must be a comma-separated string", id="not-a-sequence"),
        ],
    )
