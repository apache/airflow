...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.1.0/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.1.0/changelog.html>`_.
