...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.4.4/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.4.4/changelog.html>`_.
