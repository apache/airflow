...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.6.0/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.6.0/changelog.html>`_.
