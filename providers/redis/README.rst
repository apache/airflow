...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.4.5/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.4.5/changelog.html>`_.
