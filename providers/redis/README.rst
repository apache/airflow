...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.0.2/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-redis/4.0.2/changelog.html>`_.
