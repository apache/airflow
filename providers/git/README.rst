...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-git/0.4.0/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-git/0.4.0/changelog.html>`_.
