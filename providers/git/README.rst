...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-git/0.4.2/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-git/0.4.2/changelog.html>`_.
