...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-git/0.2.3/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-git/0.2.3/changelog.html>`_.
