...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-git/0.3.0/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-git/0.3.0/changelog.html>`_.
