...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-git/0.2.4/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-git/0.2.4/changelog.html>`_.
