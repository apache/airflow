...
class TestGetAsyncConnection:
    @mock.patch("airflow.providers.discord.version_compat.BaseHook", new_callable=MockAgetBaseHook)
    @pytest.mark.asyncio
    ...
    @mock.patch("airflow.providers.discord.version_compat.BaseHook", new_callable=MockBaseHook)
    @pytest.mark.asyncio
