...
.. Below changes are excluded from the changelog. Move them to
   ...
   * ``Make opsgenie tests db independent (#54577)``
   * ``Make psgenie hook tests db independent (#54575)``
...
* ``Move all BaseHook usages to version_compat in opsgenie (#52859)``
...
.. Below changes are excluded from the changelog. Move them to
   ...
   * ``Move provider: Opsgenie to new provider structure``
