...
`DuckDB <https://duckdb.org/>`__ is an in-process analytical database. Because it runs inside the
Airflow task process there is no server to connect to: the "connection" describes which database
file to open, if any, and how the engine should be configured.
...
.. toctree::
    ...
    Connection types <connections/duckdb>
    Operators <operators>
...
.. toctree::
    ...
    Python API <_api/airflow/providers/duckdb/index>
...
.. toctree::
    ...
    System Tests <_api/tests/system/duckdb/index>
