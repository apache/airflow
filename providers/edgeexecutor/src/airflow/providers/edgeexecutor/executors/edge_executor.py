...
from airflow.providers.edgeexecutor.cli.edge_command import EDGE_COMMANDS
from airflow.providers.edgeexecutor.models.edge_job import EdgeJobModel
from airflow.providers.edgeexecutor.models.edge_logs import EdgeLogsModel
from airflow.providers.edgeexecutor.models.edge_worker import EdgeWorkerModel, EdgeWorkerState, reset_metrics
from airflow.providers.edgeexecutor.version_compat import AIRFLOW_V_3_0_PLUS
        ...
        return [
            GroupCommand(
                ...
                description=(
                    ...
                    "see https://airflow.apache.org/docs/apache-airflow-providers-edgeexecutor/stable/edge_executor.html"
                ),
