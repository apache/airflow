...
from airflow.providers.edgeexecutor.models.edge_worker import EdgeWorkerVersionException
...
if TYPE_CHECKING:
    ...
    from airflow.providers.edgeexecutor.models.edge_worker import EdgeWorkerState
...
def _make_generic_request(method: str, rest_path: str, data: str | None = None) -> Any:
    if AIRFLOW_V_3_0_PLUS:
        ...
        from airflow.providers.edgeexecutor.worker_api.auth import jwt_signer
