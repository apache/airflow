...
def _get_airflow_2_api_endpoint() -> Blueprint:
    ...
    folder = Path(__file__).parents[1].resolve()  # this is airflow/providers/edgeexecutor/
...
def _get_api_endpoint() -> dict[str, Any]:
    from airflow.providers.edgeexecutor.worker_api.app import create_edge_worker_api_app
...
# registers airflow/providers/edgeexecutor/plugins/templates as a Jinja template folder
...
class EdgeWorkerHosts(BaseView):
    ...
    def status(self, session: Session = NEW_SESSION):
        from airflow.providers.edgeexecutor.models.edge_worker import EdgeWorkerModel
    ...
    def worker_to_maintenance(self, worker_name: str):
        ...
        from airflow.providers.edgeexecutor.models.edge_worker import request_maintenance
    ...
    def remove_worker_from_maintenance(self, worker_name: str):
        from airflow.providers.edgeexecutor.models.edge_worker import exit_maintenance
    ...
    def remove_worker(self, worker_name: str):
        from airflow.providers.edgeexecutor.models.edge_worker import remove_worker
    ...
    def change_maintenance_comment(self, worker_name: str):
        ...
        from airflow.providers.edgeexecutor.models.edge_worker import change_maintenance_comment
