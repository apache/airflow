...
from airflow.providers.edgeexecutor.worker_api.routes.health import health_router
from airflow.providers.edgeexecutor.worker_api.routes.jobs import jobs_router
from airflow.providers.edgeexecutor.worker_api.routes.logs import logs_router
from airflow.providers.edgeexecutor.worker_api.routes.worker import worker_router
