...
from airflow.providers.edgeexecutor.cli.dataclasses import Job
from airflow.providers.edgeexecutor.cli.edge_command import _EdgeWorkerCli, _write_pid_to_pidfile
from airflow.providers.edgeexecutor.models.edge_worker import EdgeWorkerState, EdgeWorkerVersionException
from airflow.providers.edgeexecutor.worker_api.datamodels import (
    EdgeJobFetched,
...
class TestEdgeWorkerCli:
    ...
    @patch("airflow.providers.edgeexecutor.cli.edge_command.Process")
    @patch("airflow.providers.edgeexecutor.cli.edge_command.logs_logfile_path")
    @patch("airflow.providers.edgeexecutor.cli.edge_command.Popen")
    ...
    @patch("airflow.providers.edgeexecutor.cli.edge_command.jobs_fetch")
    @patch("airflow.providers.edgeexecutor.cli.edge_command.logs_logfile_path")
    @patch("airflow.providers.edgeexecutor.cli.edge_command.jobs_set_state")
    ...
    @patch("airflow.providers.edgeexecutor.cli.edge_command.logs_push")
    ...
    @patch("airflow.providers.edgeexecutor.cli.edge_command.worker_set_state")
    def test_heartbeat(
    ...
    @patch("airflow.providers.edgeexecutor.cli.edge_command.worker_register")
    ...
    @patch("airflow.providers.edgeexecutor.cli.edge_command.worker_register")
    @patch("airflow.providers.edgeexecutor.cli.edge_command._EdgeWorkerCli.loop")
    @patch("airflow.providers.edgeexecutor.cli.edge_command.worker_set_state")
