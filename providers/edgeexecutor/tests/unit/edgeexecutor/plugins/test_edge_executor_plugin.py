...
from airflow.providers.edgeexecutor.plugins import edge_executor_plugin
...
def test_plugin_inactive():
    with conf_vars({("edge", "api_enabled"): "false"}):
        ...
        from airflow.providers.edgeexecutor.plugins.edge_executor_plugin import (
...
@pytest.fixture
def plugin():
    from airflow.providers.edgeexecutor.plugins.edge_executor_plugin import EdgeExecutorPlugin
