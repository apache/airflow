...
from airflow.providers.edgeexecutor.cli.edge_command import _EdgeWorkerCli
from airflow.providers.edgeexecutor.models.edge_worker import EdgeWorkerModel, EdgeWorkerState
from airflow.providers.edgeexecutor.worker_api.datamodels import WorkerQueueUpdateBody, WorkerStateBody
from airflow.providers.edgeexecutor.worker_api.routes._v2_compat import HTTPException
from airflow.providers.edgeexecutor.worker_api.routes.worker import (
    _assert_version,
    register,
    set_state,
    update_queues,
...
class TestWorkerApiRoutes:
    ...
    def test_assert_version(self):
        ...
        from airflow.providers.edgeexecutor import __version__ as edge_provider_version
    ...
    def test_redefine_state(
        ...
        from airflow.providers.edgeexecutor.worker_api.routes.worker import redefine_state
