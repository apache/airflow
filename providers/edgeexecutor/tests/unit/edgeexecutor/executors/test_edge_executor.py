...
from airflow.providers.edgeexecutor.executors.edge_executor import EdgeExecutor
from airflow.providers.edgeexecutor.models.edge_job import EdgeJobModel
from airflow.providers.edgeexecutor.models.edge_worker import EdgeWorkerModel, EdgeWorkerState
...
class TestEdgeExecutor:
    ...
    @patch("airflow.providers.edgeexecutor.executors.edge_executor.EdgeExecutor.running_state")
    @patch("airflow.providers.edgeexecutor.executors.edge_executor.EdgeExecutor.success")
    @patch("airflow.providers.edgeexecutor.executors.edge_executor.EdgeExecutor.fail")
