        ...
        "connection-types": [
            {
                ...
                "conn-fields": {
                    ...
                    "verify": {
                        ...
                        "schema": {"type": ["boolean", "null"]},
                        "description": "Verify the server SSL certificate when TLS is enabled",
                    },
                    "connect_timeout": {
                    ...
                    "compress": {"label": "Enable LZ4 Compression", "schema": {"type": ["boolean", "null"]}},
                    "client_name": {"label": "Client Name", "schema": {"type": ["string", "null"]}},
                    "session_settings": {
                        "label": "Session Settings (JSON)",
