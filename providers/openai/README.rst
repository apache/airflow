...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-openai/1.7.4/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-openai/1.7.4/changelog.html>`_.
