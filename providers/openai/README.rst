...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-openai/1.8.2/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-openai/1.8.2/changelog.html>`_.
