...
from airflow.providers.fab.version_compat import AIRFLOW_V_3_1_PLUS, AIRFLOW_V_3_4_PLUS
...
class FabAuthManager(BaseAuthManager[User]):
    ...
    def get_fastapi_middlewares(self) -> list[tuple[_MiddlewareFactory[Any], dict[str, Any]]]:
        ...
        middleware = super().get_fastapi_middlewares() if AIRFLOW_V_3_4_PLUS else []
