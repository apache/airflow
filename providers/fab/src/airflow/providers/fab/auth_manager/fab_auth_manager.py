...
_MAP_DAG_ACCESS_ENTITY_TO_FAB_RESOURCE_TYPE: dict[DagAccessEntity, tuple[str, ...]] = {
    ...
    DagAccessEntity.TASK: (RESOURCE_TASK_INSTANCE, RESOURCE_REQUIRED_ACTIONS),
    DagAccessEntity.TASK_INSTANCE: (RESOURCE_DAG_RUN, RESOURCE_TASK_INSTANCE, RESOURCE_REQUIRED_ACTIONS),
...
_MAP_MENU_ITEM_TO_FAB_RESOURCE_TYPE = {
    ...
    MenuItem.REQUIRED_ACTIONS: RESOURCE_REQUIRED_ACTIONS,
