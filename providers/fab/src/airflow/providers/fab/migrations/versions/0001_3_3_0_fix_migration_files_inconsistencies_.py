...
"""
Fix migration files inconsistencies with ORM.

Revision ID: 4e0e54749301
Revises: 6709f7a774b9
Create Date: 2026-02-23 14:48:10.806464
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("ab_permission_view_role", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(None, "ab_role", ["role_id"], ["id"], ondelete="CASCADE")
        batch_op.create_foreign_key(
            None, "ab_permission_view", ["permission_view_id"], ["id"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("ab_user_role", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(None, "ab_user", ["user_id"], ["id"], ondelete="CASCADE")
        batch_op.create_foreign_key(None, "ab_role", ["role_id"], ["id"], ondelete="CASCADE")
