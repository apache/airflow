...
.. exampleinclude:: /../../providers/google/tests/system/google/cloud/tasks/example_queue.py
    :language: python
    :dedent: 4
...
.. exampleinclude:: /../../providers/google/tests/system/google/cloud/tasks/example_tasks.py
    :language: python
    :dedent: 4
