...
def _get_vertex_ray():
    try:
        ...
        raise ImportError(
            "Vertex AI Ray cleanup requires the optional `vertex_ray` package. "
            "Install `google-cloud-aiplatform[ray]` or skip the `vertex_ai_raycluster` asset type."
        ) from e
    return vertex_ray
