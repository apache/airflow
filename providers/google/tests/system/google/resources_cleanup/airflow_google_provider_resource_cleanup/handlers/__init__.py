...
def get_delete_handlers() -> dict[str, type[BaseDeleteHandler]]:
    ...
    from airflow_google_provider_resource_cleanup.handlers.dataproc_metastore import (
        DataprocMetastoreDeleteHandler,
    )
    from airflow_google_provider_resource_cleanup.handlers.dlp import DLPDeleteHandler
    from airflow_google_provider_resource_cleanup.handlers.kafka import ManagedKafkaDeleteHandler
    from airflow_google_provider_resource_cleanup.handlers.kubernetes_engine import GKEDeleteHandler
    ...
    from airflow_google_provider_resource_cleanup.handlers.spanner import SpannerDeleteHandler
    ...
    return {
        ...
        "gke": GKEDeleteHandler,
        "kafka": ManagedKafkaDeleteHandler,
        "logging": LoggingDeleteHandler,
        "spanner": SpannerDeleteHandler,
