...
def _build_resource_tree(
    resources_data: Sequence[dict[str, Any]], cfg: GCPProjectConfig
) -> list[dict[str, Any]]:
    ...
    for resource in resources_data:
        ...
        if resource.get("parentFullResourceName"):
...
def _get_html_template(resource_type: str | None = None) -> Template:
...
def _get_html_file(system_tests_project: str, resource_type: str | None = None) -> Path:
    if resource_type is None:
