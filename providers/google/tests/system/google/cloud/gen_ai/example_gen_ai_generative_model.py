...
# verbose form: "{{ task_instance.xcom_pull('get_actual_models') }}"
...
CONTENTS = [PROMPT]
# verbose form: "{{ task_instance.xcom_pull('get_actual_models')['text-embedding'] }}"
TEXT_EMBEDDING_MODEL = "{{ get_actual_models.output['text-embedding'] }}"
# verbose form: "{{ task_instance.xcom_pull('get_actual_models')['multimodal'] }}"
...
# verbose form: "{{ task_instance.xcom_pull('get_actual_models')['cached-model'] }}"
