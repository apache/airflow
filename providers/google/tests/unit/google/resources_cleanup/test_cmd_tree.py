...
def test_handler_tree(mock_args):
    with (
        ...
        patch("airflow_google_provider_resource_cleanup.commands.cmd_tree.get_resources_file") as mock_get_file,
        patch(
        ...
        patch("airflow_google_provider_resource_cleanup.commands.cmd_tree._build_resource_tree") as mock_build,
        patch("airflow_google_provider_resource_cleanup.commands.cmd_tree._get_html_template") as mock_get_template,
        patch("airflow_google_provider_resource_cleanup.commands.cmd_tree._get_html_file") as mock_get_file_path,
