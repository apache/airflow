...
def test_handler_tree(mock_args):
    with (
        ...
        patch("airflow_google_provider_resource_cleanup.commands.cmd_tree.webbrowser.open") as mock_open_browser,
    ):
        # Mock setup
        ...
        mock_open_browser.assert_called_once_with(mock_html_file.absolute.return_value.as_uri.return_value)
