...
class TestCloudLoggingRemoteLogIO:
    ...
    def _setup(self, tmp_path):
        self.local_log_location = str(tmp_path / "local/cloud_logging/logs")
    ...
    try:
        ...
        with context_manager:
            with conf_vars(
                ...
                # Older Airflow: logging is wired as a logging handler
...
class TestCloudLoggingHandlerTask:
    DAG_ID = "dag_for_testing_logging_file_task_handler"
    ...
    def test_should_read_logs_for_all_try(self, mock_client, mock_get_creds_and_project_id):
        ...
        filter_str = (
            ...
            'labels.dag_id="dag_for_testing_logging_file_task_handler"\n'
