...
from airflow.providers.google.cloud.hooks import monitoring
...
@pytest.mark.db_test
class TestCloudMonitoringHookMethods:
    @mock.patch(
        "airflow.providers.google.common.hooks.base_google.GoogleBaseHook.get_credentials_and_project_id",
        return_value=(CREDENTIALS, PROJECT_ID),
    )
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_policy_client")
    def test_cloud_monitoring_list_alert_policies(self, mock_policy_client, mock_get_creds_and_project_id):
        method = mock_policy_client.return_value.list_alert_policies
        hook = monitoring.CloudMonitoringHook()
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_policy_client")
    def test_cloud_monitoring_enable_alert_policy(self, mock_policy_client, mock_get_creds_and_project_id):
        hook = monitoring.CloudMonitoringHook()
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_policy_client")
    def test_cloud_monitoring_disable_alert_policy(self, mock_policy_client, mock_get_creds_and_project_id):
        hook = monitoring.CloudMonitoringHook()
        alert_policy_enabled = AlertPolicy(**TEST_ALERT_POLICY_1)
        alert_policy_disabled = AlertPolicy(**TEST_ALERT_POLICY_2)
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_policy_client")
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_channel_client")
    def test_cloud_monitoring_upsert_alert_policy(
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_policy_client")
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_channel_client")
    def test_cloud_monitoring_upsert_alert_policy_without_channel(
        self, mock_channel_client, mock_policy_client, mock_get_creds_and_project_id
    ):
        hook = monitoring.CloudMonitoringHook()
        existing_alert_policy = AlertPolicy(**TEST_ALERT_POLICY_1)
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_policy_client")
    def test_cloud_monitoring_delete_alert_policy(self, mock_policy_client, mock_get_creds_and_project_id):
        hook = monitoring.CloudMonitoringHook()
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_policy_client")
    def test_cloud_monitoring_delete_alert_policy_raises_operation_error(
        self, mock_policy_client, mock_get_creds_and_project_id
    ):
        mock_policy_client.return_value.delete_alert_policy.side_effect = HttpError(
            resp=httplib2.Response({"status": 400}), content=b"Error content"
        )
        hook = monitoring.CloudMonitoringHook()

        with pytest.raises(monitoring.CloudMonitoringOperationError, match="Delete alerting policy failed"):
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_channel_client")
    def test_cloud_monitoring_list_notification_channel(
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_channel_client")
    def test_cloud_monitoring_enable_notification_channel(
        self, mock_channel_client, mock_get_creds_and_project_id
    ):
        hook = monitoring.CloudMonitoringHook()
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_channel_client")
    def test_cloud_monitoring_disable_notification_channel(
        self, mock_channel_client, mock_get_creds_and_project_id
    ):
        hook = monitoring.CloudMonitoringHook()
        notification_channel_enabled = NotificationChannel(**TEST_NOTIFICATION_CHANNEL_1)
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_channel_client")
    def test_cloud_monitoring_upsert_channel(self, mock_channel_client, mock_get_creds_and_project_id):
        hook = monitoring.CloudMonitoringHook()
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_channel_client")
    def test_cloud_monitoring_delete_notification_channel(
        self, mock_channel_client, mock_get_creds_and_project_id
    ):
        hook = monitoring.CloudMonitoringHook()
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.monitoring.CloudMonitoringHook._get_channel_client")
    def test_cloud_monitoring_delete_notification_channel_raises_operation_error(
        self, mock_channel_client, mock_get_creds_and_project_id
    ):
        mock_channel_client.return_value.delete_notification_channel.side_effect = HttpError(
            resp=httplib2.Response({"status": 400}), content=b"Error content"
        )
        hook = monitoring.CloudMonitoringHook()

        with pytest.raises(
            monitoring.CloudMonitoringOperationError, match="Delete notification channel failed"
        ):
