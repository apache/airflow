...
class TestCloudKMSHook:
    ...
    @mock.patch("airflow.providers.google.cloud.hooks.kms.CloudKMSHook.get_client_options")
    ...
    def test_kms_client_creation(self, mock_client, mock_get_creds, mock_get_client_options):
