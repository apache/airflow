...
from airflow.providers.google.cloud.hooks import cloud_monitoring
...
class TestCloudMonitoringHookMethods:
    ...
    @mock.patch(
        "airflow.providers.google.cloud.hooks.cloud_monitoring.CloudMonitoringHook._get_policy_client"
    )
    def test_cloud_monitoring_list_alert_policies(self, mock_policy_client, mock_get_creds_and_project_id):
        ...
        hook = cloud_monitoring.CloudMonitoringHook()
    ...
    def test_cloud_monitoring_list_alert_policies_formats_result(
    ...
    @mock.patch(
        "airflow.providers.google.cloud.hooks.cloud_monitoring.CloudMonitoringHook._get_channel_client"
    )
