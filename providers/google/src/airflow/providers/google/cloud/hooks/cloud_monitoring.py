...
# under the License.
"""This module contains Google Cloud Monitoring operators."""
...
class CloudMonitoringHook(GoogleBaseHook):
    """Cloud Monitoring Hook for connecting with Google Cloud Monitoring."""
