...
# under the License.
"""This module contains Google Cloud Monitoring hook."""
...
class CloudMonitoringOperationError(RuntimeError):
    """Raised when a Cloud Monitoring API operation fails."""
...
class CloudMonitoringHook(GoogleBaseHook):
    ...
    def delete_alert_policy(
        ...
        try:
            ...
            raise CloudMonitoringOperationError(
