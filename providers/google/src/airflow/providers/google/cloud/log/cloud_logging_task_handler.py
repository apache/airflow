...
class CloudLoggingRemoteLogIO(LoggingMixin):
    ...
    def read(self, relative_path: str, ti: RuntimeTI) -> LogResponse:
        """Read logs from Cloud Logging Logging using task instance labels."""
...
class CloudLoggingTaskHandler(logging.Handler):
    """
    Handler that directly makes Cloud Logging logging API calls.
    ...
    :param name: the name of the custom log in Cloud Logging Logging. Defaults
    ...
    def read(
        ...
        """
        Read logs of given task instance from Cloud Logging logging.
