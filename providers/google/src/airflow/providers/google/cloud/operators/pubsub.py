...
class PubSubCreateSubscriptionOperator(GoogleCloudBaseOperator):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.metadata = metadata
        self.impersonation_chain = impersonation_chain
        self.__created_subscription_name: str | None = None
    ...
    def execute(self, context: Context) -> str:
        ...
        self.__created_subscription_name = self.subscription or result

        PubSubSubscriptionLink.persist(
            context=context,
            subscription_id=self.__created_subscription_name,  # result returns subscription name
    ...
    def get_openlineage_facets_on_complete(self, _) -> OperatorLineage:
        ...
        output_dataset = [Dataset(
            namespace=f"pubsub",
            name=f"subscription:{project_id}:{self.__created_subscription_name}"
        )]
