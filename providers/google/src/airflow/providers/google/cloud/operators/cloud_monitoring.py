...
class CloudMonitoringListAlertPoliciesOperator(GoogleCloudBaseOperator):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.hook: CloudMonitoringHook | None = None
    ...
    def execute(self, context: Context):
        ...
        CloudMonitoringPoliciesLink.persist(
            context=context,
...
class CloudMonitoringEnableAlertPoliciesOperator(GoogleCloudBaseOperator):
    ...
    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:CloudMonitoringEnableAlertPoliciesOperator`
...
class CloudMonitoringDisableAlertPoliciesOperator(GoogleCloudBaseOperator):
    """
    ...
    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:CloudMonitoringDisableAlertPoliciesOperator`
...
class CloudMonitoringUpsertAlertOperator(GoogleCloudBaseOperator):
    ...
    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:CloudMonitoringUpsertAlertOperator`
...
class CloudMonitoringDeleteAlertOperator(GoogleCloudBaseOperator):
    """
    Deletes an alerting policy.

    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:CloudMonitoringDeleteAlertOperator`
...
class CloudMonitoringListNotificationChannelsOperator(GoogleCloudBaseOperator):
    """
    ...
    def execute(self, context: Context):
        ...
        CloudMonitoringNotificationsLink.persist(
            context=context,
            project_id=self.project_id or self.hook.project_id,
        )
        if self.format_ not in ("dict", "json"):
...
class CloudMonitoringEnableNotificationChannelsOperator(GoogleCloudBaseOperator):
    ...
    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:CloudMonitoringEnableNotificationChannelsOperator`
...
class CloudMonitoringDisableNotificationChannelsOperator(GoogleCloudBaseOperator):
    """
...
class CloudMonitoringUpsertNotificationChannelOperator(GoogleCloudBaseOperator):
    """
...
class CloudMonitoringDeleteNotificationChannelOperator(GoogleCloudBaseOperator):
    """
