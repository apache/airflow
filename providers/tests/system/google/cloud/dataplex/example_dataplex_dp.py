...
# [END howto_dataplex_data_profile_configuration]
...
with DAG(
    ...
    # [START howto_dataplex_create_data_profile_operator]
    ...
    # [END howto_dataplex_create_data_profile_operator]
    ...
    # [START howto_dataplex_get_data_profile_operator]
    ...
    # [END howto_dataplex_get_data_profile_operator]
    ...
    # [START howto_dataplex_run_data_profile_operator]
    ...
    # [END howto_dataplex_run_data_profile_operator]
    ...
    # [END howto_dataplex_get_data_profile_job_operator]
    # [START howto_dataplex_run_data_profile_def_operator]
    ...
    # [END howto_dataplex_run_data_profile_def_operator]
