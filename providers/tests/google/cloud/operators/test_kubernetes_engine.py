...
class TestGKEBaseOperator:
    def setup_method(self):
        self.operator = GKEBaseOperator(
    ...
    @mock.patch(GKE_OPERATORS_PATH.format("GKEHook"))
    @mock.patch(GKE_OPERATORS_PATH.format("GKEBaseOperator.cluster_info"), new_callable=PropertyMock)
...
class TestGKEDeleteClusterOperator:
    ...
    def test_template_fields(self):
        expected_template_fields = {"api_version", "deferrable", "poll_interval"} | set(
            GKEBaseOperator.template_fields
        )
        assert set(self.operator.template_fields) == expected_template_fields
...
class TestGKEStartKueueInsideClusterOperator:
    ...
    def test_template_fields(self):
        expected_template_fields = set(GKEBaseOperator.template_fields) | set(
...
class TestGKEStartPodOperator:
    ...
    def test_template_fields(self):
        expected_template_fields = (
            ...
            | set(GKEBaseOperator.template_fields)
        )
...
class TestGKEListJobsOperator:
    ...
    def test_template_fields(self):
        expected_template_fields = {"namespace"} | set(GKEBaseOperator.template_fields)
...
class TestGKEStartKueueJobOperator:
    def test_template_fields(self):
        assert set(GKEStartKueueJobOperator.template_fields) == set(GKEBaseOperator.template_fields) | set(
...
class TestGKEDeleteJobOperator:
    def test_template_fields(self):
        assert set(GKEDeleteJobOperator.template_fields) == set(GKEBaseOperator.template_fields) | set(
...
class TestGKESuspendJobOperator:
    ...
    def test_template_fields(self):
        expected_template_fields = {"name", "namespace"} | set(GKEBaseOperator.template_fields)
