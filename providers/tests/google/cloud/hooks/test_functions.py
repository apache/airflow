...
class TestFunctionHookNoDefaultProjectId:
    ...
    def test_create_new_function_overridden_project_id(
        ...
        create_method = get_conn.return_value.projects.return_value.locations.return_value.functions.return_value.create
...
class TestFunctionHookDefaultProjectId:
    def setup_method(self):
        with mock.patch(
            ...
            self.gcf_function_hook = CloudFunctionsHook(
                gcp_conn_id="test", api_version="v1"
            )
    ...
    def test_get_function(self, get_conn):
        get_method = get_conn.return_value.projects.return_value.locations.return_value.functions.return_value.get
    ...
    def test_delete_function(self, wait_for_operation_to_complete, get_conn):
        delete_method = get_conn.return_value.projects.return_value.locations.return_value.functions.return_value.delete
    ...
    def test_update_function(self, wait_for_operation_to_complete, get_conn):
        patch_method = get_conn.return_value.projects.return_value.locations.return_value.functions.return_value.patch
