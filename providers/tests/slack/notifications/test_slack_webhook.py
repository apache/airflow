...
class TestSlackNotifier:
    ...
    def test_slack_webhook_notifier(
        self, mock_slack_hook, slack_op_kwargs, hook_extra_kwargs
    ):
    ...
    def test_slack_webhook_templated(self, mock_slack_hook, dag_maker):
        ...
        notifier = send_slack_webhook_notification(
            ...
            blocks=[
                {
                    "type": "header",
                    "text": {"type": "plain_text", "text": "{{ dag.dag_id }}"},
                }
            ],
            ...
            blocks=[
                {
                    ...
                    "text": {
                        "type": "plain_text",
                        "text": "test_send_slack_webhook_notification_templated",
                    },
                }
            ],
            attachments=[
                {"image_url": "test_send_slack_webhook_notification_templated.png"}
            ],
            unfurl_links=None,
            unfurl_media=None,
        )
