...
# """
# Temporary utility functions copied from
# providers/fab/tests/provider_tests/fab/auth_manager/api_endpoints/api_connexion_utils.py
# to create and delete users and roles in the legacy FAB view tests after the FAB
# provider has been moved to the new provider structure.

# Please refer to the following issue to get more details:
#     https://github.com/apache/airflow/issues/46045 and
#     https://github.com/apache/airflow/pull/46144#issuecomment-2616759066
# TODO: This file should be removed when the UI is not using the FAB views anymore.
# """
