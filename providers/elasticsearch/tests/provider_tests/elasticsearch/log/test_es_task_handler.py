...
from provider_tests.elasticsearch.log.elasticmock import elasticmock
from provider_tests.elasticsearch.log.elasticmock.utilities import SearchFailedException
