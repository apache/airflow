...
`7ae5a49b93 <https://github.com/apache/airflow/commit/7ae5a49b93e4e8f3e1428b68e4a5b94bd47fd8c7>`__  2025-02-01   ``refactor(providers/salesforce): move salesforce provider to new structure (#46301)``
`63f3b0ed4d <https://github.com/apache/airflow/commit/63f3b0ed4d5d1b3c3dbeb529d54cd22da3a00c65>`__  2025-01-26   ``Implement fetching consumer_secret from Salesforce connection (#45954)``
...
`30250962db <https://github.com/apache/airflow/commit/30250962db2404559190b9f2e5bb55652deaae21>`__  2024-04-16   ``update simple-salesforce type hints to support 1.12.6 (#39047)``
`74d22fd6ce <https://github.com/apache/airflow/commit/74d22fd6ceb86c90a5b142ebd7aed9c73dfd442c>`__  2024-04-16   ``limit simple-salesforce version which breaks MyPy checks (#39045)``
...
`90a100a7c3 <https://github.com/apache/airflow/commit/90a100a7c3d554d1c674a90feaefdf42fd4c45ba>`__  2023-10-31   ``Fix SalesforceHook compatiblity with Pandas 2.x (#35145)``
...
`ed26b86a50 <https://github.com/apache/airflow/commit/ed26b86a506b07ecf66c314e5514bd906e608359>`__  2022-11-30   ``Add test_connection to SalesforceHook (#27921)``
==================================================================================================  ===========  =====================================================================
...
`eaeab806b0 <https://github.com/apache/airflow/commit/eaeab806b0d385aaf58dc2be8944c31eebcaf1bc>`__  2022-10-22   ``Allow and prefer non-prefixed extra fields for SalesforceHook (#27075)``
...
`3f9414d0fd <https://github.com/apache/airflow/commit/3f9414d0fd67a2c508e105651de1105955f307bf>`__  2022-07-08   ``Correct parameter typing in 'SalesforceBulkOperator' (#24927)``
`b6a2759417 <https://github.com/apache/airflow/commit/b6a27594174c888af31d3fc71ea5f8b589883a12>`__  2022-07-05   ``Add support for Salesforce bulk api (#24473)``
...
`fdf518573f <https://github.com/apache/airflow/commit/fdf518573fa45f6208f6a9111323bd35ed2a2fad>`__  2022-06-03   ``Migrate Salesforce example DAGs to new design #22463 (#24127)``
==================================================================================================  ===========  ==================================================================================
...
`45669bea4f <https://github.com/apache/airflow/commit/45669bea4f690021b69a7d2afa8be9567ae0c49d>`__  2020-09-24   ``Increasing type coverage for salesforce provide (#11135)``
...
`ff342fc230 <https://github.com/apache/airflow/commit/ff342fc230982dc5d88acfd5e5eab75187256b58>`__  2020-05-17   ``Added SalesforceHook missing method to return only dataframe (#8565) (#8644)``
...
`9546192836 <https://github.com/apache/airflow/commit/95461928365f255c79ab4a164ce60d8eebea29d7>`__  2020-03-26   ``bumping simple-salesforce to 1.0.0 (#7857)``
`31efc931e3 <https://github.com/apache/airflow/commit/31efc931e32841b7da8decd576cafa1e5a6f6d95>`__  2020-03-23   ``Add missing call to Super class in 'salesforce' provider (#7824)``
`6140356b80 <https://github.com/apache/airflow/commit/6140356b80f68906e89ccf46941a949bdc4d43fa>`__  2020-03-12   ``[AIRFLOW-6481] Fix bug in SalesforceHook (#7703)``
...
`61a8bb6581 <https://github.com/apache/airflow/commit/61a8bb65818521ccbb846e647103535b3e36b26d>`__  2020-02-22   ``[AIRFLOW-6879] Fix Failing CI: Update New import paths (#7500)``
`a9ad0a9298 <https://github.com/apache/airflow/commit/a9ad0a929851b6912e0bb8551f1ff80b50281944>`__  2020-02-22   ``[AIRFLOW-6790] Add basic Tableau Integration (#7410)``
