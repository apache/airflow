...
@pytest.mark.parametrize(
    "value",
    [
        pytest.param("vertica://host:5433/mydb/public/mytable", id="valid"),
    ],
)
...
@pytest.mark.parametrize(
    "value",
    [
        pytest.param("vertica:///db/schema/table", id="missing-host"),
        pytest.param("vertica://host:5433", id="missing-path"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            "mytable",
            5433,
            "vertica://myhost:5433/mydb/public/mytable",
            id="default-port",
        ),
        pytest.param("myhost", "db", "s", "t", 5444, "vertica://myhost:5444/db/s/t", id="custom-port"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "vertica://otherhost:5444/testdb/schema1/data",
            "vertica://otherhost:5444",
            "testdb.schema1.data",
            id="custom-port",
        ),
    ],
