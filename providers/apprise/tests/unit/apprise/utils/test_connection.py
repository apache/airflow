...
class TestGetAsyncConnection:
    @mock.patch("airflow.providers.apprise.utils.BaseHook", new_callable=MockAgetBaseHook)
    @pytest.mark.asyncio
    ...
    @mock.patch("airflow.providers.apprise.utils.BaseHook", new_callable=MockBaseHook)
    @pytest.mark.asyncio
