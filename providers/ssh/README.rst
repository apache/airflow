...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-ssh/4.1.5/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-ssh/4.1.5/changelog.html>`_.
