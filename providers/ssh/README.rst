...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-ssh/4.3.1/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-ssh/4.3.1/changelog.html>`_.
