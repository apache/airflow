...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-ssh/4.1.6/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-ssh/4.1.6/changelog.html>`_.
