...
def get_provider_info():
    return {
        "package-name": "apache-airflow-providers-dataquality",
        "name": "Data Quality",
        ...
        "integrations": [
            {
                ...
                "external-doc-url": "https://airflow.apache.org/docs/apache-airflow-providers-dataquality/",
                "how-to-guide": ["/docs/apache-airflow-providers-dataquality/operators.rst"],
                "tags": ["software"],
            }
        ],
        "operators": [
            {
                "integration-name": "Data Quality",
                "python-modules": ["airflow.providers.dataquality.operators.dq_check"],
            }
        ],
        "task-decorators": [
            {
                "class-name": "airflow.providers.dataquality.decorators.dq_check.dq_check_task",
                "name": "dq_check",
            }
        ],
        "config": {
