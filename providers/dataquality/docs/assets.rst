...
Pass the resulting asset to :class:`~airflow.providers.dataquality.operators.dq_check.DQCheckOperator`
...
:func:`~airflow.providers.dataquality.assets.require_quality` builds a ``@task.short_circuit`` task that
