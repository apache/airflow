...
Writing a :class:`~airflow.providers.dataquality.rules.RuleSet` by hand for every table doesn't scale.
...
``airflow/providers/dataquality/skills/dataquality-rule-authoring/``: a ``SKILL.md`` documenting the
...
.. exampleinclude:: /../src/airflow/providers/dataquality/example_dags/example_dq_llm_generated_ruleset.py
    :language: python
