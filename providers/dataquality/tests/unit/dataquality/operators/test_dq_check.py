...
from airflow.providers.dataquality.assets import asset_quality
...
def results_backend(tmp_path):
    ...
    with mock.patch(
        "airflow.providers.dataquality.operators.dq_check.get_backend_from_config", return_value=backend
    ):
        yield backend
