...
import airflow.providers.dataquality
from airflow.providers.dataquality.rules import Condition, DQRule, RuleSet, Severity, describe_rule
...
def test_skill_reference_schema_matches_live_model():
    ...
    """
    schema_path = (
        Path(airflow.providers.dataquality.__file__).parent
        / "skills"
