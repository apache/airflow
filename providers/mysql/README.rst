...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-mysql/6.6.2/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-mysql/6.6.2/changelog.html>`_.
