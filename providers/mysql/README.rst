...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-mysql/6.4.2/>`_.
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-mysql/6.4.2/changelog.html>`_.
