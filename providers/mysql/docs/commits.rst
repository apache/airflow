...
`a37f6fec44 <https://github.com/apache/airflow/commit/a37f6fec4471b06c65f79f0fa1f72a1b125b6e34>`__  2025-03-04   ``Adding ticks to user provided table names (#47262)``
`4e8fa928e4 <https://github.com/apache/airflow/commit/4e8fa928e4e39afa875414a9680c4d2241eb335a>`__  2025-03-01   ``Add regex validation for table names in 'bulk_load' (#47254)``
`5f7be558a1 <https://github.com/apache/airflow/commit/5f7be558a192725a4e6f078b75e577978315aeaa>`__  2025-03-01   ``Add regex validation for table names in 'bulk_dump' (#47255)``
...
`3c0915c75b <https://github.com/apache/airflow/commit/3c0915c75b6f1285e79a9d260a109cf085b14171>`__  2024-12-06   ``Remove Provider Deprecations in MySQL (#44665)``
...
`8c91fcec50 <https://github.com/apache/airflow/commit/8c91fcec50ab18ddabaaf97d2461a32f8ce4fb44>`__  2024-11-19   ``Fix error file not found. tmp file is deleted before inserting rows to DB in VerticaToMySQLOperator bulk  (#44028)``
...
`9e8fb40ba7 <https://github.com/apache/airflow/commit/9e8fb40ba71d9bd07ae40503d5e7aa93ef042bb0>`__  2024-10-25   ``Improve the cursor type definition of mysql (#43376)``
...
`e3c31752f1 <https://github.com/apache/airflow/commit/e3c31752f180ae60f0c0de304793018084e02943>`__  2024-05-26   ``Resolving mysql deprecated operator warnings (#39725)``
==================================================================================================  ===========  ==================================================================================
...
`c29632aab4 <https://github.com/apache/airflow/commit/c29632aab4cf13a861bfffcbd11f1c9964d8910a>`__  2024-01-08   ``Bump min version of mysql-connector-python (#36668)``
==================================================================================================  ===========  ====================================================================================
...
`3598a52a2d <https://github.com/apache/airflow/commit/3598a52a2d1a7f9aef5e3777f1dd2a5823722aa2>`__  2024-01-03   ``Sanitize filenames in MySQLHook (#33328)``
...
`dce9796861 <https://github.com/apache/airflow/commit/dce9796861e0a535952f79b0e2a7d5a012fcc01b>`__  2023-08-18   ``Add init_command parameter to MySqlHook (#33359)``
`744aa609c8 <https://github.com/apache/airflow/commit/744aa609c82e6cd4230a12a80424c9b7fec17779>`__  2023-08-17   ``Add 'local_infile' parameter to 'S3ToMySqlOperator' (#33459)``
==================================================================================================  ===========  ================================================================
...
`98a999034c <https://github.com/apache/airflow/commit/98a999034cab576b001340c9274ed293dcfce2cd>`__  2023-07-21   ``Add OpenLineage support for MySQL. (#31609)``
...
`312f7e873d <https://github.com/apache/airflow/commit/312f7e873d5141ad65e64dbffa6095232c6c29b6>`__  2023-04-13   ``Remove mysql-connector-python (#30487)``
...
`ff8fae1baf <https://github.com/apache/airflow/commit/ff8fae1baf5ab3346059bb876c3c0d1c26ab92ad>`__  2023-02-22   ``Use MariaDB client binaries in arm64 image for support MySQL backend (#29519)``
==================================================================================================  ===========  =================================================================================
...
`c4d28d0c73 <https://github.com/apache/airflow/commit/c4d28d0c73fe9f24c96fb42d6a8e82c2f08d4b72>`__  2023-02-02   ``[FOLLOW-UP][PR-28811] Remove local_infile in mysql connection examples (#29284)``
...
`83dc604650 <https://github.com/apache/airflow/commit/83dc604650d13d64e34014f2c2323e764033c4a5>`__  2022-11-17   ``Allow SSL mode in MySQL provider (#27717)``
==================================================================================================  ===========  ================================================================
...
`2ee099655b <https://github.com/apache/airflow/commit/2ee099655b1ca46935dbf3e37ae0ec1139f98287>`__  2022-08-26   ``Fix dead link in MySQL Provider page (#25387)``
...
`55b16444ad <https://github.com/apache/airflow/commit/55b16444ad5abcc4249631d6b9ef0beafd6ac86c>`__  2022-06-20   ``Close the MySQL connections once operations are done. (#24508)``
...
`3df8ff7407 <https://github.com/apache/airflow/commit/3df8ff7407f76b8c944d9e353744e6e79ed6277d>`__  2022-06-03   ``Migrate MySQL example DAGs to new design #22453 (#24142)``
==================================================================================================  ===========  ==================================================================================
...
`68da4d84ef <https://github.com/apache/airflow/commit/68da4d84ef3e182916e2ca7ce4909f7f5e22e21f>`__  2022-02-19   ``Update MySqlOperator example dag (#21434)``
==================================================================================================  ===========  ========================================================
...
`919ff4567d <https://github.com/apache/airflow/commit/919ff4567d86a09fb069dcfd84885b496229eea9>`__  2022-01-05   ``Refactor vertica_to_mysql to make it more 'mypy' friendly (#20618)``
...
`4dae4ec9a4 <https://github.com/apache/airflow/commit/4dae4ec9a4148db6c32f15ccc122d42c93a2c58a>`__  2021-08-03   ``refactor: fixed type annotation for 'sql' in MySqlOperator (#17388)``
==================================================================================================  ===========  ============================================================================
...
`a1d3b271ed <https://github.com/apache/airflow/commit/a1d3b271edb2e938a7e76c10c5617425d0f48591>`__  2021-07-19   ``Parse template parameters field for MySQL operator (#17080)``
...
`6ab00bfcfd <https://github.com/apache/airflow/commit/6ab00bfcfdfe1213928281527f32ca31b77cce1b>`__  2021-07-14   ``Extended template_fields_renderers for MySQL provider (#16987)``
`c3b8212b6e <https://github.com/apache/airflow/commit/c3b8212b6e82145f96d17e51cc462db8e2506220>`__  2021-07-10   ``Added template_fields_renderers for MySQL Operator (#16914)``
...
`7ab4b27076 <https://github.com/apache/airflow/commit/7ab4b2707669498d7278113439a13f58bd12ea1a>`__  2021-04-08   ``Docs: Remove extra single quote from example connection (#15265)``
==================================================================================================  ===========  ====================================================================
...
`9b428bbbdf <https://github.com/apache/airflow/commit/9b428bbbdf4c56f302a1ce84f7c2caf34b81ffa0>`__  2021-03-28   ``Fix autocommit calls for mysql-connector-python (#14869)``
`fe2a70c713 <https://github.com/apache/airflow/commit/fe2a70c713f8d12199579bfca26eb916035ab206>`__  2021-03-26   ``Bump mysqlclient to support the 1.4.x and 2.x series (#14978)``
...
`cdc20904a5 <https://github.com/apache/airflow/commit/cdc20904a59610822968ab57aa127d989ec7e2a5>`__  2021-02-17   ``MySQL hook respects conn_name_attr (#14240)``
...
`0d214575a1 <https://github.com/apache/airflow/commit/0d214575a144356a8a83a462d6d9fb68bf4999c7>`__  2020-12-28   ``Refactored setup.py to better reflect changes in providers (#13314)``
...
`6bf9acb90f <https://github.com/apache/airflow/commit/6bf9acb90fcb510223cadc1f41431ea5f57f0ca1>`__  2020-12-14   ``Fix import from core to mysql provider in mysql example DAG (#13060)``
==================================================================================================  ===========  ========================================================================
...
`75f229601e <https://github.com/apache/airflow/commit/75f229601edebfc25b295683a2200d1f1d69dceb>`__  2020-11-04   ``Adding MySql howto-documentation and example DAG (#12077)``
...
`01f37967c9 <https://github.com/apache/airflow/commit/01f37967c938f3f11b08517f5920f31aca89676f>`__  2020-08-18   ``Add typing coverage to mysql providers package (#10095)``
...
`329e6a5f72 <https://github.com/apache/airflow/commit/329e6a5f72bc2e3fc19391754256d974179a6ce0>`__  2020-04-01   ``[AIRFLOW-5907] Add S3 to MySql Operator (#6578)``
...
`b39468d287 <https://github.com/apache/airflow/commit/b39468d2878554ba60863656364b4a95eda30685>`__  2020-03-09   ``[AIRFLOW-5922] Add option to specify the mysql client library used in MySqlHook (#6576)``
...
`1e576f1234 <https://github.com/apache/airflow/commit/1e576f12343b30c2a37ab3f4f62ee3aa30326e77>`__  2020-02-02   ``[AIRFLOW-6680] Last changes for AIP-21 (#7301)``
