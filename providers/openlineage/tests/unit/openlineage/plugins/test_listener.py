...
class TestOpenLineageListenerAirflow2:
    ...
    @mock.patch("airflow.providers.openlineage.plugins.listener.get_task_parent_run_id")
    ...
    def test_adapter_start_task_is_called_with_proper_arguments(
        ...
        mock_get_task_parent_run_id.return_value = {"parent": 4}
