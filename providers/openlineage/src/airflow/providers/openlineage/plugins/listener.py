...
class OpenLineageListener:
    ...
    def _on_task_instance_running(
        ...
        def on_running():
            ...
            task_doc, task_doc_type = get_task_documentation(task)
            dag_doc, dag_doc_type = get_dag_documentation(dag)
            ...
            redacted_event = self.adapter.start_task(
                ...
                job_description=task_doc or dag_doc,
                job_description_type=task_doc_type or dag_doc_type,
    ...
    def on_dag_run_running(self, dag_run: DagRun, msg: str) -> None:
        try:
            ...
            dag_doc, dag_doc_type = get_dag_documentation(dag_run.dag)
            ...
            self.submit_callable(
                ...
                job_description=dag_doc,
                job_description_type=dag_doc_type,
