...
from airflow.providers.standard.models.db import InteractiveProviderDBManager

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

version_table = InteractiveProviderDBManager.version_table_name
...
target_metadata = InteractiveProviderDBManager.metadata
