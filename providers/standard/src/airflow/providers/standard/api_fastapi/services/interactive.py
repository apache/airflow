...
from airflow.providers.standard.api_fastapi.datamodel.interactive import InteractiveBody
...
class InteractiveRsponseService:
    """Login Service for FABAuthManager."""

    @classmethod
    def response(cls, body: InteractiveBody):
        pass
