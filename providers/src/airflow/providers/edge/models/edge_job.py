...
class EdgeJobModel(Base, LoggingMixin):
    ...
    need_concurrency = Column(Integer, default=1)
    ...
    def __init__(
        ...
        self.state = state
        self.queue = queue
        self.need_concurrency = need_concurrency
    ...
    def reserve_task(
        ...
        query = (
            ...
            .where(
                ...
                EdgeJobModel.need_concurrency <= free_concurrency,
            )
        ...
        return EdgeJob(
            ...
            state=job.state,
            queue=job.queue,
            need_concurrency=job.need_concurrency,
