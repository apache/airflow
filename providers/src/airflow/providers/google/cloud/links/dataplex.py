...
DATAPLEX_TASKS_LINK = (
    DATAPLEX_BASE_LINK + "?project={project_id}&qLake={lake_id}.{region}"
)

DATAPLEX_LAKE_LINK = "https://console.cloud.google.com/dataplex/lakes/{lake_id};location={region}?project={project_id}"
