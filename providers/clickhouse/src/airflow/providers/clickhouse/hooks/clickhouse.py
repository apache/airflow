    ...
    def get_connection_form_widgets(cls) -> dict[str, Any]:
        ...
        return {
            "secure": BooleanField(
                ...
                description="Enable TLS/HTTPS for the connection (default: False).",
            ),
            "verify": BooleanField(
                label=lazy_gettext("Verify SSL Certificate"),
                description="Verify the server SSL certificate when TLS is enabled (default: True).",
            ),
            ...
            "client_name": StringField(
                ...
                widget=BS3TextFieldWidget(),
                description=(
                    "Optional label appended to the Airflow version identifier in the "
                    "ClickHouse HTTP User-Agent and system.query_log client_name field. "
            ...
            "client_kwargs": StringField(
                ...
                widget=BS3TextFieldWidget(),
                description=(
                    "Additional keyword arguments forwarded to clickhouse_connect.get_client() "
                    'as a JSON object, e.g. {"http_proxy": "http://proxy:8080"}. '
                    "Hook-managed keys (host, port, username, password, database, secure, "
